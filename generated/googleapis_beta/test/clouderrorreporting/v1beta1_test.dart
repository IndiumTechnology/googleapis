...
checkUnnamed5219(core.List<api.SourceReference> o) {
...
buildErrorContext() {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    o.sourceReferences = buildUnnamed5219();
    o.user = "foo";
  }
  buildCounterErrorContext--;
  return o;
...
checkErrorContext(api.ErrorContext o) {
  ...
  if (buildCounterErrorContext < 3) {
    ...
    checkUnnamed5219(o.sourceReferences);
...
checkUnnamed5220(core.List<api.TrackingIssue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildErrorGroup() {
  ...
  if (buildCounterErrorGroup < 3) {
    o.groupId = "foo";
    o.name = "foo";
    o.trackingIssues = buildUnnamed5220();
  }
  buildCounterErrorGroup--;
  return o;
}
...
checkErrorGroup(api.ErrorGroup o) {
  ...
  if (buildCounterErrorGroup < 3) {
    ...
    checkUnnamed5220(o.trackingIssues);
  }
  buildCounterErrorGroup--;
}
...
checkUnnamed5221(core.List<api.ServiceContext> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5222(core.List<api.TimedCount> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTimedCount(o[0]);
  checkTimedCount(o[1]);
}
...
buildErrorGroupStats() {
  ...
  if (buildCounterErrorGroupStats < 3) {
    o.affectedServices = buildUnnamed5221();
    ...
    o.timedCounts = buildUnnamed5222();
  }
  buildCounterErrorGroupStats--;
  return o;
}
...
checkErrorGroupStats(api.ErrorGroupStats o) {
  buildCounterErrorGroupStats++;
  if (buildCounterErrorGroupStats < 3) {
    checkUnnamed5221(o.affectedServices);
    ...
    checkUnnamed5222(o.timedCounts);
  }
  buildCounterErrorGroupStats--;
}
...
checkUnnamed5223(core.List<api.ErrorEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkErrorEvent(o[0]);
  checkErrorEvent(o[1]);
}
...
buildListEventsResponse() {
  ...
  if (buildCounterListEventsResponse < 3) {
    o.errorEvents = buildUnnamed5223();
    o.nextPageToken = "foo";
...
checkListEventsResponse(api.ListEventsResponse o) {
  buildCounterListEventsResponse++;
  if (buildCounterListEventsResponse < 3) {
    checkUnnamed5223(o.errorEvents);
...
checkUnnamed5224(core.List<api.ErrorGroupStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListGroupStatsResponse() {
  ...
  if (buildCounterListGroupStatsResponse < 3) {
    o.errorGroupStats = buildUnnamed5224();
    o.nextPageToken = "foo";
    o.timeRangeBegin = "foo";
  }
  buildCounterListGroupStatsResponse--;
...
checkListGroupStatsResponse(api.ListGroupStatsResponse o) {
  buildCounterListGroupStatsResponse++;
  if (buildCounterListGroupStatsResponse < 3) {
    checkUnnamed5224(o.errorGroupStats);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.timeRangeBegin, unittest.equals('foo'));
  }
  buildCounterListGroupStatsResponse--;
...
main() {
  ...
  unittest.group("resource-ProjectsGroupStatsResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_groupId = buildUnnamed5225();
      var arg_serviceFilter_service = "foo";
      var arg_pageSize = 42;
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
