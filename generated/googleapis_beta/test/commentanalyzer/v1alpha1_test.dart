...
checkUnnamed5065(core.Map<core.String, api.AttributeParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAnalyzeCommentRequest() {
  ...
  if (buildCounterAnalyzeCommentRequest < 3) {
    ...
    o.doNotStore = true;
    o.languages = buildUnnamed5064();
    o.requestedAttributes = buildUnnamed5065();
    o.sessionId = "foo";
...
checkAnalyzeCommentRequest(api.AnalyzeCommentRequest o) {
  ...
  if (buildCounterAnalyzeCommentRequest < 3) {
    ...
    checkUnnamed5064(o.languages);
    checkUnnamed5065(o.requestedAttributes);
...
checkUnnamed5066(core.Map<core.String, api.AttributeScores> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAnalyzeCommentResponse() {
  ...
  if (buildCounterAnalyzeCommentResponse < 3) {
    o.attributeScores = buildUnnamed5066();
    o.clientToken = "foo";
    o.detectedLanguages = buildUnnamed5067();
    o.languages = buildUnnamed5068();
  }
  buildCounterAnalyzeCommentResponse--;
  return o;
}
...
checkAnalyzeCommentResponse(api.AnalyzeCommentResponse o) {
  buildCounterAnalyzeCommentResponse++;
  if (buildCounterAnalyzeCommentResponse < 3) {
    checkUnnamed5066(o.attributeScores);
    unittest.expect(o.clientToken, unittest.equals('foo'));
    checkUnnamed5067(o.detectedLanguages);
    checkUnnamed5068(o.languages);
  }
  buildCounterAnalyzeCommentResponse--;
}
...
checkUnnamed5069(core.List<api.SpanScore> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSpanScore(o[0]);
  checkSpanScore(o[1]);
}
...
checkUnnamed5070(core.List<api.TextEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTextEntry(o[0]);
  checkTextEntry(o[1]);
}
...
checkUnnamed5071(core.Map<core.String, api.AttributeScores> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttributeScores(o["x"]);
  checkAttributeScores(o["y"]);
}
...
buildSuggestCommentScoreRequest() {
  ...
  if (buildCounterSuggestCommentScoreRequest < 3) {
    o.attributeScores = buildUnnamed5071();
    o.clientToken = "foo";
    o.comment = buildTextEntry();
    o.communityId = "foo";
    o.context = buildContext();
    o.languages = buildUnnamed5072();
    o.sessionId = "foo";
  }
  buildCounterSuggestCommentScoreRequest--;
  return o;
...
checkSuggestCommentScoreRequest(api.SuggestCommentScoreRequest o) {
  buildCounterSuggestCommentScoreRequest++;
  if (buildCounterSuggestCommentScoreRequest < 3) {
    checkUnnamed5071(o.attributeScores);
    unittest.expect(o.clientToken, unittest.equals('foo'));
    checkTextEntry(o.comment);
    unittest.expect(o.communityId, unittest.equals('foo'));
    checkContext(o.context);
    checkUnnamed5072(o.languages);
    unittest.expect(o.sessionId, unittest.equals('foo'));
  }
  buildCounterSuggestCommentScoreRequest--;
}
...
buildSuggestCommentScoreResponse() {
  ...
  if (buildCounterSuggestCommentScoreResponse < 3) {
    o.clientToken = "foo";
    o.detectedLanguages = buildUnnamed5073();
    o.requestedLanguages = buildUnnamed5074();
  }
  buildCounterSuggestCommentScoreResponse--;
  return o;
}
...
checkSuggestCommentScoreResponse(api.SuggestCommentScoreResponse o) {
  ...
  if (buildCounterSuggestCommentScoreResponse < 3) {
    unittest.expect(o.clientToken, unittest.equals('foo'));
    checkUnnamed5073(o.detectedLanguages);
    checkUnnamed5074(o.requestedLanguages);
  }
  buildCounterSuggestCommentScoreResponse--;
}
