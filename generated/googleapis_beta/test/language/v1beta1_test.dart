...
checkUnnamed5021(core.List<api.Entity> o) {
...
checkUnnamed5022(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed5023(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed5024(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnalyzeSyntaxResponse() {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    o.language = "foo";
    o.sentences = buildUnnamed5023();
    o.tokens = buildUnnamed5024();
  }
  buildCounterAnalyzeSyntaxResponse--;
  return o;
}
...
checkAnalyzeSyntaxResponse(api.AnalyzeSyntaxResponse o) {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed5023(o.sentences);
    checkUnnamed5024(o.tokens);
  }
  buildCounterAnalyzeSyntaxResponse--;
}
...
checkUnnamed5025(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
checkUnnamed5026(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed5027(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnnotateTextResponse() {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    o.documentSentiment = buildSentiment();
    o.entities = buildUnnamed5025();
    o.language = "foo";
    o.sentences = buildUnnamed5026();
    o.tokens = buildUnnamed5027();
  }
  buildCounterAnnotateTextResponse--;
  return o;
}
...
checkAnnotateTextResponse(api.AnnotateTextResponse o) {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    checkSentiment(o.documentSentiment);
    checkUnnamed5025(o.entities);
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed5026(o.sentences);
    checkUnnamed5027(o.tokens);
  }
  buildCounterAnnotateTextResponse--;
}
...
checkUnnamed5028(core.List<api.EntityMention> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5029(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEntity() {
  ...
  if (buildCounterEntity < 3) {
    o.mentions = buildUnnamed5028();
    o.metadata = buildUnnamed5029();
    o.name = "foo";
    o.salience = 42.0;
    o.type = "foo";
  }
...
checkEntity(api.Entity o) {
  buildCounterEntity++;
  if (buildCounterEntity < 3) {
    checkUnnamed5028(o.mentions);
    checkUnnamed5029(o.metadata);
...
checkUnnamed5030(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5031() {
  ...
  o.add(buildUnnamed5030());
  o.add(buildUnnamed5030());
  return o;
}

checkUnnamed5031(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
