...
checkUnnamed4891(core.Map<core.String, core.String> o) {
...
checkUnnamed4892(core.List<api.AttachmentInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBeaconInfo() {
  ...
  if (buildCounterBeaconInfo < 3) {
    o.advertisedId = buildAdvertisedId();
    o.attachments = buildUnnamed4892();
    o.beaconName = "foo";
  }
  buildCounterBeaconInfo--;
  return o;
...
checkBeaconInfo(api.BeaconInfo o) {
  ...
  if (buildCounterBeaconInfo < 3) {
    checkAdvertisedId(o.advertisedId);
    checkUnnamed4892(o.attachments);
    unittest.expect(o.beaconName, unittest.equals('foo'));
  }
  buildCounterBeaconInfo--;
}
...
checkUnnamed4895(core.List<api.Observation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGetInfoForObservedBeaconsRequest() {
  ...
  if (buildCounterGetInfoForObservedBeaconsRequest < 3) {
    o.namespacedTypes = buildUnnamed4894();
    o.observations = buildUnnamed4895();
  }
  buildCounterGetInfoForObservedBeaconsRequest--;
  return o;
}
...
checkGetInfoForObservedBeaconsRequest(api.GetInfoForObservedBeaconsRequest o) {
  buildCounterGetInfoForObservedBeaconsRequest++;
  if (buildCounterGetInfoForObservedBeaconsRequest < 3) {
    checkUnnamed4894(o.namespacedTypes);
    checkUnnamed4895(o.observations);
  }
  buildCounterGetInfoForObservedBeaconsRequest--;
}
...
checkUnnamed4896(core.List<api.BeaconInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBeaconInfo(o[0]);
  checkBeaconInfo(o[1]);
}
...
checkUnnamed4897(core.List<api.BeaconAttachment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListBeaconAttachmentsResponse() {
  ...
  if (buildCounterListBeaconAttachmentsResponse < 3) {
    o.attachments = buildUnnamed4897();
  }
  buildCounterListBeaconAttachmentsResponse--;
  return o;
}
...
checkListBeaconAttachmentsResponse(api.ListBeaconAttachmentsResponse o) {
  buildCounterListBeaconAttachmentsResponse++;
  if (buildCounterListBeaconAttachmentsResponse < 3) {
    checkUnnamed4897(o.attachments);
  }
  buildCounterListBeaconAttachmentsResponse--;
}
...
checkUnnamed4898(core.List<api.Beacon> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBeacon(o[0]);
  checkBeacon(o[1]);
}
...
checkUnnamed4899(core.List<api.Diagnostics> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListDiagnosticsResponse() {
  ...
  if (buildCounterListDiagnosticsResponse < 3) {
    o.diagnostics = buildUnnamed4899();
    o.nextPageToken = "foo";
  }
  buildCounterListDiagnosticsResponse--;
  return o;
...
checkListDiagnosticsResponse(api.ListDiagnosticsResponse o) {
  buildCounterListDiagnosticsResponse++;
  if (buildCounterListDiagnosticsResponse < 3) {
    checkUnnamed4899(o.diagnostics);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDiagnosticsResponse--;
}
...
checkUnnamed4900(core.List<api.Namespace> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNamespace(o[0]);
  checkNamespace(o[1]);
}
