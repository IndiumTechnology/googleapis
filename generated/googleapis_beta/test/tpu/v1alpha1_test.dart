...
checkUnnamed5099(core.List<api.AcceleratorType> o) {
...
buildListAcceleratorTypesResponse() {
  ...
  if (buildCounterListAcceleratorTypesResponse < 3) {
    o.acceleratorTypes = buildUnnamed5099();
    o.nextPageToken = "foo";
    o.unreachable = buildUnnamed5100();
  }
  buildCounterListAcceleratorTypesResponse--;
  return o;
}
...
checkListAcceleratorTypesResponse(api.ListAcceleratorTypesResponse o) {
  buildCounterListAcceleratorTypesResponse++;
  if (buildCounterListAcceleratorTypesResponse < 3) {
    checkUnnamed5099(o.acceleratorTypes);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed5100(o.unreachable);
  }
  buildCounterListAcceleratorTypesResponse--;
}
...
checkUnnamed5101(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed5102(core.List<api.Node> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNode(o[0]);
  checkNode(o[1]);
}
...
buildListNodesResponse() {
  ...
  if (buildCounterListNodesResponse < 3) {
    o.nextPageToken = "foo";
    o.nodes = buildUnnamed5102();
    o.unreachable = buildUnnamed5103();
  }
  buildCounterListNodesResponse--;
  return o;
}
...
checkListNodesResponse(api.ListNodesResponse o) {
  ...
  if (buildCounterListNodesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed5102(o.nodes);
    checkUnnamed5103(o.unreachable);
  }
  buildCounterListNodesResponse--;
}
...
checkUnnamed5104(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed5105(core.List<api.TensorFlowVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListTensorFlowVersionsResponse() {
  ...
  if (buildCounterListTensorFlowVersionsResponse < 3) {
    o.nextPageToken = "foo";
    o.tensorflowVersions = buildUnnamed5105();
    o.unreachable = buildUnnamed5106();
  }
  buildCounterListTensorFlowVersionsResponse--;
  return o;
}
...
checkListTensorFlowVersionsResponse(api.ListTensorFlowVersionsResponse o) {
  ...
  if (buildCounterListTensorFlowVersionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed5105(o.tensorflowVersions);
    checkUnnamed5106(o.unreachable);
  }
  buildCounterListTensorFlowVersionsResponse--;
}
...
checkUnnamed5108(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = "foo";
    o.labels = buildUnnamed5107();
    o.locationId = "foo";
    o.metadata = buildUnnamed5108();
    o.name = "foo";
  }
  buildCounterLocation--;
  return o;
...
checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed5107(o.labels);
    unittest.expect(o.locationId, unittest.equals('foo'));
    checkUnnamed5108(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterLocation--;
}
...
checkUnnamed5109(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed5110(core.List<api.NetworkEndpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNode() {
  ...
  if (buildCounterNode < 3) {
    ...
    o.ipAddress = "foo";
    o.labels = buildUnnamed5109();
    o.name = "foo";
    o.network = "foo";
    o.networkEndpoints = buildUnnamed5110();
    o.port = "foo";
...
checkNode(api.Node o) {
  ...
  if (buildCounterNode < 3) {
    ...
    unittest.expect(o.ipAddress, unittest.equals('foo'));
    checkUnnamed5109(o.labels);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.network, unittest.equals('foo'));
    checkUnnamed5110(o.networkEndpoints);
...
checkUnnamed5112(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed5111();
    o.name = "foo";
    o.response = buildUnnamed5112();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed5111(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5112(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed5113(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5114() {
  ...
  o.add(buildUnnamed5113());
  o.add(buildUnnamed5113());
  return o;
}

checkUnnamed5114(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5113(o[0]);
  checkUnnamed5113(o[1]);
}
