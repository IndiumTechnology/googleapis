...
checkUnnamed5117(core.List<core.String> o) {
...
checkUnnamed5118(core.List<api.RuntimeConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5119(core.List<api.Variable> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVariable(o[0]);
  checkVariable(o[1]);
}
...
checkUnnamed5120(core.List<api.Waiter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWaiter(o[0]);
  checkWaiter(o[1]);
}
...
checkUnnamed5121(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5122(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed5121();
    o.name = "foo";
    o.response = buildUnnamed5122();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed5121(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5122(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed5123(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
checkUnnamed5124(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5125() {
  ...
  o.add(buildUnnamed5124());
  o.add(buildUnnamed5124());
  return o;
}

checkUnnamed5125(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5124(o[0]);
  checkUnnamed5124(o[1]);
}
...
checkUnnamed5126(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed5126();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed5126(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}
...
buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed5127();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed5127(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
