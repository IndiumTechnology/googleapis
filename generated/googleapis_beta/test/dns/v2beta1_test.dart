...
checkUnnamed5568(core.List<api.ResourceRecordSet> o) {
...
checkUnnamed5569(core.List<api.ResourceRecordSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceRecordSet(o[0]);
  checkResourceRecordSet(o[1]);
}
...
buildChange() {
  ...
  if (buildCounterChange < 3) {
    o.additions = buildUnnamed5568();
    o.deletions = buildUnnamed5569();
    o.id = "foo";
    o.isServing = true;
    o.kind = "foo";
    o.startTime = "foo";
...
checkChange(api.Change o) {
  buildCounterChange++;
  if (buildCounterChange < 3) {
    checkUnnamed5568(o.additions);
    checkUnnamed5569(o.deletions);
...
checkUnnamed5570(core.List<api.Change> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkChange(o[0]);
  checkChange(o[1]);
}
...
checkUnnamed5571(core.List<api.DnsKeyDigest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5572(core.List<api.DnsKey> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKey(o[0]);
  checkDnsKey(o[1]);
}
...
checkUnnamed5573(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5574(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZone() {
  ...
  if (buildCounterManagedZone < 3) {
    ...
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed5573();
    o.name = "foo";
    o.nameServerSet = "foo";
    o.nameServers = buildUnnamed5574();
...
checkUnnamed5575(core.List<api.DnsKeySpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKeySpec(o[0]);
  checkDnsKeySpec(o[1]);
}
...
buildManagedZoneDnsSecConfig() {
  ...
  if (buildCounterManagedZoneDnsSecConfig < 3) {
    o.defaultKeySpecs = buildUnnamed5575();
    o.kind = "foo";
    o.nonExistence = "foo";
    o.state = "foo";
  }
...
checkManagedZoneDnsSecConfig(api.ManagedZoneDnsSecConfig o) {
  buildCounterManagedZoneDnsSecConfig++;
  if (buildCounterManagedZoneDnsSecConfig < 3) {
    checkUnnamed5575(o.defaultKeySpecs);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed5576(core.List<api.ManagedZoneForwardingConfigNameServerTarget> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZoneForwardingConfig() {
  ...
  if (buildCounterManagedZoneForwardingConfig < 3) {
    o.kind = "foo";
    o.targetNameServers = buildUnnamed5576();
  }
  buildCounterManagedZoneForwardingConfig--;
  return o;
}
...
checkManagedZoneForwardingConfig(api.ManagedZoneForwardingConfig o) {
  ...
  if (buildCounterManagedZoneForwardingConfig < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed5576(o.targetNameServers);
  }
  buildCounterManagedZoneForwardingConfig--;
}
...
checkUnnamed5578(core.List<api.ManagedZonePrivateVisibilityConfigNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5579(core.List<api.ManagedZone> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildManagedZonesListResponse() {
  ...
  if (buildCounterManagedZonesListResponse < 3) {
    o.header = buildResponseHeader();
    o.kind = "foo";
    o.managedZones = buildUnnamed5579();
    o.nextPageToken = "foo";
  }
  buildCounterManagedZonesListResponse--;
  return o;
...
checkManagedZonesListResponse(api.ManagedZonesListResponse o) {
  ...
  if (buildCounterManagedZonesListResponse < 3) {
    checkResponseHeader(o.header);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed5579(o.managedZones);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterManagedZonesListResponse--;
}
...
checkUnnamed5580(core.List<api.Policy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPolicy(o[0]);
  checkPolicy(o[1]);
}
...
checkUnnamed5581(core.List<api.PolicyNetwork> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPolicyAlternativeNameServerConfig() {
  ...
  if (buildCounterPolicyAlternativeNameServerConfig < 3) {
    o.kind = "foo";
    o.targetNameServers = buildUnnamed5582();
  }
  buildCounterPolicyAlternativeNameServerConfig--;
  return o;
}
...
checkPolicyAlternativeNameServerConfig(
  ...
  if (buildCounterPolicyAlternativeNameServerConfig < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed5582(o.targetNameServers);
  }
  buildCounterPolicyAlternativeNameServerConfig--;
}
...
checkUnnamed5583(core.List<api.DnsKeySpec> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDnsKeySpec(o[0]);
  checkDnsKeySpec(o[1]);
}
...
buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    ...
    o.whitelistedKeySpecs = buildUnnamed5583();
  }
  buildCounterQuota--;
  return o;
}
...
checkQuota(api.Quota o) {
  ...
  if (buildCounterQuota < 3) {
    ...
    checkUnnamed5583(o.whitelistedKeySpecs);
  }
  buildCounterQuota--;
}
...
buildResourceRecordSet() {
  ...
  if (buildCounterResourceRecordSet < 3) {
    o.kind = "foo";
    o.name = "foo";
    o.rrdatas = buildUnnamed5584();
    o.signatureRrdatas = buildUnnamed5585();
    o.ttl = 42;
    o.type = "foo";
  }
  buildCounterResourceRecordSet--;
...
checkResourceRecordSet(api.ResourceRecordSet o) {
  ...
  if (buildCounterResourceRecordSet < 3) {
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5584(o.rrdatas);
    checkUnnamed5585(o.signatureRrdatas);
...
checkUnnamed5586(core.List<api.ResourceRecordSet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResourceRecordSet(o[0]);
  checkResourceRecordSet(o[1]);
}
