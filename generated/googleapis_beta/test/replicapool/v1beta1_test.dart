...
checkUnnamed5588(core.List<api.EnvVariable> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAction() {
  ...
  if (buildCounterAction < 3) {
    o.commands = buildUnnamed5587();
    o.envVariables = buildUnnamed5588();
...
checkAction(api.Action o) {
  buildCounterAction++;
  if (buildCounterAction < 3) {
    checkUnnamed5587(o.commands);
    checkUnnamed5588(o.envVariables);
...
checkUnnamed5589(core.List<api.MetadataItem> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5590(core.List<api.AccessConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNetworkInterface() {
  ...
  if (buildCounterNetworkInterface < 3) {
    o.accessConfigs = buildUnnamed5590();
    o.network = "foo";
    o.networkIp = "foo";
  }
  buildCounterNetworkInterface--;
...
checkNetworkInterface(api.NetworkInterface o) {
  buildCounterNetworkInterface++;
  if (buildCounterNetworkInterface < 3) {
    checkUnnamed5590(o.accessConfigs);
...
checkUnnamed5591(core.List<api.HealthCheck> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5592(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
buildPool() {
  ...
  if (buildCounterPool < 3) {
    ...
    o.description = "foo";
    o.healthChecks = buildUnnamed5591();
    o.initialNumReplicas = 42;
    o.labels = buildUnnamed5592();
    o.name = "foo";
    o.numReplicas = 42;
    o.resourceViews = buildUnnamed5593();
    o.selfLink = "foo";
    o.targetPool = "foo";
    o.targetPools = buildUnnamed5594();
...
checkPool(api.Pool o) {
  ...
  if (buildCounterPool < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    checkUnnamed5591(o.healthChecks);
    ...
    checkUnnamed5593(o.resourceViews);
    unittest.expect(o.selfLink, unittest.equals('foo'));
    unittest.expect(o.targetPool, unittest.equals('foo'));
    checkUnnamed5594(o.targetPools);
...
buildPoolsDeleteRequest() {
  ...
  if (buildCounterPoolsDeleteRequest < 3) {
    o.abandonInstances = buildUnnamed5595();
  }
  buildCounterPoolsDeleteRequest--;
  return o;
}
...
checkPoolsDeleteRequest(api.PoolsDeleteRequest o) {
  buildCounterPoolsDeleteRequest++;
  if (buildCounterPoolsDeleteRequest < 3) {
    checkUnnamed5595(o.abandonInstances);
  }
  buildCounterPoolsDeleteRequest--;
}
...
checkUnnamed5596(core.List<api.Pool> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPool(o[0]);
  checkPool(o[1]);
}
...
checkUnnamed5597(core.List<api.Replica> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReplica(o[0]);
  checkReplica(o[1]);
}
...
checkUnnamed5598(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed5600(core.List<api.HealthCheck> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHealthCheck(o[0]);
  checkHealthCheck(o[1]);
}
...
buildTemplate() {
  ...
  if (buildCounterTemplate < 3) {
    ...
    o.healthChecks = buildUnnamed5600();
    o.version = "foo";
...
checkTemplate(api.Template o) {
  ...
  if (buildCounterTemplate < 3) {
    ...
    checkUnnamed5600(o.healthChecks);
...
checkUnnamed5601(core.List<api.ExistingDisk> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5602(core.List<api.NewDisk> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNewDisk(o[0]);
  checkNewDisk(o[1]);
}
...
checkUnnamed5603(core.List<api.NetworkInterface> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5604(core.List<api.ServiceAccount> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVmParams() {
  ...
  if (buildCounterVmParams < 3) {
    ...
    o.canIpForward = true;
    o.description = "foo";
    o.disksToAttach = buildUnnamed5601();
    o.disksToCreate = buildUnnamed5602();
    o.machineType = "foo";
    o.metadata = buildMetadata();
    o.networkInterfaces = buildUnnamed5603();
    o.onHostMaintenance = "foo";
    o.serviceAccounts = buildUnnamed5604();
    o.tags = buildTag();
  }
  buildCounterVmParams--;
  return o;
...
checkVmParams(api.VmParams o) {
  ...
  if (buildCounterVmParams < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    checkUnnamed5601(o.disksToAttach);
    checkUnnamed5602(o.disksToCreate);
    unittest.expect(o.machineType, unittest.equals('foo'));
    checkMetadata(o.metadata);
    checkUnnamed5603(o.networkInterfaces);
    unittest.expect(o.onHostMaintenance, unittest.equals('foo'));
    checkUnnamed5604(o.serviceAccounts);
    checkTag(o.tags);
  }
  buildCounterVmParams--;
}
