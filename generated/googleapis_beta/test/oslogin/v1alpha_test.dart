...
checkUnnamed5115(core.List<api.PosixAccount> o) {
...
checkUnnamed5116(core.Map<core.String, api.SshPublicKey> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLoginProfile() {
  ...
  if (buildCounterLoginProfile < 3) {
    o.name = "foo";
    o.posixAccounts = buildUnnamed5115();
    o.sshPublicKeys = buildUnnamed5116();
  }
  buildCounterLoginProfile--;
  return o;
}
...
checkLoginProfile(api.LoginProfile o) {
  ...
  if (buildCounterLoginProfile < 3) {
    ...
    checkUnnamed5115(o.posixAccounts);
    checkUnnamed5116(o.sshPublicKeys);
  }
  buildCounterLoginProfile--;
}
