...
buildGoogleCloudPrivatecatalogproducerV1beta1ListAssociationsResponse() {
  ...
  if (buildCounterGoogleCloudPrivatecatalogproducerV1beta1ListAssociationsResponse <
      3) {
    o.associations = buildUnnamed5605();
    o.nextPageToken = "foo";
  }
  buildCounterGoogleCloudPrivatecatalogproducerV1beta1ListAssociationsResponse--;
  return o;
...
checkGoogleCloudPrivatecatalogproducerV1beta1ListAssociationsResponse(
  ...
  if (buildCounterGoogleCloudPrivatecatalogproducerV1beta1ListAssociationsResponse <
      3) {
    checkUnnamed5605(o.associations);
...
checkUnnamed5609(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudPrivatecatalogproducerV1beta1Product() {
  ...
  if (buildCounterGoogleCloudPrivatecatalogproducerV1beta1Product < 3) {
    o.assetType = "foo";
    o.createTime = "foo";
    o.displayMetadata = buildUnnamed5609();
    o.iconUri = "foo";
    o.name = "foo";
    o.updateTime = "foo";
  }
...
checkGoogleCloudPrivatecatalogproducerV1beta1Product(
  ...
  if (buildCounterGoogleCloudPrivatecatalogproducerV1beta1Product < 3) {
    ...
    unittest.expect(o.createTime, unittest.equals('foo'));
    checkUnnamed5609(o.displayMetadata);
...
checkUnnamed5610(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5611(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleCloudPrivatecatalogproducerV1beta1Version() {
  ...
  if (buildCounterGoogleCloudPrivatecatalogproducerV1beta1Version < 3) {
    o.asset = buildUnnamed5610();
    o.createTime = "foo";
    o.description = "foo";
    o.name = "foo";
    o.originalAsset = buildUnnamed5611();
    o.updateTime = "foo";
  }
  buildCounterGoogleCloudPrivatecatalogproducerV1beta1Version--;
  return o;
...
checkGoogleCloudPrivatecatalogproducerV1beta1Version(
  ...
  buildCounterGoogleCloudPrivatecatalogproducerV1beta1Version++;
  if (buildCounterGoogleCloudPrivatecatalogproducerV1beta1Version < 3) {
    checkUnnamed5610(o.asset);
    unittest.expect(o.createTime, unittest.equals('foo'));
    unittest.expect(o.description, unittest.equals('foo'));
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed5611(o.originalAsset);
    unittest.expect(o.updateTime, unittest.equals('foo'));
  }
  buildCounterGoogleCloudPrivatecatalogproducerV1beta1Version--;
}
...
checkUnnamed5612(core.List<api.GoogleIamV1AuditLogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleIamV1AuditConfig() {
  ...
  if (buildCounterGoogleIamV1AuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed5612();
    o.service = "foo";
  }
  buildCounterGoogleIamV1AuditConfig--;
  return o;
...
checkGoogleIamV1AuditConfig(api.GoogleIamV1AuditConfig o) {
  buildCounterGoogleIamV1AuditConfig++;
  if (buildCounterGoogleIamV1AuditConfig < 3) {
    checkUnnamed5612(o.auditLogConfigs);
...
checkUnnamed5613(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleIamV1AuditLogConfig() {
  ...
  if (buildCounterGoogleIamV1AuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed5613();
    o.logType = "foo";
  }
  buildCounterGoogleIamV1AuditLogConfig--;
  return o;
...
checkGoogleIamV1AuditLogConfig(api.GoogleIamV1AuditLogConfig o) {
  buildCounterGoogleIamV1AuditLogConfig++;
  if (buildCounterGoogleIamV1AuditLogConfig < 3) {
    checkUnnamed5613(o.exemptedMembers);
...
checkUnnamed5614(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
checkUnnamed5615(core.List<api.GoogleIamV1AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5616(core.List<api.GoogleIamV1Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildGoogleIamV1Policy() {
  ...
  if (buildCounterGoogleIamV1Policy < 3) {
    o.auditConfigs = buildUnnamed5615();
...
checkGoogleIamV1Policy(api.GoogleIamV1Policy o) {
  buildCounterGoogleIamV1Policy++;
  if (buildCounterGoogleIamV1Policy < 3) {
    checkUnnamed5615(o.auditConfigs);
...
buildGoogleIamV1TestIamPermissionsResponse() {
  ...
  if (buildCounterGoogleIamV1TestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed5618();
  }
  buildCounterGoogleIamV1TestIamPermissionsResponse--;
  return o;
}
...
checkGoogleIamV1TestIamPermissionsResponse(
  ...
  buildCounterGoogleIamV1TestIamPermissionsResponse++;
  if (buildCounterGoogleIamV1TestIamPermissionsResponse < 3) {
    checkUnnamed5618(o.permissions);
  }
  buildCounterGoogleIamV1TestIamPermissionsResponse--;
}
...
checkUnnamed5619(core.List<api.GoogleLongrunningOperation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5621(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed5622(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed5623() {
  ...
  o.add(buildUnnamed5622());
  o.add(buildUnnamed5622());
  return o;
}

checkUnnamed5623(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed5622(o[0]);
  checkUnnamed5622(o[1]);
}
