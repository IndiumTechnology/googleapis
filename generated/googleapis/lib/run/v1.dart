...
class NamespacesResourceApi {
  ...
  NamespacesAutodomainmappingsResourceApi get autodomainmappings =>
      new NamespacesAutodomainmappingsResourceApi(_requester);
...
class NamespacesAutodomainmappingsResourceApi {
  final commons.ApiRequester _requester;

  NamespacesAutodomainmappingsResourceApi(commons.ApiRequester client)
      : _requester = client;
  ...
  /// Request parameters:
  ///
  /// [parent] - The project ID or project number in which this auto domain
  /// mapping should
  /// be created.
  /// Value must have pattern "^namespaces/[^/]+$".
  ///
  ...
  /// response.
  ///
  /// Completes with a [AutoDomainMapping].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<AutoDomainMapping> create(
      AutoDomainMapping request, core.String parent,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
    ...
    var _response = _requester.request(_url, "POST",
        ...
        uploadMedia: _uploadMedia,
        downloadOptions: _downloadOptions);
    return _response.then((data) => new AutoDomainMapping.fromJson(data));
  }
  ...
  /// Value must have pattern "^namespaces/[^/]+/autodomainmappings/[^/]+$".
  ///
  ...
  /// response.
  ///
  /// Completes with a [K8sIoApimachineryPkgApisMetaV1Status].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<K8sIoApimachineryPkgApisMetaV1Status> delete(core.String name,
    ...
    return _response.then(
        (data) => new K8sIoApimachineryPkgApisMetaV1Status.fromJson(data));
  }
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<AutoDomainMapping> get(core.String name, {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
    var _uploadOptions;
  ...
  /// response.
  ///
  /// Completes with a [ListAutoDomainMappingsResponse].
  ///
  /// Completes with a [commons.ApiRequestError] if the API endpoint returned an
  /// error.
  ///
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<ListAutoDomainMappingsResponse> list(core.String parent,
    ...
    var _response = _requester.request(_url, "GET",
        ...
        downloadOptions: _downloadOptions);
    return _response
        .then((data) => new ListAutoDomainMappingsResponse.fromJson(data));
  }
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<AutoDomainMapping> replaceAutoDomainMapping(
      AutoDomainMapping request, core.String name,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
...
class NamespacesConfigurationsResourceApi {
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Configuration> replaceConfiguration(
      Configuration request, core.String name,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
...
class NamespacesDomainmappingsResourceApi {
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<DomainMapping> replaceDomainMapping(
      DomainMapping request, core.String name,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
...
class NamespacesRoutesResourceApi {
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Route> create(Route request, core.String parent,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
  ...
  /// Request parameters:
  ///
  /// [parent] - The project ID or project number from which the routes should
  /// be listed.
  /// Value must have pattern "^namespaces/[^/]+$".
  ///
  /// [continue_] - Optional encoded string to continue paging.
  ...
  /// If the used [http.Client] completes with an error when making a REST call,
  /// this method will complete with the same error.
  async.Future<Route> replaceRoute(Route request, core.String name,
      {core.String $fields}) {
    var _url;
    var _queryParams = new core.Map<core.String, core.List<core.String>>();
    var _uploadMedia;
...
class NamespacesServicesResourceApi {
  ...
  /// Request parameters:
  ///
  /// [parent] - The project ID or project number in which this service should
  /// be created.
  /// Value must have pattern "^namespaces/[^/]+$".
  ///
  /// [$fields] - Selector specifying which fields to include in a partial
  ...
  /// Request parameters:
  ///
  /// [parent] - The project ID or project number from which the services should
  /// be listed.
  /// Value must have pattern "^namespaces/[^/]+$".
  ///
  /// [limit] - The maximum number of records that should be returned.
...
class ProjectsLocationsResourceApi {
  ...
  ProjectsLocationsAutodomainmappingsResourceApi get autodomainmappings =>
      new ProjectsLocationsAutodomainmappingsResourceApi(_requester);
...
class ProjectsLocationsAutodomainmappingsResourceApi {
  final commons.ApiRequester _requester;

  ProjectsLocationsAutodomainmappingsResourceApi(commons.ApiRequester client)
      : _requester = client;
...
class AutoDomainMapping {
  ...
  K8sIoApimachineryPkgApisMetaV1ObjectMeta metadata;

  /// The spec for this AutoDomainMapping.
  AutoDomainMappingSpec spec;

  /// The current status of the AutoDomainMapping.
  AutoDomainMappingStatus status;

  AutoDomainMapping();

  AutoDomainMapping.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("metadata")) {
      metadata = new K8sIoApimachineryPkgApisMetaV1ObjectMeta.fromJson(
          _json["metadata"]);
    }
    if (_json.containsKey("spec")) {
      spec = new AutoDomainMappingSpec.fromJson(_json["spec"]);
    }
    if (_json.containsKey("status")) {
      status = new AutoDomainMappingStatus.fromJson(_json["status"]);
    }
  }
...
class AutoDomainMappingSpec {
  ...
  AutoDomainMappingSpec.fromJson(core.Map _json) {
    if (_json.containsKey("certificateMode")) {
      certificateMode = _json["certificateMode"];
    }
    if (_json.containsKey("expansionType")) {
      expansionType = _json["expansionType"];
    }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (expansionType != null) {
      _json["expansionType"] = expansionType;
    }
...
class AutoDomainMappingStatus {
  /// Array of observed AutoDomainMappingConditions, indicating the current
  /// state
  ...
  AutoDomainMappingStatus.fromJson(core.Map _json) {
...
class K8sIoApimachineryPkgApisMetaV1ListMeta {
  ...
  K8sIoApimachineryPkgApisMetaV1ListMeta.fromJson(core.Map _json) {
...
class K8sIoApimachineryPkgApisMetaV1ObjectMeta {
  ...
  core.List<K8sIoApimachineryPkgApisMetaV1OwnerReference> ownerReferences;
  ...
  K8sIoApimachineryPkgApisMetaV1ObjectMeta.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("ownerReferences")) {
      ownerReferences = (_json["ownerReferences"] as core.List)
          .map<K8sIoApimachineryPkgApisMetaV1OwnerReference>((value) =>
              new K8sIoApimachineryPkgApisMetaV1OwnerReference.fromJson(value))
          .toList();
    }
    if (_json.containsKey("resourceVersion")) {
      resourceVersion = _json["resourceVersion"];
...
class K8sIoApimachineryPkgApisMetaV1OwnerReference {
  ...
  K8sIoApimachineryPkgApisMetaV1OwnerReference.fromJson(core.Map _json) {
    if (_json.containsKey("apiVersion")) {
      apiVersion = _json["apiVersion"];
    }
...
class K8sIoApimachineryPkgApisMetaV1Status {
  ...
  /// the reason type.
  /// +optional
  K8sIoApimachineryPkgApisMetaV1StatusDetails details;
  ...
  /// https://git.k8s.io/community/contributors/devel/api-conventions.md#types-kinds
  /// +optional
  K8sIoApimachineryPkgApisMetaV1ListMeta metadata;
  ...
  K8sIoApimachineryPkgApisMetaV1Status.fromJson(core.Map _json) {
    if (_json.containsKey("code")) {
      code = _json["code"];
    }
    if (_json.containsKey("details")) {
      details = new K8sIoApimachineryPkgApisMetaV1StatusDetails.fromJson(
          _json["details"]);
    }
    if (_json.containsKey("message")) {
      message = _json["message"];
    ...
    if (_json.containsKey("metadata")) {
      metadata = new K8sIoApimachineryPkgApisMetaV1ListMeta.fromJson(
          _json["metadata"]);
    }
    if (_json.containsKey("reason")) {
      reason = _json["reason"];
...
class K8sIoApimachineryPkgApisMetaV1StatusCause {
  ...
  K8sIoApimachineryPkgApisMetaV1StatusCause.fromJson(core.Map _json) {
...
class K8sIoApimachineryPkgApisMetaV1StatusDetails {
  ...
  /// +optional
  core.List<K8sIoApimachineryPkgApisMetaV1StatusCause> causes;
  ...
  K8sIoApimachineryPkgApisMetaV1StatusDetails.fromJson(core.Map _json) {
    if (_json.containsKey("causes")) {
      causes = (_json["causes"] as core.List)
          .map<K8sIoApimachineryPkgApisMetaV1StatusCause>((value) =>
              new K8sIoApimachineryPkgApisMetaV1StatusCause.fromJson(value))
          .toList();
    }
...
class ListAutoDomainMappingsResponse {
  ...
  core.List<AutoDomainMapping> items;
  ...
  core.Map<core.String, RegionDetails> regionDetails;

  /// Locations that could not be reached.
  core.List<core.String> unreachable;

  ListAutoDomainMappingsResponse();

  ListAutoDomainMappingsResponse.fromJson(core.Map _json) {
    if (_json.containsKey("apiVersion")) {
      apiVersion = _json["apiVersion"];
    }
    if (_json.containsKey("items")) {
      items = (_json["items"] as core.List)
          .map<AutoDomainMapping>(
              (value) => new AutoDomainMapping.fromJson(value))
          .toList();
    }
    if (_json.containsKey("kind")) {
      kind = _json["kind"];
    ...
    if (_json.containsKey("regionDetails")) {
      regionDetails = commons.mapMap<core.Map, RegionDetails>(
          _json["regionDetails"].cast<core.String, core.Map>(),
          (core.Map item) => new RegionDetails.fromJson(item));
    }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (regionDetails != null) {
      _json["regionDetails"] =
          commons.mapMap<RegionDetails, core.Map<core.String, core.Object>>(
              regionDetails, (RegionDetails item) => (item).toJson());
    }
    if (unreachable != null) {
...
class Probe {
  ...
  Probe.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("handler")) {
      handler = new Handler.fromJson(_json["handler"]);
    }
...
class RegionDetails {
  ...
  RegionDetails.fromJson(core.Map _json) {
