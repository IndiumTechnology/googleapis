...
class GoogleCloudVisionV1p4beta1AnnotateImageResponse {
  ...
  GoogleCloudVisionV1p4beta1ImageQuality imageQualityAnnotation;
  ...
  GoogleCloudVisionV1p4beta1QualityOptimizationResult qualityOptimizationResult;
  ...
  GoogleCloudVisionV1p4beta1AnnotateImageResponse.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("imageQualityAnnotation")) {
      imageQualityAnnotation =
          new GoogleCloudVisionV1p4beta1ImageQuality.fromJson(
              _json["imageQualityAnnotation"]);
    }
    if (_json.containsKey("labelAnnotations")) {
      labelAnnotations = (_json["labelAnnotations"] as core.List)
    ...
    if (_json.containsKey("qualityOptimizationResult")) {
      qualityOptimizationResult =
          new GoogleCloudVisionV1p4beta1QualityOptimizationResult.fromJson(
              _json["qualityOptimizationResult"]);
    }
    if (_json.containsKey("safeSearchAnnotation")) {
      safeSearchAnnotation =
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (imageQualityAnnotation != null) {
      _json["imageQualityAnnotation"] = (imageQualityAnnotation).toJson();
    }
    if (labelAnnotations != null) {
      _json["labelAnnotations"] =
          labelAnnotations.map((value) => (value).toJson()).toList();
    ...
    if (qualityOptimizationResult != null) {
      _json["qualityOptimizationResult"] = (qualityOptimizationResult).toJson();
    }
    if (safeSearchAnnotation != null) {
      _json["safeSearchAnnotation"] = (safeSearchAnnotation).toJson();
    }
...
class GoogleCloudVisionV1p4beta1ImageQuality {
  ...
  GoogleCloudVisionV1p4beta1ImageQuality.fromJson(core.Map _json) {
    if (_json.containsKey("qualityScore")) {
      qualityScore = _json["qualityScore"].toDouble();
    }
  }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (qualityScore != null) {
      _json["qualityScore"] = qualityScore;
    }
    return _json;
  }
}
...
class GoogleCloudVisionV1p4beta1QualityOptimizationResult {
  ...
  core.String qualityOptimizationType;

  GoogleCloudVisionV1p4beta1QualityOptimizationResult();

  GoogleCloudVisionV1p4beta1QualityOptimizationResult.fromJson(core.Map _json) {
    if (_json.containsKey("image")) {
      image = _json["image"];
    }
    if (_json.containsKey("mimeType")) {
    ...
    if (_json.containsKey("qualityOptimizationType")) {
      qualityOptimizationType = _json["qualityOptimizationType"];
    }
  }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (qualityOptimizationType != null) {
      _json["qualityOptimizationType"] = qualityOptimizationType;
    }
    return _json;
  }
}
...
class GoogleCloudVisionV1p4beta1SafeSearchAnnotation {
  ...
  /// Confidence of nsfw_score. Range [0, 1]. 0 means not confident, 1 means
  /// very
  /// confident.
  ...
  /// Confidence of racy_score. Range [0, 1]. 0 means not confident, 1 means
  /// very
  /// confident.
  ...
  GoogleCloudVisionV1p4beta1SafeSearchAnnotation.fromJson(core.Map _json) {
    ...
    if (_json.containsKey("adultConfidence")) {
      adultConfidence = _json["adultConfidence"].toDouble();
    }
    if (_json.containsKey("medical")) {
      medical = _json["medical"];
    }
    if (_json.containsKey("medicalConfidence")) {
      medicalConfidence = _json["medicalConfidence"].toDouble();
    }
    if (_json.containsKey("nsfwConfidence")) {
      nsfwConfidence = _json["nsfwConfidence"].toDouble();
    }
    if (_json.containsKey("racy")) {
      racy = _json["racy"];
    }
    if (_json.containsKey("racyConfidence")) {
      racyConfidence = _json["racyConfidence"].toDouble();
    }
    if (_json.containsKey("spoof")) {
      spoof = _json["spoof"];
    }
    if (_json.containsKey("spoofConfidence")) {
      spoofConfidence = _json["spoofConfidence"].toDouble();
    }
    if (_json.containsKey("violence")) {
      violence = _json["violence"];
    }
    if (_json.containsKey("violenceConfidence")) {
      violenceConfidence = _json["violenceConfidence"].toDouble();
    }
  }
  ...
  core.Map<core.String, core.Object> toJson() {
    ...
    if (adultConfidence != null) {
      _json["adultConfidence"] = adultConfidence;
    }
    if (medical != null) {
      _json["medical"] = medical;
    }
    if (medicalConfidence != null) {
      _json["medicalConfidence"] = medicalConfidence;
    }
    if (nsfwConfidence != null) {
      _json["nsfwConfidence"] = nsfwConfidence;
    }
    if (racy != null) {
      _json["racy"] = racy;
    }
    if (racyConfidence != null) {
      _json["racyConfidence"] = racyConfidence;
    }
    if (spoof != null) {
      _json["spoof"] = spoof;
    }
    if (spoofConfidence != null) {
      _json["spoofConfidence"] = spoofConfidence;
    }
    if (violence != null) {
      _json["violence"] = violence;
    }
    if (violenceConfidence != null) {
      _json["violenceConfidence"] = violenceConfidence;
    }
    return _json;
  }
}
