...
checkUnnamed2861(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed2861();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed2861(o.auditLogConfigs);
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed2862();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed2862(o.exemptedMembers);
...
checkUnnamed2864(core.List<api.Repo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRepo(o[0]);
  checkRepo(o[1]);
}
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed2865();
    o.name = "foo";
    o.response = buildUnnamed2866();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed2865(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2866(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed2867(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2868(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed2867();
    o.bindings = buildUnnamed2868();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed2867(o.auditConfigs);
    checkUnnamed2868(o.bindings);
...
checkUnnamed2869(core.Map<core.String, api.PubsubConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildProjectConfig() {
  ...
  if (buildCounterProjectConfig < 3) {
    ...
    o.name = "foo";
    o.pubsubConfigs = buildUnnamed2869();
  }
  buildCounterProjectConfig--;
  return o;
}
...
checkProjectConfig(api.ProjectConfig o) {
  ...
  if (buildCounterProjectConfig < 3) {
    ...
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2869(o.pubsubConfigs);
  }
  buildCounterProjectConfig--;
}
...
checkUnnamed2870(core.Map<core.String, api.PubsubConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPubsubConfig(o["x"]);
  checkPubsubConfig(o["y"]);
}
...
buildRepo() {
  ...
  if (buildCounterRepo < 3) {
    ...
    o.name = "foo";
    o.pubsubConfigs = buildUnnamed2870();
    o.size = "foo";
    o.url = "foo";
  }
  buildCounterRepo--;
...
checkRepo(api.Repo o) {
  ...
  if (buildCounterRepo < 3) {
    ...
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed2870(o.pubsubConfigs);
...
checkUnnamed2872(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSyncRepoMetadata() {
  var o = new api.SyncRepoMetadata();
...
checkSyncRepoMetadata(api.SyncRepoMetadata o) {
  buildCounterSyncRepoMetadata++;
  if (buildCounterSyncRepoMetadata < 3) {
    unittest.expect(o.name, unittest.equals('foo'));
...
buildSyncRepoRequest() {
  var o = new api.SyncRepoRequest();
...
checkSyncRepoRequest(api.SyncRepoRequest o) {
  buildCounterSyncRepoRequest++;
  if (buildCounterSyncRepoRequest < 3) {}
  buildCounterSyncRepoRequest--;
}
...
main() {
  ...
  unittest.group("obj-schema-SyncRepoMetadata", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SyncRepoMetadata.fromJson(o.toJson());
  ...
  unittest.group("obj-schema-SyncRepoRequest", () {
    unittest.test("to-json--from-json", () {
      ...
      var od = new api.SyncRepoRequest.fromJson(o.toJson());
  ...
  unittest.group("resource-ProjectsReposResourceApi", () {
    ...
    unittest.test("method--sync", () {
      ...
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var obj = new api.SyncRepoRequest.fromJson(json);
