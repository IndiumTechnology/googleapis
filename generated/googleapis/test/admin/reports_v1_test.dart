...
checkUnnamed3907(core.List<api.Activity> o) {
...
checkUnnamed3908(core.List<api.NestedParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3910(core.List<api.NestedParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNestedParameter(o[0]);
  checkNestedParameter(o[1]);
}
...
checkUnnamed3911(core.List<api.ActivityEventsParametersMultiMessageValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityEventsParameters() {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    ...
    o.multiIntValue = buildUnnamed3909();
    o.multiMessageValue = buildUnnamed3911();
    o.multiValue = buildUnnamed3912();
    o.name = "foo";
    o.value = "foo";
  }
  buildCounterActivityEventsParameters--;
...
checkActivityEventsParameters(api.ActivityEventsParameters o) {
  ...
  if (buildCounterActivityEventsParameters < 3) {
    ...
    checkUnnamed3909(o.multiIntValue);
    checkUnnamed3911(o.multiMessageValue);
    checkUnnamed3912(o.multiValue);
...
checkUnnamed3913(core.List<api.ActivityEventsParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3914(core.List<api.ActivityEvents> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3916(core.List<core.bool> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNestedParameter() {
  ...
  if (buildCounterNestedParameter < 3) {
    o.boolValue = true;
    o.intValue = "foo";
    o.multiBoolValue = buildUnnamed3916();
    o.multiIntValue = buildUnnamed3917();
    o.multiValue = buildUnnamed3918();
    o.name = "foo";
    o.value = "foo";
  }
  buildCounterNestedParameter--;
...
checkNestedParameter(api.NestedParameter o) {
  ...
  if (buildCounterNestedParameter < 3) {
    unittest.expect(o.boolValue, unittest.isTrue);
    unittest.expect(o.intValue, unittest.equals('foo'));
    checkUnnamed3916(o.multiBoolValue);
    checkUnnamed3917(o.multiIntValue);
    checkUnnamed3918(o.multiValue);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.value, unittest.equals('foo'));
  }
  buildCounterNestedParameter--;
...
checkUnnamed3919(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed3920() {
  ...
  o.add(buildUnnamed3919());
  o.add(buildUnnamed3919());
  return o;
}

checkUnnamed3920(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3919(o[0]);
  checkUnnamed3919(o[1]);
}
...
checkUnnamed3921(core.List<api.UsageReportParameters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3922(core.List<api.UsageReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3923(core.List<api.UsageReportsWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3924(core.List<api.UsageReportsWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUsageReports() {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.usageReports = buildUnnamed3922();
    o.warnings = buildUnnamed3924();
  }
  buildCounterUsageReports--;
  return o;
}
...
checkUsageReports(api.UsageReports o) {
  ...
  if (buildCounterUsageReports < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3922(o.usageReports);
    checkUnnamed3924(o.warnings);
  }
  buildCounterUsageReports--;
}
