...
checkUnnamed3875(core.List<api.ApplicationTransferParam> o) {
...
buildApplication() {
  ...
  if (buildCounterApplication < 3) {
    ...
    o.kind = "foo";
    o.name = "foo";
    o.transferParams = buildUnnamed3875();
  }
  buildCounterApplication--;
  return o;
}
...
checkApplication(api.Application o) {
  ...
  if (buildCounterApplication < 3) {
    ...
    checkUnnamed3875(o.transferParams);
  }
  buildCounterApplication--;
}
...
checkUnnamed3876(core.List<api.ApplicationTransferParam> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApplicationTransferParam(o[0]);
  checkApplicationTransferParam(o[1]);
}
...
buildApplicationDataTransfer() {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    o.applicationId = "foo";
    o.applicationTransferParams = buildUnnamed3876();
...
checkApplicationDataTransfer(api.ApplicationDataTransfer o) {
  ...
  if (buildCounterApplicationDataTransfer < 3) {
    ...
    checkUnnamed3876(o.applicationTransferParams);
...
checkUnnamed3878(core.List<api.Application> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildApplicationsListResponse() {
  ...
  if (buildCounterApplicationsListResponse < 3) {
    o.applications = buildUnnamed3878();
    o.etag = "foo";
    o.kind = "foo";
    o.nextPageToken = "foo";
  }
...
checkApplicationsListResponse(api.ApplicationsListResponse o) {
  buildCounterApplicationsListResponse++;
  if (buildCounterApplicationsListResponse < 3) {
    checkUnnamed3878(o.applications);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3879(core.List<api.ApplicationDataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDataTransfer() {
  ...
  if (buildCounterDataTransfer < 3) {
    o.applicationDataTransfers = buildUnnamed3879();
    o.etag = "foo";
    o.id = "foo";
    o.kind = "foo";
...
checkDataTransfer(api.DataTransfer o) {
  buildCounterDataTransfer++;
  if (buildCounterDataTransfer < 3) {
    checkUnnamed3879(o.applicationDataTransfers);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed3880(core.List<api.DataTransfer> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDataTransfersListResponse() {
  ...
  if (buildCounterDataTransfersListResponse < 3) {
    o.dataTransfers = buildUnnamed3880();
    o.etag = "foo";
    o.kind = "foo";
    o.nextPageToken = "foo";
  }
...
checkDataTransfersListResponse(api.DataTransfersListResponse o) {
  buildCounterDataTransfersListResponse++;
  if (buildCounterDataTransfersListResponse < 3) {
    checkUnnamed3880(o.dataTransfers);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
