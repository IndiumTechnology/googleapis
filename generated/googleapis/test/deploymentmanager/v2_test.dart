...
checkUnnamed3440(core.List<api.AuditLogConfig> o) {
...
buildAuditConfig() {
  ...
  if (buildCounterAuditConfig < 3) {
    o.auditLogConfigs = buildUnnamed3440();
    o.exemptedMembers = buildUnnamed3441();
    o.service = "foo";
  }
  buildCounterAuditConfig--;
  return o;
...
checkAuditConfig(api.AuditConfig o) {
  buildCounterAuditConfig++;
  if (buildCounterAuditConfig < 3) {
    checkUnnamed3440(o.auditLogConfigs);
    checkUnnamed3441(o.exemptedMembers);
...
buildAuditLogConfig() {
  ...
  if (buildCounterAuditLogConfig < 3) {
    o.exemptedMembers = buildUnnamed3442();
    o.logType = "foo";
  }
  buildCounterAuditLogConfig--;
  return o;
...
checkAuditLogConfig(api.AuditLogConfig o) {
  buildCounterAuditLogConfig++;
  if (buildCounterAuditLogConfig < 3) {
    checkUnnamed3442(o.exemptedMembers);
...
checkUnnamed3445(core.List<api.DeploymentLabelEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3446(core.List<api.DeploymentUpdateLabelEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3447(core.List<api.Deployment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeployment(o[0]);
  checkDeployment(o[1]);
}
...
buildDeploymentsListResponse() {
  ...
  if (buildCounterDeploymentsListResponse < 3) {
    o.deployments = buildUnnamed3447();
    o.nextPageToken = "foo";
  }
  buildCounterDeploymentsListResponse--;
  return o;
...
checkDeploymentsListResponse(api.DeploymentsListResponse o) {
  buildCounterDeploymentsListResponse++;
  if (buildCounterDeploymentsListResponse < 3) {
    checkUnnamed3447(o.deployments);
...
checkUnnamed3448(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
checkUnnamed3449(core.List<api.ImportFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImportFile(o[0]);
  checkImportFile(o[1]);
}
...
checkUnnamed3450(core.List<api.Manifest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkManifest(o[0]);
  checkManifest(o[1]);
}
...
checkUnnamed3451(core.List<api.OperationErrorErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3452(core.List<api.OperationWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3453(core.List<api.OperationWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3454(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed3455(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3456(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
checkUnnamed3457(core.List<api.Rule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRule(o[0]);
  checkRule(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed3455();
    o.bindings = buildUnnamed3456();
    o.etag = "foo";
    o.iamOwned = true;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed3455(o.auditConfigs);
    checkUnnamed3456(o.bindings);
    unittest.expect(o.etag, unittest.equals('foo'));
...
checkUnnamed3458(core.List<api.ResourceWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3459(core.List<api.ResourceWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3460(core.List<api.ResourceUpdateErrorErrors> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3461(core.List<api.ResourceUpdateWarningsData> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3462(core.List<api.ResourceUpdateWarnings> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3463(core.List<api.Resource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResource(o[0]);
  checkResource(o[1]);
}
...
checkUnnamed3464(core.List<api.Condition> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCondition(o[0]);
  checkCondition(o[1]);
}
...
checkUnnamed3466(core.List<api.LogConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLogConfig(o[0]);
  checkLogConfig(o[1]);
}
...
buildRule() {
  ...
  if (buildCounterRule < 3) {
    o.action = "foo";
    o.conditions = buildUnnamed3464();
    o.description = "foo";
    o.ins = buildUnnamed3465();
    o.logConfigs = buildUnnamed3466();
    o.notIns = buildUnnamed3467();
...
checkRule(api.Rule o) {
  ...
  if (buildCounterRule < 3) {
    ...
    checkUnnamed3464(o.conditions);
    unittest.expect(o.description, unittest.equals('foo'));
    checkUnnamed3465(o.ins);
    checkUnnamed3466(o.logConfigs);
    checkUnnamed3467(o.notIns);
...
checkUnnamed3469(core.List<api.ImportFile> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImportFile(o[0]);
  checkImportFile(o[1]);
}
...
checkUnnamed3472(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}
