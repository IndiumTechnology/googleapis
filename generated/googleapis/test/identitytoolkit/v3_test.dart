...
buildCreateAuthUriResponse() {
  ...
  if (buildCounterCreateAuthUriResponse < 3) {
    o.allProviders = buildUnnamed396();
    o.authUri = "foo";
    ...
    o.registered = true;
    o.sessionId = "foo";
    o.signinMethods = buildUnnamed397();
  }
  buildCounterCreateAuthUriResponse--;
  return o;
}
...
checkCreateAuthUriResponse(api.CreateAuthUriResponse o) {
  buildCounterCreateAuthUriResponse++;
  if (buildCounterCreateAuthUriResponse < 3) {
    checkUnnamed396(o.allProviders);
    ...
    checkUnnamed397(o.signinMethods);
  }
  buildCounterCreateAuthUriResponse--;
}
...
checkUnnamed398(core.List<api.UserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserInfo(o[0]);
  checkUserInfo(o[1]);
}
...
checkUnnamed399(core.List<api.UserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserInfo(o[0]);
  checkUserInfo(o[1]);
}
...
checkUnnamed400(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildIdentitytoolkitRelyingpartyCreateAuthUriRequest() {
  ...
  if (buildCounterIdentitytoolkitRelyingpartyCreateAuthUriRequest < 3) {
    ...
    o.context = "foo";
    o.continueUri = "foo";
    o.customParameter = buildUnnamed400();
    o.hostedDomain = "foo";
    o.identifier = "foo";
...
checkIdentitytoolkitRelyingpartyCreateAuthUriRequest(
  ...
  if (buildCounterIdentitytoolkitRelyingpartyCreateAuthUriRequest < 3) {
    ...
    checkUnnamed400(o.customParameter);
...
buildIdentitytoolkitRelyingpartyGetAccountInfoRequest() {
  ...
  if (buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest < 3) {
    o.delegatedProjectNumber = "foo";
    o.email = buildUnnamed401();
    o.idToken = "foo";
    o.localId = buildUnnamed402();
    o.phoneNumber = buildUnnamed403();
  }
  buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest--;
  return o;
}
...
checkIdentitytoolkitRelyingpartyGetAccountInfoRequest(
  ...
  if (buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest < 3) {
    unittest.expect(o.delegatedProjectNumber, unittest.equals('foo'));
    checkUnnamed401(o.email);
    unittest.expect(o.idToken, unittest.equals('foo'));
    checkUnnamed402(o.localId);
    checkUnnamed403(o.phoneNumber);
  }
  buildCounterIdentitytoolkitRelyingpartyGetAccountInfoRequest--;
}
...
checkUnnamed405(core.List<api.IdpConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIdpConfig(o[0]);
  checkIdpConfig(o[1]);
}
...
checkIdentitytoolkitRelyingpartyGetProjectConfigResponse(
  ...
  if (buildCounterIdentitytoolkitRelyingpartyGetProjectConfigResponse < 3) {
    ...
    checkUnnamed404(o.authorizedDomains);
...
buildIdentitytoolkitRelyingpartySetAccountInfoRequest() {
  ...
  if (buildCounterIdentitytoolkitRelyingpartySetAccountInfoRequest < 3) {
    ...
    o.delegatedProjectNumber = "foo";
    o.deleteAttribute = buildUnnamed406();
    o.deleteProvider = buildUnnamed407();
    o.disableUser = true;
    o.displayName = "foo";
    o.email = "foo";
...
checkIdentitytoolkitRelyingpartySetAccountInfoRequest(
  ...
  if (buildCounterIdentitytoolkitRelyingpartySetAccountInfoRequest < 3) {
    ...
    unittest.expect(o.delegatedProjectNumber, unittest.equals('foo'));
    checkUnnamed406(o.deleteAttribute);
    checkUnnamed407(o.deleteProvider);
...
checkUnnamed411(core.List<api.UserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserInfo(o[0]);
  checkUserInfo(o[1]);
}
...
buildIdpConfig() {
  ...
  if (buildCounterIdpConfig < 3) {
    ...
    o.provider = "foo";
    o.secret = "foo";
    o.whitelistedAudiences = buildUnnamed412();
  }
  buildCounterIdpConfig--;
  return o;
}
...
checkIdpConfig(api.IdpConfig o) {
  ...
  if (buildCounterIdpConfig < 3) {
    ...
    checkUnnamed412(o.whitelistedAudiences);
  }
  buildCounterIdpConfig--;
}
...
checkUnnamed413(core.List<api.SetAccountInfoResponseProviderUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSetAccountInfoResponse() {
  ...
  if (buildCounterSetAccountInfoResponse < 3) {
    ...
    o.passwordHash = "foo";
    o.photoUrl = "foo";
    o.providerUserInfo = buildUnnamed413();
    o.refreshToken = "foo";
  }
  buildCounterSetAccountInfoResponse--;
  return o;
...
checkSetAccountInfoResponse(api.SetAccountInfoResponse o) {
  ...
  if (buildCounterSetAccountInfoResponse < 3) {
    ...
    unittest.expect(o.photoUrl, unittest.equals('foo'));
    checkUnnamed413(o.providerUserInfo);
    unittest.expect(o.refreshToken, unittest.equals('foo'));
  }
  buildCounterSetAccountInfoResponse--;
}
...
checkUnnamed414(core.List<api.UploadAccountResponseError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed415(core.List<api.UserInfoProviderUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUserInfo() {
  ...
  if (buildCounterUserInfo < 3) {
    ...
    o.phoneNumber = "foo";
    o.photoUrl = "foo";
    o.providerUserInfo = buildUnnamed415();
    o.rawPassword = "foo";
    o.salt = "foo";
    o.screenName = "foo";
    o.validSince = "foo";
...
checkUserInfo(api.UserInfo o) {
  ...
  if (buildCounterUserInfo < 3) {
    ...
    unittest.expect(o.phoneNumber, unittest.equals('foo'));
    unittest.expect(o.photoUrl, unittest.equals('foo'));
    checkUnnamed415(o.providerUserInfo);
...
buildVerifyAssertionResponse() {
  ...
  if (buildCounterVerifyAssertionResponse < 3) {
    ...
    o.screenName = "foo";
    o.timeZone = "foo";
    o.verifiedProvider = buildUnnamed416();
  }
  buildCounterVerifyAssertionResponse--;
  return o;
}
...
checkVerifyAssertionResponse(api.VerifyAssertionResponse o) {
  ...
  if (buildCounterVerifyAssertionResponse < 3) {
    ...
    checkUnnamed416(o.verifiedProvider);
  }
  buildCounterVerifyAssertionResponse--;
}
