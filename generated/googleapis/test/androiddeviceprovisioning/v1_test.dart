...
checkUnnamed2832(core.List<api.PartnerClaim> o) {
...
buildCompany() {
  ...
  if (buildCounterCompany < 3) {
    o.adminEmails = buildUnnamed2833();
    o.companyId = "foo";
    o.companyName = "foo";
    o.name = "foo";
    o.ownerEmails = buildUnnamed2834();
    o.termsStatus = "foo";
  }
  buildCounterCompany--;
  return o;
...
checkUnnamed2835(core.List<api.Configuration> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCustomerListConfigurationsResponse() {
  ...
  if (buildCounterCustomerListConfigurationsResponse < 3) {
    o.configurations = buildUnnamed2835();
  }
  buildCounterCustomerListConfigurationsResponse--;
  return o;
}
...
checkCustomerListConfigurationsResponse(
  ...
  buildCounterCustomerListConfigurationsResponse++;
  if (buildCounterCustomerListConfigurationsResponse < 3) {
    checkUnnamed2835(o.configurations);
  }
  buildCounterCustomerListConfigurationsResponse--;
}
...
checkUnnamed2836(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
checkUnnamed2837(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
...
checkUnnamed2838(core.List<api.Dpc> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDpc(o[0]);
  checkDpc(o[1]);
}
...
checkUnnamed2839(core.List<api.DeviceClaim> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2841(core.List<api.OperationPerDevice> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDevicesLongRunningOperationResponse() {
  ...
  if (buildCounterDevicesLongRunningOperationResponse < 3) {
    o.perDeviceStatus = buildUnnamed2841();
    o.successCount = 42;
  }
  buildCounterDevicesLongRunningOperationResponse--;
  return o;
...
checkDevicesLongRunningOperationResponse(
  ...
  buildCounterDevicesLongRunningOperationResponse++;
  if (buildCounterDevicesLongRunningOperationResponse < 3) {
    checkUnnamed2841(o.perDeviceStatus);
...
checkUnnamed2842(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
...
checkUnnamed2844(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
...
checkUnnamed2845(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
checkUnnamed2846(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
checkUnnamed2847(core.List<api.Company> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCompany(o[0]);
  checkCompany(o[1]);
}
...
checkUnnamed2850(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2851() {
  ...
  o.add(buildUnnamed2850());
  o.add(buildUnnamed2850());
  return o;
}

checkUnnamed2851(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2850(o[0]);
  checkUnnamed2850(o[1]);
}
...
checkUnnamed2852(core.List<api.PartnerUnclaim> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2853(core.List<api.UpdateMetadataArguments> o) {
  unittest.expect(o, unittest.hasLength(2));
