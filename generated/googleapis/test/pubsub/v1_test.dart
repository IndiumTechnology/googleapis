...
checkUnnamed377(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed378(core.List<api.Snapshot> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSnapshot(o[0]);
  checkSnapshot(o[1]);
}
...
checkUnnamed379(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListSubscriptionsResponse() {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed379();
  }
  buildCounterListSubscriptionsResponse--;
  return o;
}
...
checkListSubscriptionsResponse(api.ListSubscriptionsResponse o) {
  ...
  if (buildCounterListSubscriptionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed379(o.subscriptions);
  }
  buildCounterListSubscriptionsResponse--;
}
...
buildListTopicSubscriptionsResponse() {
  ...
  if (buildCounterListTopicSubscriptionsResponse < 3) {
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed381();
  }
  buildCounterListTopicSubscriptionsResponse--;
  return o;
}
...
checkListTopicSubscriptionsResponse(api.ListTopicSubscriptionsResponse o) {
  ...
  if (buildCounterListTopicSubscriptionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed381(o.subscriptions);
  }
  buildCounterListTopicSubscriptionsResponse--;
}
...
checkUnnamed382(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
buildMessageStoragePolicy() {
  ...
  if (buildCounterMessageStoragePolicy < 3) {
    o.allowedPersistenceRegions = buildUnnamed383();
  }
  buildCounterMessageStoragePolicy--;
  return o;
}
...
checkMessageStoragePolicy(api.MessageStoragePolicy o) {
  buildCounterMessageStoragePolicy++;
  if (buildCounterMessageStoragePolicy < 3) {
    checkUnnamed383(o.allowedPersistenceRegions);
  }
  buildCounterMessageStoragePolicy--;
}
...
checkUnnamed385(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
checkUnnamed386(core.List<api.PubsubMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed388(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed389(core.List<api.ReceivedMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPullResponse() {
  ...
  if (buildCounterPullResponse < 3) {
    o.receivedMessages = buildUnnamed389();
  }
  buildCounterPullResponse--;
  return o;
}
...
checkPullResponse(api.PullResponse o) {
  buildCounterPullResponse++;
  if (buildCounterPullResponse < 3) {
    checkUnnamed389(o.receivedMessages);
  }
  buildCounterPullResponse--;
}
...
checkUnnamed391(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed392(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed395(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
