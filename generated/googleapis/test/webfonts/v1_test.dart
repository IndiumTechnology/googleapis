...
checkUnnamed1199(core.Map<core.String, core.String> o) {
...
buildWebfont() {
  ...
  if (buildCounterWebfont < 3) {
    o.category = "foo";
    o.family = "foo";
    o.files = buildUnnamed1199();
    o.kind = "foo";
    o.lastModified = core.DateTime.parse("2002-02-27T14:01:02Z");
    o.subsets = buildUnnamed1200();
    o.variants = buildUnnamed1201();
    o.version = "foo";
  }
  buildCounterWebfont--;
  return o;
...
checkWebfont(api.Webfont o) {
  ...
  if (buildCounterWebfont < 3) {
    ...
    checkUnnamed1199(o.files);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.lastModified,
        unittest.equals(core.DateTime.parse("2002-02-27T00:00:00")));
    checkUnnamed1200(o.subsets);
    checkUnnamed1201(o.variants);
...
checkUnnamed1202(core.List<api.Webfont> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkWebfont(o[0]);
  checkWebfont(o[1]);
}
