...
checkUnnamed3196(core.List<api.Account> o) {
...
buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    ...
    o.name = "foo";
    o.premium = true;
    o.subAccounts = buildUnnamed3196();
    o.timezone = "foo";
  }
  buildCounterAccount--;
  return o;
...
checkAccount(api.Account o) {
  ...
  if (buildCounterAccount < 3) {
    ...
    checkUnnamed3196(o.subAccounts);
...
checkUnnamed3197(core.List<api.Account> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAccount(o[0]);
  checkAccount(o[1]);
}
...
checkUnnamed3198(core.List<api.AdClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdClient(o[0]);
  checkAdClient(o[1]);
}
...
checkUnnamed3199(core.List<api.AdUnit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAdUnit(o[0]);
  checkAdUnit(o[1]);
}
...
checkUnnamed3201(core.List<api.AdsenseReportsGenerateResponseHeaders> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3203(core.List<core.List<core.String>> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAdsenseReportsGenerateResponse() {
  ...
  if (buildCounterAdsenseReportsGenerateResponse < 3) {
    o.averages = buildUnnamed3200();
    o.endDate = "foo";
    o.headers = buildUnnamed3201();
    o.kind = "foo";
    o.rows = buildUnnamed3203();
    o.startDate = "foo";
    o.totalMatchedRows = "foo";
    o.totals = buildUnnamed3204();
    o.warnings = buildUnnamed3205();
  }
  buildCounterAdsenseReportsGenerateResponse--;
  return o;
}
...
checkAdsenseReportsGenerateResponse(api.AdsenseReportsGenerateResponse o) {
  buildCounterAdsenseReportsGenerateResponse++;
  if (buildCounterAdsenseReportsGenerateResponse < 3) {
    checkUnnamed3200(o.averages);
    unittest.expect(o.endDate, unittest.equals('foo'));
    checkUnnamed3201(o.headers);
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3203(o.rows);
    unittest.expect(o.startDate, unittest.equals('foo'));
    unittest.expect(o.totalMatchedRows, unittest.equals('foo'));
    checkUnnamed3204(o.totals);
    checkUnnamed3205(o.warnings);
  }
  buildCounterAdsenseReportsGenerateResponse--;
}
...
checkUnnamed3206(core.List<api.Alert> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAlert(o[0]);
  checkAlert(o[1]);
}
...
checkUnnamed3207(core.List<api.CustomChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3208(core.List<api.ReportingMetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3209(core.List<api.Payment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPayment(o[0]);
  checkPayment(o[1]);
}
...
buildReportingMetadataEntry() {
  ...
  if (buildCounterReportingMetadataEntry < 3) {
    o.compatibleDimensions = buildUnnamed3210();
    o.compatibleMetrics = buildUnnamed3211();
    o.id = "foo";
    o.kind = "foo";
    o.requiredDimensions = buildUnnamed3212();
    o.requiredMetrics = buildUnnamed3213();
    o.supportedProducts = buildUnnamed3214();
  }
  buildCounterReportingMetadataEntry--;
  return o;
}
...
checkReportingMetadataEntry(api.ReportingMetadataEntry o) {
  buildCounterReportingMetadataEntry++;
  if (buildCounterReportingMetadataEntry < 3) {
    checkUnnamed3210(o.compatibleDimensions);
    checkUnnamed3211(o.compatibleMetrics);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3212(o.requiredDimensions);
    checkUnnamed3213(o.requiredMetrics);
    checkUnnamed3214(o.supportedProducts);
  }
  buildCounterReportingMetadataEntry--;
}
...
checkUnnamed3215(core.List<api.SavedAdStyle> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3216(core.List<api.SavedReport> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3217(core.List<api.UrlChannel> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrlChannel(o[0]);
  checkUrlChannel(o[1]);
}
...
main() {
  ...
  unittest.group("resource-AccountsReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_dimension = buildUnnamed3218();
      var arg_filter = buildUnnamed3219();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed3220();
      var arg_sort = buildUnnamed3221();
  ...
  unittest.group("resource-ReportsResourceApi", () {
    unittest.test("method--generate", () {
      ...
      var arg_currency = "foo";
      var arg_dimension = buildUnnamed3223();
      var arg_filter = buildUnnamed3224();
      var arg_locale = "foo";
      var arg_maxResults = 42;
      var arg_metric = buildUnnamed3225();
      var arg_sort = buildUnnamed3226();
      var arg_startIndex = 42;
      var arg_useTimezoneReporting = true;
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
