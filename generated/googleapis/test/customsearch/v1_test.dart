...
checkUnnamed3473(core.List<api.ContextFacets> o) {
...
buildUnnamed3474() {
  ...
  o.add(buildUnnamed3473());
  o.add(buildUnnamed3473());
  return o;
}

checkUnnamed3474(core.List<core.List<api.ContextFacets>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3473(o[0]);
  checkUnnamed3473(o[1]);
}
...
checkUnnamed3475(core.List<api.PromotionBodyLines> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3476(core.List<api.ResultLabels> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed3478() {
  ...
  o.add(buildUnnamed3477());
  o.add(buildUnnamed3477());
  return o;
}

checkUnnamed3478(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3477(o[0]);
  checkUnnamed3477(o[1]);
}

buildUnnamed3479() {
  var o = new core
      .Map<core.String, core.List<core.Map<core.String, core.Object>>>();
  o["x"] = buildUnnamed3478();
  o["y"] = buildUnnamed3478();
  return o;
}
...
checkUnnamed3479(
  ...
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3478(o["x"]);
  checkUnnamed3478(o["y"]);
}
...
checkUnnamed3480(core.List<api.Result> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResult(o[0]);
  checkResult(o[1]);
}
...
checkUnnamed3481(core.List<api.Promotion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPromotion(o[0]);
  checkPromotion(o[1]);
}
...
checkUnnamed3482(core.List<api.Query> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuery(o[0]);
  checkQuery(o[1]);
}
...
buildUnnamed3483() {
  ...
  o["x"] = buildUnnamed3482();
  o["y"] = buildUnnamed3482();
  return o;
}

checkUnnamed3483(core.Map<core.String, core.List<api.Query>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3482(o["x"]);
  checkUnnamed3482(o["y"]);
}
...
buildSearch() {
  ...
  if (buildCounterSearch < 3) {
    ...
    o.kind = "foo";
    o.promotions = buildUnnamed3481();
    o.queries = buildUnnamed3483();
...
checkSearch(api.Search o) {
  ...
  if (buildCounterSearch < 3) {
    ...
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed3481(o.promotions);
    checkUnnamed3483(o.queries);
