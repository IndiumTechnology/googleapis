...
checkUnnamed2484(core.List<api.AuditLogConfig> o) {
...
checkUnnamed2487(core.List<api.Ancestor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAncestor(o[0]);
  checkAncestor(o[1]);
}
...
buildLien() {
  ...
  if (buildCounterLien < 3) {
    ...
    o.parent = "foo";
    o.reason = "foo";
    o.restrictions = buildUnnamed2488();
  }
  buildCounterLien--;
  return o;
}
...
checkLien(api.Lien o) {
  ...
  if (buildCounterLien < 3) {
    ...
    checkUnnamed2488(o.restrictions);
  }
  buildCounterLien--;
}
...
checkUnnamed2489(core.List<api.Constraint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConstraint(o[0]);
  checkConstraint(o[1]);
}
...
buildListAvailableOrgPolicyConstraintsResponse() {
  ...
  if (buildCounterListAvailableOrgPolicyConstraintsResponse < 3) {
    o.constraints = buildUnnamed2489();
    o.nextPageToken = "foo";
  }
  buildCounterListAvailableOrgPolicyConstraintsResponse--;
  return o;
...
checkListAvailableOrgPolicyConstraintsResponse(
  ...
  buildCounterListAvailableOrgPolicyConstraintsResponse++;
  if (buildCounterListAvailableOrgPolicyConstraintsResponse < 3) {
    checkUnnamed2489(o.constraints);
...
checkUnnamed2490(core.List<api.Lien> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLien(o[0]);
  checkLien(o[1]);
}
...
checkUnnamed2491(core.List<api.OrgPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOrgPolicy(o[0]);
  checkOrgPolicy(o[1]);
}
...
buildListPolicy() {
  ...
  if (buildCounterListPolicy < 3) {
    o.allValues = "foo";
    o.allowedValues = buildUnnamed2492();
    o.deniedValues = buildUnnamed2493();
...
checkListPolicy(api.ListPolicy o) {
  ...
  if (buildCounterListPolicy < 3) {
    ...
    checkUnnamed2492(o.allowedValues);
    checkUnnamed2493(o.deniedValues);
...
checkUnnamed2494(core.List<api.Project> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProject(o[0]);
  checkProject(o[1]);
}
...
checkUnnamed2497(core.List<api.AuditConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2498(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
buildPolicy() {
  ...
  if (buildCounterPolicy < 3) {
    o.auditConfigs = buildUnnamed2497();
    o.bindings = buildUnnamed2498();
    o.etag = "foo";
    o.version = 42;
  }
  buildCounterPolicy--;
...
checkPolicy(api.Policy o) {
  buildCounterPolicy++;
  if (buildCounterPolicy < 3) {
    checkUnnamed2497(o.auditConfigs);
    checkUnnamed2498(o.bindings);
    unittest.expect(o.etag, unittest.equals('foo'));
    unittest.expect(o.version, unittest.equals(42));
  }
  buildCounterPolicy--;
...
checkUnnamed2499(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2500(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2502() {
  ...
  o.add(buildUnnamed2501());
  o.add(buildUnnamed2501());
  return o;
}

checkUnnamed2502(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2501(o[0]);
  checkUnnamed2501(o[1]);
}
...
buildTestIamPermissionsRequest() {
  ...
  if (buildCounterTestIamPermissionsRequest < 3) {
    o.permissions = buildUnnamed2503();
  }
  buildCounterTestIamPermissionsRequest--;
  return o;
}
...
checkTestIamPermissionsRequest(api.TestIamPermissionsRequest o) {
  buildCounterTestIamPermissionsRequest++;
  if (buildCounterTestIamPermissionsRequest < 3) {
    checkUnnamed2503(o.permissions);
  }
  buildCounterTestIamPermissionsRequest--;
}
