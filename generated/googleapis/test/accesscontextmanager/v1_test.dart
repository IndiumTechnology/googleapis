...
checkUnnamed4636(core.List<api.Condition> o) {
...
checkUnnamed4639(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildCondition() {
  ...
  if (buildCounterCondition < 3) {
    ...
    o.ipSubnetworks = buildUnnamed4637();
    o.members = buildUnnamed4638();
    o.negate = true;
    o.regions = buildUnnamed4639();
    o.requiredAccessLevels = buildUnnamed4640();
  }
  buildCounterCondition--;
  return o;
}
...
checkCondition(api.Condition o) {
  ...
  if (buildCounterCondition < 3) {
    ...
    checkUnnamed4637(o.ipSubnetworks);
    checkUnnamed4638(o.members);
    unittest.expect(o.negate, unittest.isTrue);
    checkUnnamed4639(o.regions);
    checkUnnamed4640(o.requiredAccessLevels);
  }
  buildCounterCondition--;
}
...
checkUnnamed4643(core.List<api.OsConstraint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDevicePolicy() {
  ...
  if (buildCounterDevicePolicy < 3) {
    o.allowedDeviceManagementLevels = buildUnnamed4641();
    o.allowedEncryptionStatuses = buildUnnamed4642();
    o.osConstraints = buildUnnamed4643();
...
checkDevicePolicy(api.DevicePolicy o) {
  buildCounterDevicePolicy++;
  if (buildCounterDevicePolicy < 3) {
    checkUnnamed4641(o.allowedDeviceManagementLevels);
    checkUnnamed4642(o.allowedEncryptionStatuses);
    checkUnnamed4643(o.osConstraints);
...
checkUnnamed4644(core.List<api.AccessLevel> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListAccessLevelsResponse() {
  ...
  if (buildCounterListAccessLevelsResponse < 3) {
    o.accessLevels = buildUnnamed4644();
    o.nextPageToken = "foo";
  }
  buildCounterListAccessLevelsResponse--;
  return o;
...
checkListAccessLevelsResponse(api.ListAccessLevelsResponse o) {
  buildCounterListAccessLevelsResponse++;
  if (buildCounterListAccessLevelsResponse < 3) {
    checkUnnamed4644(o.accessLevels);
...
checkUnnamed4645(core.List<api.AccessPolicy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListAccessPoliciesResponse() {
  ...
  if (buildCounterListAccessPoliciesResponse < 3) {
    o.accessPolicies = buildUnnamed4645();
    o.nextPageToken = "foo";
  }
  buildCounterListAccessPoliciesResponse--;
  return o;
...
checkListAccessPoliciesResponse(api.ListAccessPoliciesResponse o) {
  buildCounterListAccessPoliciesResponse++;
  if (buildCounterListAccessPoliciesResponse < 3) {
    checkUnnamed4645(o.accessPolicies);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListAccessPoliciesResponse--;
}
...
checkUnnamed4646(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed4647(core.List<api.ServicePerimeter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListServicePerimetersResponse() {
  ...
  if (buildCounterListServicePerimetersResponse < 3) {
    o.nextPageToken = "foo";
    o.servicePerimeters = buildUnnamed4647();
  }
  buildCounterListServicePerimetersResponse--;
  return o;
}
...
checkListServicePerimetersResponse(api.ListServicePerimetersResponse o) {
  ...
  if (buildCounterListServicePerimetersResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4647(o.servicePerimeters);
  }
  buildCounterListServicePerimetersResponse--;
}
...
checkUnnamed4648(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4649(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4648();
    o.name = "foo";
    o.response = buildUnnamed4649();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed4648(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4649(o.response);
  }
  buildCounterOperation--;
}
...
buildServicePerimeterConfig() {
  ...
  if (buildCounterServicePerimeterConfig < 3) {
    o.accessLevels = buildUnnamed4650();
    o.resources = buildUnnamed4651();
    o.restrictedServices = buildUnnamed4652();
  }
  buildCounterServicePerimeterConfig--;
  return o;
}
...
checkServicePerimeterConfig(api.ServicePerimeterConfig o) {
  buildCounterServicePerimeterConfig++;
  if (buildCounterServicePerimeterConfig < 3) {
    checkUnnamed4650(o.accessLevels);
    checkUnnamed4651(o.resources);
    checkUnnamed4652(o.restrictedServices);
  }
  buildCounterServicePerimeterConfig--;
}
...
checkUnnamed4653(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed4654() {
  ...
  o.add(buildUnnamed4653());
  o.add(buildUnnamed4653());
  return o;
}

checkUnnamed4654(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4653(o[0]);
  checkUnnamed4653(o[1]);
}
