...
checkUnnamed3390(core.List<api.User> o) {
...
buildComment() {
  ...
  if (buildCounterComment < 3) {
    ...
    o.mentionedUsers = buildUnnamed3390();
    o.post = buildPost();
...
checkComment(api.Comment o) {
  ...
  if (buildCounterComment < 3) {
    ...
    checkUnnamed3390(o.mentionedUsers);
    checkPost(o.post);
...
checkUnnamed3391(core.List<api.Action> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAction(o[0]);
  checkAction(o[1]);
}
...
checkUnnamed3392(core.List<api.Actor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActor(o[0]);
  checkActor(o[1]);
}
...
checkUnnamed3393(core.List<api.Target> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTarget(o[0]);
  checkTarget(o[1]);
}
...
buildDriveActivity() {
  ...
  if (buildCounterDriveActivity < 3) {
    o.actions = buildUnnamed3391();
    o.actors = buildUnnamed3392();
    o.primaryActionDetail = buildActionDetail();
    o.targets = buildUnnamed3393();
    o.timeRange = buildTimeRange();
    o.timestamp = "foo";
  }
  buildCounterDriveActivity--;
...
checkDriveActivity(api.DriveActivity o) {
  buildCounterDriveActivity++;
  if (buildCounterDriveActivity < 3) {
    checkUnnamed3391(o.actions);
    checkUnnamed3392(o.actors);
    checkActionDetail(o.primaryActionDetail);
    checkUnnamed3393(o.targets);
    checkTimeRange(o.timeRange);
    unittest.expect(o.timestamp, unittest.equals('foo'));
  }
  buildCounterDriveActivity--;
...
checkUnnamed3394(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3395(core.List<api.TargetReference> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTargetReference(o[0]);
  checkTargetReference(o[1]);
}
...
buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed3394();
    o.removedParents = buildUnnamed3395();
  }
  buildCounterMove--;
  return o;
}
...
checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed3394(o.addedParents);
    checkUnnamed3395(o.removedParents);
  }
  buildCounterMove--;
}
...
checkUnnamed3396(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
checkUnnamed3397(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed3396();
    o.removedPermissions = buildUnnamed3397();
  }
  buildCounterPermissionChange--;
  return o;
}
...
checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed3396(o.addedPermissions);
    checkUnnamed3397(o.removedPermissions);
  }
  buildCounterPermissionChange--;
}
...
checkUnnamed3398(core.List<api.DriveActivity> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3399(core.List<api.RestrictionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSettingsChange() {
  ...
  if (buildCounterSettingsChange < 3) {
    o.restrictionChanges = buildUnnamed3399();
  }
  buildCounterSettingsChange--;
  return o;
}
...
checkSettingsChange(api.SettingsChange o) {
  buildCounterSettingsChange++;
  if (buildCounterSettingsChange < 3) {
    checkUnnamed3399(o.restrictionChanges);
  }
  buildCounterSettingsChange--;
}
