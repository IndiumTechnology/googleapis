...
buildContainerStartedEvent() {
  ...
  if (buildCounterContainerStartedEvent < 3) {
    o.actionId = 42;
    o.ipAddress = "foo";
    o.portMappings = buildUnnamed4826();
  }
  buildCounterContainerStartedEvent--;
  return o;
}
...
checkContainerStartedEvent(api.ContainerStartedEvent o) {
  ...
  if (buildCounterContainerStartedEvent < 3) {
    ...
    checkUnnamed4826(o.portMappings);
  }
  buildCounterContainerStartedEvent--;
}
...
checkUnnamed4829(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed4831(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4830();
    o.name = "foo";
    o.response = buildUnnamed4831();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed4830(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4831(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed4832(core.List<api.OperationEvent> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4834(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4835(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperationMetadata() {
  ...
  if (buildCounterOperationMetadata < 3) {
    ...
    o.createTime = "foo";
    o.endTime = "foo";
    o.events = buildUnnamed4832();
    o.labels = buildUnnamed4833();
    o.projectId = "foo";
    o.request = buildUnnamed4834();
    o.runtimeMetadata = buildUnnamed4835();
    o.startTime = "foo";
  }
  buildCounterOperationMetadata--;
  return o;
...
checkOperationMetadata(api.OperationMetadata o) {
  ...
  if (buildCounterOperationMetadata < 3) {
    ...
    unittest.expect(o.endTime, unittest.equals('foo'));
    checkUnnamed4832(o.events);
    checkUnnamed4833(o.labels);
    unittest.expect(o.projectId, unittest.equals('foo'));
    checkUnnamed4834(o.request);
    checkUnnamed4835(o.runtimeMetadata);
    unittest.expect(o.startTime, unittest.equals('foo'));
  }
  buildCounterOperationMetadata--;
}
...
checkUnnamed4836(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed4837() {
  ...
  o.add(buildUnnamed4836());
  o.add(buildUnnamed4836());
  return o;
}

checkUnnamed4837(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4836(o[0]);
  checkUnnamed4836(o[1]);
}
