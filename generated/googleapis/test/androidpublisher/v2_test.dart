...
checkUnnamed441(core.List<api.ApkListing> o) {
...
checkUnnamed442(core.List<api.Apk> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApk(o[0]);
  checkApk(o[1]);
}
...
checkUnnamed443(core.List<api.Bundle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBundle(o[0]);
  checkBundle(o[1]);
}
...
checkUnnamed447(core.List<api.ExternallyHostedApkUsesPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildExternallyHostedApk() {
  ...
  if (buildCounterExternallyHostedApk < 3) {
    ...
    o.certificateBase64s = buildUnnamed444();
    ...
    o.maximumSdk = 42;
    o.minimumSdk = 42;
    o.nativeCodes = buildUnnamed445();
    o.packageName = "foo";
    o.usesFeatures = buildUnnamed446();
    o.usesPermissions = buildUnnamed447();
    o.versionCode = 42;
    o.versionName = "foo";
  }
  buildCounterExternallyHostedApk--;
...
checkExternallyHostedApk(api.ExternallyHostedApk o) {
  ...
  if (buildCounterExternallyHostedApk < 3) {
    ...
    checkUnnamed444(o.certificateBase64s);
    ...
    checkUnnamed445(o.nativeCodes);
    unittest.expect(o.packageName, unittest.equals('foo'));
    checkUnnamed446(o.usesFeatures);
    checkUnnamed447(o.usesPermissions);
    unittest.expect(o.versionCode, unittest.equals(42));
...
checkUnnamed448(core.List<api.Image> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImage(o[0]);
  checkImage(o[1]);
}
...
checkUnnamed449(core.List<api.Image> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImage(o[0]);
  checkImage(o[1]);
}
...
checkUnnamed450(core.Map<core.String, api.InAppProductListing> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed451(core.Map<core.String, api.Price> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPrice(o["x"]);
  checkPrice(o["y"]);
}
...
buildInAppProduct() {
  ...
  if (buildCounterInAppProduct < 3) {
    ...
    o.gracePeriod = "foo";
    o.listings = buildUnnamed450();
    o.packageName = "foo";
    o.prices = buildUnnamed451();
    o.purchaseType = "foo";
...
checkInAppProduct(api.InAppProduct o) {
  ...
  if (buildCounterInAppProduct < 3) {
    ...
    checkUnnamed450(o.listings);
    unittest.expect(o.packageName, unittest.equals('foo'));
    checkUnnamed451(o.prices);
...
checkUnnamed452(core.List<api.InAppProduct> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildInappproductsListResponse() {
  ...
  if (buildCounterInappproductsListResponse < 3) {
    o.inappproduct = buildUnnamed452();
    o.kind = "foo";
...
checkInappproductsListResponse(api.InappproductsListResponse o) {
  buildCounterInappproductsListResponse++;
  if (buildCounterInappproductsListResponse < 3) {
    checkUnnamed452(o.inappproduct);
    unittest.expect(o.kind, unittest.equals('foo'));
...
checkUnnamed453(core.List<api.Listing> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkListing(o[0]);
  checkListing(o[1]);
}
...
checkUnnamed454(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed455(core.List<api.Review> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReview(o[0]);
  checkReview(o[1]);
}
...
checkUnnamed456(core.List<api.Prorate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProrate(o[0]);
  checkProrate(o[1]);
}
...
buildTesters() {
  ...
  if (buildCounterTesters < 3) {
    o.googleGroups = buildUnnamed457();
  }
  buildCounterTesters--;
  return o;
}
...
checkTesters(api.Testers o) {
  buildCounterTesters++;
  if (buildCounterTesters < 3) {
    checkUnnamed457(o.googleGroups);
  }
  buildCounterTesters--;
}
...
checkUnnamed458(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTrack() {
  ...
  if (buildCounterTrack < 3) {
    o.track = "foo";
    o.userFraction = 42.0;
    o.versionCodes = buildUnnamed458();
  }
  buildCounterTrack--;
  return o;
}
...
checkTrack(api.Track o) {
  ...
  if (buildCounterTrack < 3) {
    ...
    checkUnnamed458(o.versionCodes);
  }
  buildCounterTrack--;
}
...
checkUnnamed459(core.List<api.Track> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTrack(o[0]);
  checkTrack(o[1]);
}
...
checkUnnamed460(core.List<api.VoidedPurchase> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildVoidedPurchasesListResponse() {
  ...
  if (buildCounterVoidedPurchasesListResponse < 3) {
    o.pageInfo = buildPageInfo();
    o.tokenPagination = buildTokenPagination();
    o.voidedPurchases = buildUnnamed460();
  }
  buildCounterVoidedPurchasesListResponse--;
  return o;
}
...
checkVoidedPurchasesListResponse(api.VoidedPurchasesListResponse o) {
  ...
  if (buildCounterVoidedPurchasesListResponse < 3) {
    checkPageInfo(o.pageInfo);
    checkTokenPagination(o.tokenPagination);
    checkUnnamed460(o.voidedPurchases);
  }
  buildCounterVoidedPurchasesListResponse--;
}
