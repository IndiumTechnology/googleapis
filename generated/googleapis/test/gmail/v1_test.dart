...
buildBatchModifyMessagesRequest() {
  ...
  if (buildCounterBatchModifyMessagesRequest < 3) {
    o.addLabelIds = buildUnnamed2796();
    o.ids = buildUnnamed2797();
    o.removeLabelIds = buildUnnamed2798();
  }
  buildCounterBatchModifyMessagesRequest--;
  return o;
}
...
checkBatchModifyMessagesRequest(api.BatchModifyMessagesRequest o) {
  buildCounterBatchModifyMessagesRequest++;
  if (buildCounterBatchModifyMessagesRequest < 3) {
    checkUnnamed2796(o.addLabelIds);
    checkUnnamed2797(o.ids);
    checkUnnamed2798(o.removeLabelIds);
  }
  buildCounterBatchModifyMessagesRequest--;
}
...
buildFilterAction() {
  ...
  if (buildCounterFilterAction < 3) {
    o.addLabelIds = buildUnnamed2799();
    o.forward = "foo";
    o.removeLabelIds = buildUnnamed2800();
  }
  buildCounterFilterAction--;
  return o;
}
...
checkFilterAction(api.FilterAction o) {
  buildCounterFilterAction++;
  if (buildCounterFilterAction < 3) {
    checkUnnamed2799(o.addLabelIds);
    unittest.expect(o.forward, unittest.equals('foo'));
    checkUnnamed2800(o.removeLabelIds);
  }
  buildCounterFilterAction--;
}
...
checkUnnamed2801(core.List<api.HistoryLabelAdded> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2802(core.List<api.HistoryLabelRemoved> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2803(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0]);
  checkMessage(o[1]);
}
...
checkUnnamed2804(core.List<api.HistoryMessageAdded> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2805(core.List<api.HistoryMessageDeleted> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildHistory() {
  ...
  if (buildCounterHistory < 3) {
    o.id = "foo";
    o.labelsAdded = buildUnnamed2801();
    o.labelsRemoved = buildUnnamed2802();
    o.messages = buildUnnamed2803();
    o.messagesAdded = buildUnnamed2804();
    o.messagesDeleted = buildUnnamed2805();
  }
  buildCounterHistory--;
  return o;
}
...
checkHistory(api.History o) {
  ...
  if (buildCounterHistory < 3) {
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed2801(o.labelsAdded);
    checkUnnamed2802(o.labelsRemoved);
    checkUnnamed2803(o.messages);
    checkUnnamed2804(o.messagesAdded);
    checkUnnamed2805(o.messagesDeleted);
  }
  buildCounterHistory--;
}
...
checkUnnamed2808(core.List<api.Delegate> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDelegate(o[0]);
  checkDelegate(o[1]);
}
...
checkUnnamed2809(core.List<api.Draft> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDraft(o[0]);
  checkDraft(o[1]);
}
...
checkUnnamed2810(core.List<api.Filter> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilter(o[0]);
  checkFilter(o[1]);
}
...
checkUnnamed2811(core.List<api.ForwardingAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListForwardingAddressesResponse() {
  ...
  if (buildCounterListForwardingAddressesResponse < 3) {
    o.forwardingAddresses = buildUnnamed2811();
  }
  buildCounterListForwardingAddressesResponse--;
  return o;
}
...
checkListForwardingAddressesResponse(api.ListForwardingAddressesResponse o) {
  buildCounterListForwardingAddressesResponse++;
  if (buildCounterListForwardingAddressesResponse < 3) {
    checkUnnamed2811(o.forwardingAddresses);
  }
  buildCounterListForwardingAddressesResponse--;
}
...
checkUnnamed2812(core.List<api.History> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHistory(o[0]);
  checkHistory(o[1]);
}
...
checkUnnamed2813(core.List<api.Label> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabel(o[0]);
  checkLabel(o[1]);
}
...
checkUnnamed2814(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0]);
  checkMessage(o[1]);
}
...
checkUnnamed2815(core.List<api.SendAs> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSendAs(o[0]);
  checkSendAs(o[1]);
}
...
checkUnnamed2816(core.List<api.SmimeInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSmimeInfo(o[0]);
  checkSmimeInfo(o[1]);
}
...
checkUnnamed2817(core.List<api.Thread> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkThread(o[0]);
  checkThread(o[1]);
}
...
checkUnnamed2819(core.List<api.MessagePartHeader> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2820(core.List<api.MessagePart> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildMessagePart() {
  ...
  if (buildCounterMessagePart < 3) {
    ...
    o.filename = "foo";
    o.headers = buildUnnamed2819();
    o.mimeType = "foo";
    o.partId = "foo";
    o.parts = buildUnnamed2820();
  }
  buildCounterMessagePart--;
  return o;
}
...
buildModifyMessageRequest() {
  ...
  if (buildCounterModifyMessageRequest < 3) {
    o.addLabelIds = buildUnnamed2821();
    o.removeLabelIds = buildUnnamed2822();
  }
  buildCounterModifyMessageRequest--;
  return o;
}
...
checkModifyMessageRequest(api.ModifyMessageRequest o) {
  buildCounterModifyMessageRequest++;
  if (buildCounterModifyMessageRequest < 3) {
    checkUnnamed2821(o.addLabelIds);
    checkUnnamed2822(o.removeLabelIds);
  }
  buildCounterModifyMessageRequest--;
}
...
buildModifyThreadRequest() {
  ...
  if (buildCounterModifyThreadRequest < 3) {
    o.addLabelIds = buildUnnamed2823();
    o.removeLabelIds = buildUnnamed2824();
  }
  buildCounterModifyThreadRequest--;
  return o;
}
...
checkModifyThreadRequest(api.ModifyThreadRequest o) {
  buildCounterModifyThreadRequest++;
  if (buildCounterModifyThreadRequest < 3) {
    checkUnnamed2823(o.addLabelIds);
    checkUnnamed2824(o.removeLabelIds);
  }
  buildCounterModifyThreadRequest--;
}
...
checkUnnamed2825(core.List<api.Message> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMessage(o[0]);
  checkMessage(o[1]);
}
...
main() {
  ...
  unittest.group("resource-UsersHistoryResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_userId = "foo";
      var arg_historyTypes = buildUnnamed2827();
      var arg_labelId = "foo";
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
  ...
  unittest.group("resource-UsersMessagesResourceApi", () {
    ...
    unittest.test("method--get", () {
      ...
      var arg_id = "foo";
      var arg_format = "foo";
      var arg_metadataHeaders = buildUnnamed2828();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test("method--list", () {
      ...
      var arg_userId = "foo";
      var arg_includeSpamTrash = true;
      var arg_labelIds = buildUnnamed2829();
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
      var arg_q = "foo";
      var arg_$fields = "foo";
  ...
  unittest.group("resource-UsersThreadsResourceApi", () {
    ...
    unittest.test("method--get", () {
      ...
      var arg_id = "foo";
      var arg_format = "foo";
      var arg_metadataHeaders = buildUnnamed2830();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test("method--list", () {
      ...
      var arg_userId = "foo";
      var arg_includeSpamTrash = true;
      var arg_labelIds = buildUnnamed2831();
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
      var arg_q = "foo";
      var arg_$fields = "foo";
