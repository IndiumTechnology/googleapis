...
checkUnnamed3737(core.List<api.Material> o) {
...
checkUnnamed3738(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
buildAssignmentSubmission() {
  ...
  if (buildCounterAssignmentSubmission < 3) {
    o.attachments = buildUnnamed3738();
  }
  buildCounterAssignmentSubmission--;
  return o;
}
...
checkAssignmentSubmission(api.AssignmentSubmission o) {
  buildCounterAssignmentSubmission++;
  if (buildCounterAssignmentSubmission < 3) {
    checkUnnamed3738(o.attachments);
  }
  buildCounterAssignmentSubmission--;
}
...
checkUnnamed3739(core.List<api.CourseMaterialSet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCourse() {
  ...
  if (buildCounterCourse < 3) {
    ...
    o.courseMaterialSets = buildUnnamed3739();
    o.courseState = "foo";
    o.creationTime = "foo";
    o.description = "foo";
...
checkCourse(api.Course o) {
  ...
  if (buildCounterCourse < 3) {
    ...
    checkUnnamed3739(o.courseMaterialSets);
...
checkUnnamed3740(core.List<api.CourseMaterial> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3741(core.List<api.Material> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMaterial(o[0]);
  checkMaterial(o[1]);
}
...
checkUnnamed3743(core.List<api.Announcement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListAnnouncementsResponse() {
  ...
  if (buildCounterListAnnouncementsResponse < 3) {
    o.announcements = buildUnnamed3743();
    o.nextPageToken = "foo";
  }
  buildCounterListAnnouncementsResponse--;
  return o;
...
checkListAnnouncementsResponse(api.ListAnnouncementsResponse o) {
  buildCounterListAnnouncementsResponse++;
  if (buildCounterListAnnouncementsResponse < 3) {
    checkUnnamed3743(o.announcements);
...
checkUnnamed3744(core.List<api.CourseAlias> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3745(core.List<api.CourseWork> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourseWork(o[0]);
  checkCourseWork(o[1]);
}
...
checkUnnamed3746(core.List<api.Course> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCourse(o[0]);
  checkCourse(o[1]);
}
...
checkUnnamed3747(core.List<api.GuardianInvitation> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListGuardianInvitationsResponse() {
  ...
  if (buildCounterListGuardianInvitationsResponse < 3) {
    o.guardianInvitations = buildUnnamed3747();
    o.nextPageToken = "foo";
  }
  buildCounterListGuardianInvitationsResponse--;
  return o;
...
checkListGuardianInvitationsResponse(api.ListGuardianInvitationsResponse o) {
  buildCounterListGuardianInvitationsResponse++;
  if (buildCounterListGuardianInvitationsResponse < 3) {
    checkUnnamed3747(o.guardianInvitations);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListGuardianInvitationsResponse--;
}
...
checkUnnamed3748(core.List<api.Guardian> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGuardian(o[0]);
  checkGuardian(o[1]);
}
...
checkUnnamed3749(core.List<api.Invitation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInvitation(o[0]);
  checkInvitation(o[1]);
}
...
buildListInvitationsResponse() {
  ...
  if (buildCounterListInvitationsResponse < 3) {
    o.invitations = buildUnnamed3749();
    o.nextPageToken = "foo";
  }
  buildCounterListInvitationsResponse--;
  return o;
...
checkListInvitationsResponse(api.ListInvitationsResponse o) {
  buildCounterListInvitationsResponse++;
  if (buildCounterListInvitationsResponse < 3) {
    checkUnnamed3749(o.invitations);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListInvitationsResponse--;
}
...
checkUnnamed3750(core.List<api.StudentSubmission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListStudentSubmissionsResponse() {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    o.nextPageToken = "foo";
    o.studentSubmissions = buildUnnamed3750();
  }
  buildCounterListStudentSubmissionsResponse--;
  return o;
}
...
checkListStudentSubmissionsResponse(api.ListStudentSubmissionsResponse o) {
  ...
  if (buildCounterListStudentSubmissionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed3750(o.studentSubmissions);
  }
  buildCounterListStudentSubmissionsResponse--;
}
...
checkUnnamed3751(core.List<api.Student> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStudent(o[0]);
  checkStudent(o[1]);
}
...
checkUnnamed3752(core.List<api.Teacher> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTeacher(o[0]);
  checkTeacher(o[1]);
}
...
checkUnnamed3753(core.List<api.Topic> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTopic(o[0]);
  checkTopic(o[1]);
}
...
checkUnnamed3754(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
buildModifyAttachmentsRequest() {
  ...
  if (buildCounterModifyAttachmentsRequest < 3) {
    o.addAttachments = buildUnnamed3754();
  }
  buildCounterModifyAttachmentsRequest--;
  return o;
}
...
checkModifyAttachmentsRequest(api.ModifyAttachmentsRequest o) {
  buildCounterModifyAttachmentsRequest++;
  if (buildCounterModifyAttachmentsRequest < 3) {
    checkUnnamed3754(o.addAttachments);
  }
  buildCounterModifyAttachmentsRequest--;
}
...
buildModifyIndividualStudentsOptions() {
  ...
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    o.addStudentIds = buildUnnamed3755();
    o.removeStudentIds = buildUnnamed3756();
  }
  buildCounterModifyIndividualStudentsOptions--;
  return o;
}
...
checkModifyIndividualStudentsOptions(api.ModifyIndividualStudentsOptions o) {
  buildCounterModifyIndividualStudentsOptions++;
  if (buildCounterModifyIndividualStudentsOptions < 3) {
    checkUnnamed3755(o.addStudentIds);
    checkUnnamed3756(o.removeStudentIds);
  }
  buildCounterModifyIndividualStudentsOptions--;
}
...
checkUnnamed3758(core.List<api.SubmissionHistory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildStudentSubmission() {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    o.state = "foo";
    o.submissionHistory = buildUnnamed3758();
    o.updateTime = "foo";
    o.userId = "foo";
  }
  buildCounterStudentSubmission--;
...
checkStudentSubmission(api.StudentSubmission o) {
  ...
  if (buildCounterStudentSubmission < 3) {
    ...
    unittest.expect(o.state, unittest.equals('foo'));
    checkUnnamed3758(o.submissionHistory);
    unittest.expect(o.updateTime, unittest.equals('foo'));
    unittest.expect(o.userId, unittest.equals('foo'));
  }
  buildCounterStudentSubmission--;
...
checkUnnamed3759(core.List<api.GlobalPermission> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUserProfile() {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    o.id = "foo";
    o.name = buildName();
    o.permissions = buildUnnamed3759();
    o.photoUrl = "foo";
...
checkUserProfile(api.UserProfile o) {
  ...
  if (buildCounterUserProfile < 3) {
    ...
    unittest.expect(o.id, unittest.equals('foo'));
    checkName(o.name);
    checkUnnamed3759(o.permissions);
...
checkUnnamed3764(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
main() {
  ...
  unittest.group("resource-CoursesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_courseStates = buildUnnamed3760();
  ...
  unittest.group("resource-CoursesAnnouncementsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      api.CoursesAnnouncementsResourceApi res =
          new api.ClassroomApi(mock).courses.announcements;
      var arg_courseId = "foo";
      var arg_announcementStates = buildUnnamed3761();
      var arg_orderBy = "foo";
      var arg_pageToken = "foo";
      var arg_pageSize = 42;
      var arg_$fields = "foo";
  ...
  unittest.group("resource-CoursesCourseWorkResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_pageSize = 42;
      var arg_courseWorkStates = buildUnnamed3762();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-CoursesCourseWorkStudentSubmissionsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_pageSize = 42;
      var arg_states = buildUnnamed3763();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-UserProfilesGuardianInvitationsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_states = buildUnnamed3764();
      var arg_pageSize = 42;
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
