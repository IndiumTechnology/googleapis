...
checkUnnamed3432(core.List<api.Event> o) {
...
buildActivity() {
  ...
  if (buildCounterActivity < 3) {
    ...
    o.singleEvents = buildUnnamed3432();
  }
  buildCounterActivity--;
  return o;
}
...
checkActivity(api.Activity o) {
  ...
  if (buildCounterActivity < 3) {
    ...
    checkUnnamed3432(o.singleEvents);
  }
  buildCounterActivity--;
}
...
checkUnnamed3434(core.List<api.PermissionChange> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEvent() {
  ...
  if (buildCounterEvent < 3) {
    o.additionalEventTypes = buildUnnamed3433();
    o.eventTimeMillis = "foo";
    o.fromUserDeletion = true;
    o.move = buildMove();
    o.permissionChanges = buildUnnamed3434();
...
checkUnnamed3435(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed3436(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
checkUnnamed3437(core.List<api.Parent> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkParent(o[0]);
  checkParent(o[1]);
}
...
buildMove() {
  ...
  if (buildCounterMove < 3) {
    o.addedParents = buildUnnamed3436();
    o.removedParents = buildUnnamed3437();
  }
  buildCounterMove--;
  return o;
}
...
checkMove(api.Move o) {
  buildCounterMove++;
  if (buildCounterMove < 3) {
    checkUnnamed3436(o.addedParents);
    checkUnnamed3437(o.removedParents);
  }
  buildCounterMove--;
}
...
checkUnnamed3438(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
checkUnnamed3439(core.List<api.Permission> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPermission(o[0]);
  checkPermission(o[1]);
}
...
buildPermissionChange() {
  ...
  if (buildCounterPermissionChange < 3) {
    o.addedPermissions = buildUnnamed3438();
    o.removedPermissions = buildUnnamed3439();
  }
  buildCounterPermissionChange--;
  return o;
}
...
checkPermissionChange(api.PermissionChange o) {
  buildCounterPermissionChange++;
  if (buildCounterPermissionChange < 3) {
    checkUnnamed3438(o.addedPermissions);
    checkUnnamed3439(o.removedPermissions);
  }
  buildCounterPermissionChange--;
}
