...
buildDownloadRequest() {
  ...
  if (buildCounterDownloadRequest < 3) {
    o.fileTypes = buildUnnamed1218();
    o.filterIds = buildUnnamed1219();
    o.filterType = "foo";
    o.version = "foo";
  }
  buildCounterDownloadRequest--;
...
checkDownloadRequest(api.DownloadRequest o) {
  buildCounterDownloadRequest++;
  if (buildCounterDownloadRequest < 3) {
    checkUnnamed1218(o.fileTypes);
    checkUnnamed1219(o.filterIds);
    unittest.expect(o.filterType, unittest.equals('foo'));
...
checkUnnamed1220(core.List<api.Query> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuery(o[0]);
  checkQuery(o[1]);
}
...
checkUnnamed1221(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
...
checkUnnamed1222(core.List<api.FilterPair> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFilterPair(o[0]);
  checkFilterPair(o[1]);
}
...
buildParameters() {
  ...
  if (buildCounterParameters < 3) {
    o.filters = buildUnnamed1222();
    o.groupBys = buildUnnamed1223();
    o.includeInviteData = true;
    o.metrics = buildUnnamed1224();
    o.type = "foo";
  }
  buildCounterParameters--;
  return o;
...
checkParameters(api.Parameters o) {
  buildCounterParameters++;
  if (buildCounterParameters < 3) {
    checkUnnamed1222(o.filters);
    checkUnnamed1223(o.groupBys);
    unittest.expect(o.includeInviteData, unittest.isTrue);
    checkUnnamed1224(o.metrics);
    unittest.expect(o.type, unittest.equals('foo'));
  }
  buildCounterParameters--;
}
...
buildQueryMetadata() {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    o.shareEmailAddress = buildUnnamed1225();
    o.title = "foo";
  }
  buildCounterQueryMetadata--;
  return o;
...
checkQueryMetadata(api.QueryMetadata o) {
  ...
  if (buildCounterQueryMetadata < 3) {
    ...
    checkUnnamed1225(o.shareEmailAddress);
...
checkUnnamed1228(core.List<api.RowStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRowStatus(o[0]);
  checkRowStatus(o[1]);
}
...
buildUploadStatus() {
  ...
  if (buildCounterUploadStatus < 3) {
    o.errors = buildUnnamed1227();
    o.rowStatus = buildUnnamed1228();
  }
  buildCounterUploadStatus--;
  return o;
}
...
checkUploadStatus(api.UploadStatus o) {
  buildCounterUploadStatus++;
  if (buildCounterUploadStatus < 3) {
    checkUnnamed1227(o.errors);
    checkUnnamed1228(o.rowStatus);
  }
  buildCounterUploadStatus--;
}
