...
buildErrorLogEntry() {
  ...
  if (buildCounterErrorLogEntry < 3) {
    o.errorDetails = buildUnnamed1229();
    o.url = "foo";
  }
  buildCounterErrorLogEntry--;
  return o;
...
checkErrorLogEntry(api.ErrorLogEntry o) {
  buildCounterErrorLogEntry++;
  if (buildCounterErrorLogEntry < 3) {
    checkUnnamed1229(o.errorDetails);
...
checkUnnamed1230(core.List<api.ErrorLogEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildErrorSummary() {
  ...
  if (buildCounterErrorSummary < 3) {
    o.errorCode = "foo";
    o.errorCount = "foo";
    o.errorLogEntries = buildUnnamed1230();
  }
  buildCounterErrorSummary--;
  return o;
}
...
checkErrorSummary(api.ErrorSummary o) {
  ...
  if (buildCounterErrorSummary < 3) {
    ...
    checkUnnamed1230(o.errorLogEntries);
  }
  buildCounterErrorSummary--;
}
...
checkUnnamed1231(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed1232(core.List<api.TransferJob> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListTransferJobsResponse() {
  ...
  if (buildCounterListTransferJobsResponse < 3) {
    o.nextPageToken = "foo";
    o.transferJobs = buildUnnamed1232();
  }
  buildCounterListTransferJobsResponse--;
  return o;
}
...
checkListTransferJobsResponse(api.ListTransferJobsResponse o) {
  ...
  if (buildCounterListTransferJobsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1232(o.transferJobs);
  }
  buildCounterListTransferJobsResponse--;
}
...
buildObjectConditions() {
  ...
  if (buildCounterObjectConditions < 3) {
    o.excludePrefixes = buildUnnamed1233();
    o.includePrefixes = buildUnnamed1234();
...
checkObjectConditions(api.ObjectConditions o) {
  buildCounterObjectConditions++;
  if (buildCounterObjectConditions < 3) {
    checkUnnamed1233(o.excludePrefixes);
    checkUnnamed1234(o.includePrefixes);
    unittest.expect(
...
checkUnnamed1235(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1235();
    o.name = "foo";
    o.response = buildUnnamed1236();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed1235(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1236(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed1237(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1238() {
  ...
  o.add(buildUnnamed1237());
  o.add(buildUnnamed1237());
  return o;
}

checkUnnamed1238(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1237(o[0]);
  checkUnnamed1237(o[1]);
}
...
checkUnnamed1239(core.List<api.ErrorSummary> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildTransferOperation() {
  ...
  if (buildCounterTransferOperation < 3) {
    ...
    o.endTime = "foo";
    o.errorBreakdowns = buildUnnamed1239();
    o.name = "foo";
    o.projectId = "foo";
    o.startTime = "foo";
    o.status = "foo";
...
checkTransferOperation(api.TransferOperation o) {
  ...
  if (buildCounterTransferOperation < 3) {
    ...
    checkUnnamed1239(o.errorBreakdowns);
    unittest.expect(o.name, unittest.equals('foo'));
    unittest.expect(o.projectId, unittest.equals('foo'));
