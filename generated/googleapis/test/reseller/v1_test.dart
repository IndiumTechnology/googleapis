...
buildResellernotifyGetwatchdetailsResponse() {
  ...
  if (buildCounterResellernotifyGetwatchdetailsResponse < 3) {
    o.serviceAccountEmailAddresses = buildUnnamed2994();
    o.topicName = "foo";
  }
  buildCounterResellernotifyGetwatchdetailsResponse--;
  return o;
...
checkResellernotifyGetwatchdetailsResponse(
  ...
  buildCounterResellernotifyGetwatchdetailsResponse++;
  if (buildCounterResellernotifyGetwatchdetailsResponse < 3) {
    checkUnnamed2994(o.serviceAccountEmailAddresses);
...
buildSubscription() {
  ...
  if (buildCounterSubscription < 3) {
    ...
    o.suspensionReasons = buildUnnamed2995();
...
checkSubscription(api.Subscription o) {
  ...
  if (buildCounterSubscription < 3) {
    ...
    checkUnnamed2995(o.suspensionReasons);
...
checkUnnamed2996(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildSubscriptions() {
  ...
  if (buildCounterSubscriptions < 3) {
    o.kind = "foo";
    o.nextPageToken = "foo";
    o.subscriptions = buildUnnamed2996();
  }
  buildCounterSubscriptions--;
  return o;
}
...
checkSubscriptions(api.Subscriptions o) {
  ...
  if (buildCounterSubscriptions < 3) {
    ...
    checkUnnamed2996(o.subscriptions);
  }
  buildCounterSubscriptions--;
}
