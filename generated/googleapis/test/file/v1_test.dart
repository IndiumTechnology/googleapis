...
checkUnnamed4720(core.Map<core.String, core.String> o) {
...
checkUnnamed4721(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4723(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4726(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildGoogleCloudSaasacceleratorManagementProvidersV1Instance() {
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1Instance < 3) {
    ...
    o.maintenancePolicyNames = buildUnnamed4721();
    o.maintenanceSchedules = buildUnnamed4722();
    o.name = "foo";
    o.producerMetadata = buildUnnamed4723();
    o.provisionedResources = buildUnnamed4724();
    o.rolloutMetadata = buildUnnamed4725();
    o.sloMetadata =
        buildGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata();
    o.softwareVersions = buildUnnamed4726();
    o.state = "foo";
...
checkGoogleCloudSaasacceleratorManagementProvidersV1Instance(
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1Instance < 3) {
    ...
    checkUnnamed4721(o.maintenancePolicyNames);
    checkUnnamed4722(o.maintenanceSchedules);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4723(o.producerMetadata);
    checkUnnamed4724(o.provisionedResources);
    checkUnnamed4725(o.rolloutMetadata);
    checkGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata(
        o.sloMetadata);
    checkUnnamed4726(o.softwareVersions);
...
buildGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata() {
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata <
      3) {
    o.exclusions = buildUnnamed4728();
    o.nodes = buildUnnamed4729();
    o.tier = "foo";
  }
  buildCounterGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata--;
  return o;
...
checkGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata(
  ...
  if (buildCounterGoogleCloudSaasacceleratorManagementProvidersV1SloMetadata <
      3) {
    checkUnnamed4728(o.exclusions);
    checkUnnamed4729(o.nodes);
...
checkUnnamed4730(core.List<api.FileShareConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4731(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4732(core.List<api.NetworkConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildInstance() {
  ...
  if (buildCounterInstance < 3) {
    ...
    o.description = "foo";
    o.etag = "foo";
    o.fileShares = buildUnnamed4730();
    o.labels = buildUnnamed4731();
    o.name = "foo";
    o.networks = buildUnnamed4732();
    o.state = "foo";
    o.statusMessage = "foo";
    o.tier = "foo";
  }
...
checkInstance(api.Instance o) {
  ...
  if (buildCounterInstance < 3) {
    ...
    checkUnnamed4730(o.fileShares);
    checkUnnamed4731(o.labels);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4732(o.networks);
    unittest.expect(o.state, unittest.equals('foo'));
...
checkUnnamed4733(core.List<api.Instance> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInstance(o[0]);
  checkInstance(o[1]);
}
...
buildListInstancesResponse() {
  ...
  if (buildCounterListInstancesResponse < 3) {
    o.instances = buildUnnamed4733();
    o.nextPageToken = "foo";
    o.unreachable = buildUnnamed4734();
  }
  buildCounterListInstancesResponse--;
  return o;
}
...
checkListInstancesResponse(api.ListInstancesResponse o) {
  buildCounterListInstancesResponse++;
  if (buildCounterListInstancesResponse < 3) {
    checkUnnamed4733(o.instances);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4734(o.unreachable);
  }
  buildCounterListInstancesResponse--;
}
...
checkUnnamed4735(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed4736(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed4737(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed4738(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildLocation() {
  ...
  if (buildCounterLocation < 3) {
    o.displayName = "foo";
    o.labels = buildUnnamed4737();
    o.locationId = "foo";
    o.metadata = buildUnnamed4738();
    o.name = "foo";
  }
  buildCounterLocation--;
  return o;
...
checkLocation(api.Location o) {
  ...
  if (buildCounterLocation < 3) {
    ...
    checkUnnamed4737(o.labels);
    unittest.expect(o.locationId, unittest.equals('foo'));
    checkUnnamed4738(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
  }
  buildCounterLocation--;
}
...
buildNetworkConfig() {
  ...
  if (buildCounterNetworkConfig < 3) {
    o.ipAddresses = buildUnnamed4739();
    o.modes = buildUnnamed4740();
    o.network = "foo";
...
checkNetworkConfig(api.NetworkConfig o) {
  buildCounterNetworkConfig++;
  if (buildCounterNetworkConfig < 3) {
    checkUnnamed4739(o.ipAddresses);
    checkUnnamed4740(o.modes);
...
checkUnnamed4741(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4742(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4741();
    o.name = "foo";
    o.response = buildUnnamed4742();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed4741(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4742(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed4743(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed4744() {
  ...
  o.add(buildUnnamed4743());
  o.add(buildUnnamed4743());
  return o;
}

checkUnnamed4744(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed4743(o[0]);
  checkUnnamed4743(o[1]);
}
