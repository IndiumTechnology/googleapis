...
checkUnnamed4543(core.List<api.AcceleratorType> o) {
...
buildListAcceleratorTypesResponse() {
  ...
  if (buildCounterListAcceleratorTypesResponse < 3) {
    o.acceleratorTypes = buildUnnamed4543();
    o.nextPageToken = "foo";
    o.unreachable = buildUnnamed4544();
  }
  buildCounterListAcceleratorTypesResponse--;
  return o;
}
...
checkListAcceleratorTypesResponse(api.ListAcceleratorTypesResponse o) {
  buildCounterListAcceleratorTypesResponse++;
  if (buildCounterListAcceleratorTypesResponse < 3) {
    checkUnnamed4543(o.acceleratorTypes);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4544(o.unreachable);
  }
  buildCounterListAcceleratorTypesResponse--;
}
...
checkUnnamed4545(core.List<api.Location> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocation(o[0]);
  checkLocation(o[1]);
}
...
checkUnnamed4546(core.List<api.Node> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNode(o[0]);
  checkNode(o[1]);
}
...
buildListNodesResponse() {
  ...
  if (buildCounterListNodesResponse < 3) {
    o.nextPageToken = "foo";
    o.nodes = buildUnnamed4546();
    o.unreachable = buildUnnamed4547();
  }
  buildCounterListNodesResponse--;
  return o;
}
...
checkListNodesResponse(api.ListNodesResponse o) {
  ...
  if (buildCounterListNodesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4546(o.nodes);
    checkUnnamed4547(o.unreachable);
  }
  buildCounterListNodesResponse--;
}
...
checkUnnamed4549(core.List<api.TensorFlowVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4550(core.List<core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o[0], unittest.equals('foo'));
  unittest.expect(o[1], unittest.equals('foo'));
}
...
buildListTensorFlowVersionsResponse() {
  ...
  if (buildCounterListTensorFlowVersionsResponse < 3) {
    o.nextPageToken = "foo";
    o.tensorflowVersions = buildUnnamed4549();
    o.unreachable = buildUnnamed4550();
  }
  buildCounterListTensorFlowVersionsResponse--;
  return o;
}
...
checkListTensorFlowVersionsResponse(api.ListTensorFlowVersionsResponse o) {
  ...
  if (buildCounterListTensorFlowVersionsResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed4549(o.tensorflowVersions);
    checkUnnamed4550(o.unreachable);
  }
  buildCounterListTensorFlowVersionsResponse--;
}
...
checkUnnamed4551(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4554(core.List<api.NetworkEndpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildNode() {
  ...
  if (buildCounterNode < 3) {
    ...
    o.name = "foo";
    o.network = "foo";
    o.networkEndpoints = buildUnnamed4554();
    o.port = "foo";
...
checkNode(api.Node o) {
  ...
  if (buildCounterNode < 3) {
    ...
    checkUnnamed4554(o.networkEndpoints);
...
checkUnnamed4555(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4556(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed4555();
    o.name = "foo";
    o.response = buildUnnamed4556();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed4555(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed4556(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed4557(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4558(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
