...
checkUnnamed1145(core.List<api.Dataset> o) {
...
checkUnnamed1146(core.List<api.AggregateBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAggregateRequest() {
  ...
  if (buildCounterAggregateRequest < 3) {
    o.aggregateBy = buildUnnamed1146();
    ...
    o.endTimeMillis = "foo";
    o.filteredDataQualityStandard = buildUnnamed1147();
    o.startTimeMillis = "foo";
  }
  buildCounterAggregateRequest--;
  return o;
...
checkAggregateRequest(api.AggregateRequest o) {
  buildCounterAggregateRequest++;
  if (buildCounterAggregateRequest < 3) {
    checkUnnamed1146(o.aggregateBy);
    ...
    unittest.expect(o.endTimeMillis, unittest.equals('foo'));
    checkUnnamed1147(o.filteredDataQualityStandard);
    unittest.expect(o.startTimeMillis, unittest.equals('foo'));
  }
  buildCounterAggregateRequest--;
}
...
checkUnnamed1148(core.List<api.AggregateBucket> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1149(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
buildDataSource() {
  ...
  if (buildCounterDataSource < 3) {
    ...
    o.dataQualityStandard = buildUnnamed1150();
    o.dataStreamId = "foo";
...
checkDataSource(api.DataSource o) {
  ...
  if (buildCounterDataSource < 3) {
    ...
    checkUnnamed1150(o.dataQualityStandard);
...
checkUnnamed1151(core.List<api.DataTypeField> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1152(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
checkUnnamed1153(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
checkUnnamed1154(core.List<api.DataPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataPoint(o[0]);
  checkDataPoint(o[1]);
}
...
buildListDataPointChangesResponse() {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    o.dataSourceId = "foo";
    o.deletedDataPoint = buildUnnamed1153();
    o.insertedDataPoint = buildUnnamed1154();
    o.nextPageToken = "foo";
  }
  buildCounterListDataPointChangesResponse--;
  return o;
...
checkListDataPointChangesResponse(api.ListDataPointChangesResponse o) {
  ...
  if (buildCounterListDataPointChangesResponse < 3) {
    unittest.expect(o.dataSourceId, unittest.equals('foo'));
    checkUnnamed1153(o.deletedDataPoint);
    checkUnnamed1154(o.insertedDataPoint);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListDataPointChangesResponse--;
}
...
checkUnnamed1155(core.List<api.DataSource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDataSource(o[0]);
  checkDataSource(o[1]);
}
...
checkUnnamed1156(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
checkUnnamed1157(core.List<api.Session> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSession(o[0]);
  checkSession(o[1]);
}
...
buildListSessionsResponse() {
  ...
  if (buildCounterListSessionsResponse < 3) {
    o.deletedSession = buildUnnamed1156();
    o.hasMoreData = true;
    o.nextPageToken = "foo";
    o.session = buildUnnamed1157();
  }
  buildCounterListSessionsResponse--;
  return o;
}
...
checkListSessionsResponse(api.ListSessionsResponse o) {
  buildCounterListSessionsResponse++;
  if (buildCounterListSessionsResponse < 3) {
    checkUnnamed1156(o.deletedSession);
    unittest.expect(o.hasMoreData, unittest.isTrue);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed1157(o.session);
  }
  buildCounterListSessionsResponse--;
}
...
checkUnnamed1158(core.List<api.ValueMapValEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
  ...
  unittest.group("resource-UsersDataSourcesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      api.UsersDataSourcesResourceApi res =
          new api.FitnessApi(mock).users.dataSources;
      var arg_userId = "foo";
      var arg_dataTypeName = buildUnnamed1159();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
