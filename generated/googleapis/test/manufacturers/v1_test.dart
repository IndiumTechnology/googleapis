...
checkUnnamed1549(core.List<api.Image> o) {
...
checkUnnamed1551(core.List<api.FeatureDescription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1554(core.List<api.ProductDetail> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAttributes() {
  ...
  if (buildCounterAttributes < 3) {
    o.additionalImageLink = buildUnnamed1549();
    o.ageGroup = "foo";
    o.brand = "foo";
    ...
    o.excludedDestination = buildUnnamed1550();
    o.featureDescription = buildUnnamed1551();
    o.flavor = "foo";
    o.format = "foo";
    o.gender = "foo";
    o.gtin = buildUnnamed1552();
    o.imageLink = buildImage();
    o.includedDestination = buildUnnamed1553();
    o.itemGroupId = "foo";
    o.material = "foo";
    o.mpn = "foo";
    o.pattern = "foo";
    o.productDetail = buildUnnamed1554();
    o.productLine = "foo";
    o.productName = "foo";
    o.productPageUrl = "foo";
    o.productType = buildUnnamed1555();
    o.releaseDate = "foo";
    o.scent = "foo";
    o.size = "foo";
    o.sizeSystem = "foo";
...
checkAttributes(api.Attributes o) {
  buildCounterAttributes++;
  if (buildCounterAttributes < 3) {
    checkUnnamed1549(o.additionalImageLink);
    ...
    checkUnnamed1550(o.excludedDestination);
    checkUnnamed1551(o.featureDescription);
    unittest.expect(o.flavor, unittest.equals('foo'));
    unittest.expect(o.format, unittest.equals('foo'));
    unittest.expect(o.gender, unittest.equals('foo'));
    checkUnnamed1552(o.gtin);
    checkImage(o.imageLink);
    checkUnnamed1553(o.includedDestination);
    ...
    checkUnnamed1554(o.productDetail);
    ...
    checkUnnamed1555(o.productType);
...
checkUnnamed1557(core.List<api.Product> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkProduct(o[0]);
  checkProduct(o[1]);
}
...
checkUnnamed1558(core.List<api.DestinationStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1559(core.List<api.Issue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkIssue(o[0]);
  checkIssue(o[1]);
}
...
buildProduct() {
  ...
  if (buildCounterProduct < 3) {
    ...
    o.destinationStatuses = buildUnnamed1558();
    o.issues = buildUnnamed1559();
    o.name = "foo";
    o.parent = "foo";
    o.productId = "foo";
    o.targetCountry = "foo";
...
checkProduct(api.Product o) {
  ...
  if (buildCounterProduct < 3) {
    ...
    checkUnnamed1558(o.destinationStatuses);
    checkUnnamed1559(o.issues);
...
main() {
  ...
  unittest.group("resource-AccountsProductsResourceApi", () {
    ...
    unittest.test("method--get", () {
      ...
      var arg_parent = "foo";
      var arg_name = "foo";
      var arg_include = buildUnnamed1560();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
    ...
    unittest.test("method--list", () {
      ...
      api.AccountsProductsResourceApi res =
          new api.ManufacturersApi(mock).accounts.products;
      var arg_parent = "foo";
      var arg_include = buildUnnamed1561();
