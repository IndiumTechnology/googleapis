...
checkUnnamed1055(core.List<api.PlusAclentryResource> o) {
...
checkUnnamed1056(core.List<api.ActivityObjectAttachmentsThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1057(core.List<api.ActivityObjectAttachments> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObject() {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    o.attachments = buildUnnamed1057();
    o.content = "foo";
    o.id = "foo";
    o.objectType = "foo";
...
checkActivityObject(api.ActivityObject o) {
  ...
  if (buildCounterActivityObject < 3) {
    ...
    checkUnnamed1057(o.attachments);
    unittest.expect(o.content, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.objectType, unittest.equals('foo'));
...
checkUnnamed1058(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed1059(core.List<api.CommentInReplyTo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1060(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed1061(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
checkUnnamed1062(core.List<api.PersonEmails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1063(core.List<api.PersonOrganizations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1064(core.List<api.PersonPlacesLived> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1065(core.List<api.PersonUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPersonUrls(o[0]);
  checkPersonUrls(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.objectType = "foo";
    o.occupation = "foo";
    o.organizations = buildUnnamed1063();
    o.placesLived = buildUnnamed1064();
    o.plusOneCount = 42;
    o.relationshipStatus = "foo";
    o.skills = "foo";
    o.tagline = "foo";
    o.url = "foo";
    o.urls = buildUnnamed1065();
    o.verified = true;
  }
  buildCounterPerson--;
  return o;
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    checkUnnamed1063(o.organizations);
    checkUnnamed1064(o.placesLived);
