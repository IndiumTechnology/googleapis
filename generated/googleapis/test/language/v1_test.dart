...
checkUnnamed2097(core.List<api.Entity> o) {
...
checkUnnamed2098(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
checkUnnamed2099(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed2100(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed2101(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnalyzeSyntaxResponse() {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    o.language = "foo";
    o.sentences = buildUnnamed2100();
    o.tokens = buildUnnamed2101();
  }
  buildCounterAnalyzeSyntaxResponse--;
  return o;
}
...
checkAnalyzeSyntaxResponse(api.AnalyzeSyntaxResponse o) {
  ...
  if (buildCounterAnalyzeSyntaxResponse < 3) {
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed2100(o.sentences);
    checkUnnamed2101(o.tokens);
  }
  buildCounterAnalyzeSyntaxResponse--;
}
...
checkUnnamed2102(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2103(core.List<api.Entity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntity(o[0]);
  checkEntity(o[1]);
}
...
checkUnnamed2104(core.List<api.Sentence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSentence(o[0]);
  checkSentence(o[1]);
}
...
checkUnnamed2105(core.List<api.Token> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkToken(o[0]);
  checkToken(o[1]);
}
...
buildAnnotateTextResponse() {
  ...
  if (buildCounterAnnotateTextResponse < 3) {
    o.categories = buildUnnamed2102();
    o.documentSentiment = buildSentiment();
    o.entities = buildUnnamed2103();
    o.language = "foo";
    o.sentences = buildUnnamed2104();
    o.tokens = buildUnnamed2105();
  }
  buildCounterAnnotateTextResponse--;
  return o;
}
...
checkAnnotateTextResponse(api.AnnotateTextResponse o) {
  buildCounterAnnotateTextResponse++;
  if (buildCounterAnnotateTextResponse < 3) {
    checkUnnamed2102(o.categories);
    checkSentiment(o.documentSentiment);
    checkUnnamed2103(o.entities);
    unittest.expect(o.language, unittest.equals('foo'));
    checkUnnamed2104(o.sentences);
    checkUnnamed2105(o.tokens);
  }
  buildCounterAnnotateTextResponse--;
}
...
checkUnnamed2106(core.List<api.ClassificationCategory> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkClassificationCategory(o[0]);
  checkClassificationCategory(o[1]);
}
...
checkUnnamed2107(core.List<api.EntityMention> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2108(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildEntity() {
  ...
  if (buildCounterEntity < 3) {
    o.mentions = buildUnnamed2107();
    o.metadata = buildUnnamed2108();
    o.name = "foo";
    o.salience = 42.0;
...
checkEntity(api.Entity o) {
  buildCounterEntity++;
  if (buildCounterEntity < 3) {
    checkUnnamed2107(o.mentions);
    checkUnnamed2108(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
...
buildUnnamed2110() {
  ...
  o.add(buildUnnamed2109());
  o.add(buildUnnamed2109());
  return o;
}

checkUnnamed2110(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2109(o[0]);
  checkUnnamed2109(o[1]);
}
