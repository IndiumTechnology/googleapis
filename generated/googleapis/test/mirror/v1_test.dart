...
checkUnnamed4655(core.List<api.AuthToken> o) {
...
checkUnnamed4657(core.List<api.UserData> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserData(o[0]);
  checkUserData(o[1]);
}
...
buildAccount() {
  ...
  if (buildCounterAccount < 3) {
    o.authTokens = buildUnnamed4655();
    o.features = buildUnnamed4656();
    o.password = "foo";
    o.userData = buildUnnamed4657();
  }
  buildCounterAccount--;
  return o;
}
...
checkAccount(api.Account o) {
  buildCounterAccount++;
  if (buildCounterAccount < 3) {
    checkUnnamed4655(o.authTokens);
    checkUnnamed4656(o.features);
    unittest.expect(o.password, unittest.equals('foo'));
    checkUnnamed4657(o.userData);
  }
  buildCounterAccount--;
}
...
checkUnnamed4658(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
checkUnnamed4659(core.List<api.Command> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCommand(o[0]);
  checkCommand(o[1]);
}
...
buildContact() {
  ...
  if (buildCounterContact < 3) {
    o.acceptCommands = buildUnnamed4659();
    o.acceptTypes = buildUnnamed4660();
    o.displayName = "foo";
    o.id = "foo";
    o.imageUrls = buildUnnamed4661();
    o.kind = "foo";
    o.phoneNumber = "foo";
    o.priority = 42;
    o.sharingFeatures = buildUnnamed4662();
    o.source = "foo";
    o.speakableName = "foo";
    o.type = "foo";
  }
...
checkContact(api.Contact o) {
  buildCounterContact++;
  if (buildCounterContact < 3) {
    checkUnnamed4659(o.acceptCommands);
    checkUnnamed4660(o.acceptTypes);
    unittest.expect(o.displayName, unittest.equals('foo'));
    unittest.expect(o.id, unittest.equals('foo'));
    checkUnnamed4661(o.imageUrls);
    unittest.expect(o.kind, unittest.equals('foo'));
    unittest.expect(o.phoneNumber, unittest.equals('foo'));
    unittest.expect(o.priority, unittest.equals(42));
    checkUnnamed4662(o.sharingFeatures);
...
checkUnnamed4663(core.List<api.Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContact(o[0]);
  checkContact(o[1]);
}
...
checkUnnamed4665(core.List<api.MenuValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMenuValue(o[0]);
  checkMenuValue(o[1]);
}
...
checkUnnamed4666(core.List<api.UserAction> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserAction(o[0]);
  checkUserAction(o[1]);
}
...
buildNotification() {
  ...
  if (buildCounterNotification < 3) {
    ...
    o.itemId = "foo";
    o.operation = "foo";
    o.userActions = buildUnnamed4666();
    o.userToken = "foo";
    o.verifyToken = "foo";
  }
  buildCounterNotification--;
...
checkNotification(api.Notification o) {
  ...
  if (buildCounterNotification < 3) {
    ...
    checkUnnamed4666(o.userActions);
...
checkUnnamed4668(core.List<api.Subscription> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed4669(core.List<api.Attachment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAttachment(o[0]);
  checkAttachment(o[1]);
}
...
checkUnnamed4670(core.List<api.MenuItem> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMenuItem(o[0]);
  checkMenuItem(o[1]);
}
...
checkUnnamed4671(core.List<api.Contact> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkContact(o[0]);
  checkContact(o[1]);
}
...
buildTimelineItem() {
  ...
  if (buildCounterTimelineItem < 3) {
    o.attachments = buildUnnamed4669();
    o.bundleId = "foo";
    o.canonicalUrl = "foo";
    ...
    o.menuItems = buildUnnamed4670();
    o.notification = buildNotificationConfig();
    o.pinScore = 42;
    o.recipients = buildUnnamed4671();
    o.selfLink = "foo";
    o.sourceItemId = "foo";
    o.speakableText = "foo";
    o.speakableType = "foo";
...
checkTimelineItem(api.TimelineItem o) {
  buildCounterTimelineItem++;
  if (buildCounterTimelineItem < 3) {
    checkUnnamed4669(o.attachments);
...
checkUnnamed4672(core.List<api.TimelineItem> o) {
  unittest.expect(o, unittest.hasLength(2));
