...
checkUnnamed1644(core.Map<core.String, core.String> o) {
...
buildImageVersion() {
  ...
  if (buildCounterImageVersion < 3) {
    ...
    o.isDefault = true;
    o.supportedPythonVersions = buildUnnamed1645();
  }
  buildCounterImageVersion--;
  return o;
}
...
checkImageVersion(api.ImageVersion o) {
  ...
  if (buildCounterImageVersion < 3) {
    ...
    checkUnnamed1645(o.supportedPythonVersions);
  }
  buildCounterImageVersion--;
}
...
checkUnnamed1646(core.List<api.Environment> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListEnvironmentsResponse() {
  ...
  if (buildCounterListEnvironmentsResponse < 3) {
    o.environments = buildUnnamed1646();
    o.nextPageToken = "foo";
  }
  buildCounterListEnvironmentsResponse--;
  return o;
...
checkListEnvironmentsResponse(api.ListEnvironmentsResponse o) {
  buildCounterListEnvironmentsResponse++;
  if (buildCounterListEnvironmentsResponse < 3) {
    checkUnnamed1646(o.environments);
...
checkUnnamed1647(core.List<api.ImageVersion> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListImageVersionsResponse() {
  ...
  if (buildCounterListImageVersionsResponse < 3) {
    o.imageVersions = buildUnnamed1647();
    o.nextPageToken = "foo";
  }
  buildCounterListImageVersionsResponse--;
  return o;
...
checkListImageVersionsResponse(api.ListImageVersionsResponse o) {
  buildCounterListImageVersionsResponse++;
  if (buildCounterListImageVersionsResponse < 3) {
    checkUnnamed1647(o.imageVersions);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
  }
  buildCounterListImageVersionsResponse--;
}
...
checkUnnamed1648(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed1651(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed1651();
    o.name = "foo";
    o.response = buildUnnamed1652();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed1651(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed1652(o.response);
  }
  buildCounterOperation--;
}
...
checkUnnamed1653(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed1655(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
buildSoftwareConfig() {
  ...
  if (buildCounterSoftwareConfig < 3) {
    o.airflowConfigOverrides = buildUnnamed1653();
    o.envVariables = buildUnnamed1654();
    o.imageVersion = "foo";
    o.pypiPackages = buildUnnamed1655();
    o.pythonVersion = "foo";
  }
  buildCounterSoftwareConfig--;
  return o;
...
checkSoftwareConfig(api.SoftwareConfig o) {
  buildCounterSoftwareConfig++;
  if (buildCounterSoftwareConfig < 3) {
    checkUnnamed1653(o.airflowConfigOverrides);
    checkUnnamed1654(o.envVariables);
    unittest.expect(o.imageVersion, unittest.equals('foo'));
    checkUnnamed1655(o.pypiPackages);
...
checkUnnamed1656(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed1657() {
  ...
  o.add(buildUnnamed1656());
  o.add(buildUnnamed1656());
  return o;
}

checkUnnamed1657(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1656(o[0]);
  checkUnnamed1656(o[1]);
}
