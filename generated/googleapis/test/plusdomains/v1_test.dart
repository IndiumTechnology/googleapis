...
checkUnnamed83(core.List<api.PlusDomainsAclentryResource> o) {
...
checkUnnamed84(core.List<api.ActivityObjectAttachmentsPreviewThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed85(core.List<api.ActivityObjectAttachmentsThumbnails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildActivityObjectAttachments() {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    o.objectType = "foo";
    o.previewThumbnails = buildUnnamed84();
    o.thumbnails = buildUnnamed85();
    o.url = "foo";
  }
  buildCounterActivityObjectAttachments--;
  return o;
...
checkActivityObjectAttachments(api.ActivityObjectAttachments o) {
  ...
  if (buildCounterActivityObjectAttachments < 3) {
    ...
    checkUnnamed84(o.previewThumbnails);
    checkUnnamed85(o.thumbnails);
    unittest.expect(o.url, unittest.equals('foo'));
  }
  buildCounterActivityObjectAttachments--;
}
...
checkUnnamed86(core.List<api.ActivityObjectAttachments> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed87(core.List<api.Activity> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkActivity(o[0]);
  checkActivity(o[1]);
}
...
checkUnnamed88(core.List<api.Audience> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAudience(o[0]);
  checkAudience(o[1]);
}
...
checkUnnamed89(core.List<api.Circle> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCircle(o[0]);
  checkCircle(o[1]);
}
...
checkUnnamed90(core.List<api.CommentInReplyTo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed91(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed92(core.List<api.Videostream> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed93(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
checkUnnamed94(core.List<api.PersonEmails> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed95(core.List<api.PersonOrganizations> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed96(core.List<api.PersonPlacesLived> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed97(core.List<api.PersonUrls> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPersonUrls(o[0]);
  checkPersonUrls(o[1]);
}
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    ...
    o.objectType = "foo";
    o.occupation = "foo";
    o.organizations = buildUnnamed95();
    o.placesLived = buildUnnamed96();
    o.plusOneCount = 42;
    o.relationshipStatus = "foo";
    o.skills = "foo";
    o.tagline = "foo";
    o.url = "foo";
    o.urls = buildUnnamed97();
    o.verified = true;
  }
  buildCounterPerson--;
  return o;
...
checkPerson(api.Person o) {
  ...
  if (buildCounterPerson < 3) {
    ...
    checkUnnamed95(o.organizations);
    checkUnnamed96(o.placesLived);
