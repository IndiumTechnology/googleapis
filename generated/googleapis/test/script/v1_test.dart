...
checkUnnamed1301(core.List<api.File> o) {
...
checkUnnamed1302(core.List<api.EntryPoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEntryPoint(o[0]);
  checkEntryPoint(o[1]);
}
...
buildDeployment() {
  ...
  if (buildCounterDeployment < 3) {
    ...
    o.deploymentId = "foo";
    o.entryPoints = buildUnnamed1302();
    o.updateTime = "foo";
  }
  buildCounterDeployment--;
  return o;
...
checkDeployment(api.Deployment o) {
  ...
  if (buildCounterDeployment < 3) {
    ...
    checkUnnamed1302(o.entryPoints);
...
checkUnnamed1303(core.List<api.ScriptStackTraceElement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildExecutionError() {
  ...
  if (buildCounterExecutionError < 3) {
    o.errorMessage = "foo";
    o.errorType = "foo";
    o.scriptStackTraceElements = buildUnnamed1303();
  }
  buildCounterExecutionError--;
  return o;
}
...
checkExecutionError(api.ExecutionError o) {
  ...
  if (buildCounterExecutionError < 3) {
    ...
    checkUnnamed1303(o.scriptStackTraceElements);
  }
  buildCounterExecutionError--;
}
...
checkUnnamed1304(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1305(core.List<api.GoogleAppsScriptTypeFunction> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1306(core.List<api.Deployment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDeployment(o[0]);
  checkDeployment(o[1]);
}
...
buildListDeploymentsResponse() {
  ...
  if (buildCounterListDeploymentsResponse < 3) {
    o.deployments = buildUnnamed1306();
    o.nextPageToken = "foo";
  }
  buildCounterListDeploymentsResponse--;
  return o;
...
checkListDeploymentsResponse(api.ListDeploymentsResponse o) {
  buildCounterListDeploymentsResponse++;
  if (buildCounterListDeploymentsResponse < 3) {
    checkUnnamed1306(o.deployments);
...
checkUnnamed1307(core.List<api.GoogleAppsScriptTypeProcess> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1308(core.List<api.GoogleAppsScriptTypeProcess> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleAppsScriptTypeProcess(o[0]);
  checkGoogleAppsScriptTypeProcess(o[1]);
}
...
checkUnnamed1309(core.List<api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o[0]);
  checkValue(o[1]);
}
...
checkUnnamed1310(core.List<api.Version> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVersion(o[0]);
  checkVersion(o[1]);
}
...
checkUnnamed1311(core.List<api.MetricsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1312(core.List<api.MetricsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricsValue(o[0]);
  checkMetricsValue(o[1]);
}
...
checkUnnamed1313(core.List<api.MetricsValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricsValue(o[0]);
  checkMetricsValue(o[1]);
}
...
buildMetrics() {
  ...
  if (buildCounterMetrics < 3) {
    o.activeUsers = buildUnnamed1311();
    o.failedExecutions = buildUnnamed1312();
    o.totalExecutions = buildUnnamed1313();
  }
  buildCounterMetrics--;
  return o;
}
...
checkMetrics(api.Metrics o) {
  buildCounterMetrics++;
  if (buildCounterMetrics < 3) {
    checkUnnamed1311(o.activeUsers);
    checkUnnamed1312(o.failedExecutions);
    checkUnnamed1313(o.totalExecutions);
  }
  buildCounterMetrics--;
}
...
buildUnnamed1316() {
  ...
  o.add(buildUnnamed1315());
  o.add(buildUnnamed1315());
  return o;
}

checkUnnamed1316(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed1315(o[0]);
  checkUnnamed1315(o[1]);
}
...
checkUnnamed1317(core.Map<core.String, api.Value> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkValue(o["x"]);
  checkValue(o["y"]);
}
...
main() {
  ...
  unittest.group("resource-ProcessesResourceApi", () {
    unittest.test("method--list", () {
      ...
      var arg_userProcessFilter_userAccessLevels = buildUnnamed1319();
      var arg_userProcessFilter_functionName = "foo";
      var arg_userProcessFilter_scriptId = "foo";
      var arg_userProcessFilter_types = buildUnnamed1320();
      var arg_userProcessFilter_statuses = buildUnnamed1321();
    ...
    unittest.test("method--listScriptProcesses", () {
      var mock = new HttpServerMock();
      api.ProcessesResourceApi res = new api.ScriptApi(mock).processes;
      var arg_scriptProcessFilter_statuses = buildUnnamed1322();
      ...
      var arg_scriptProcessFilter_types = buildUnnamed1323();
      var arg_pageToken = "foo";
      var arg_pageSize = 42;
      var arg_scriptProcessFilter_endTime = "foo";
      var arg_scriptProcessFilter_userAccessLevels = buildUnnamed1324();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
