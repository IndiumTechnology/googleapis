...
checkUnnamed2859(core.List<api.AmpUrl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAmpUrl(o[0]);
  checkAmpUrl(o[1]);
}
...
checkUnnamed2860(core.List<api.AmpUrlError> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBatchGetAmpUrlsResponse() {
  ...
  if (buildCounterBatchGetAmpUrlsResponse < 3) {
    o.ampUrls = buildUnnamed2859();
    o.urlErrors = buildUnnamed2860();
  }
  buildCounterBatchGetAmpUrlsResponse--;
  return o;
}
...
checkBatchGetAmpUrlsResponse(api.BatchGetAmpUrlsResponse o) {
  buildCounterBatchGetAmpUrlsResponse++;
  if (buildCounterBatchGetAmpUrlsResponse < 3) {
    checkUnnamed2859(o.ampUrls);
    checkUnnamed2860(o.urlErrors);
  }
  buildCounterBatchGetAmpUrlsResponse--;
}
