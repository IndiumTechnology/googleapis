...
checkUnnamed2204(core.List<api.DeviceCredential> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2205(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDevice() {
  ...
  if (buildCounterDevice < 3) {
    ...
    o.credentials = buildUnnamed2204();
...
checkDevice(api.Device o) {
  ...
  if (buildCounterDevice < 3) {
    ...
    checkUnnamed2204(o.credentials);
...
checkUnnamed2206(core.List<api.RegistryCredential> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed2207(core.List<api.EventNotificationConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDeviceRegistry() {
  ...
  if (buildCounterDeviceRegistry < 3) {
    o.credentials = buildUnnamed2206();
    o.eventNotificationConfigs = buildUnnamed2207();
...
checkDeviceRegistry(api.DeviceRegistry o) {
  buildCounterDeviceRegistry++;
  if (buildCounterDeviceRegistry < 3) {
    checkUnnamed2206(o.credentials);
    checkUnnamed2207(o.eventNotificationConfigs);
...
checkUnnamed2208(core.List<api.DeviceConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListDeviceConfigVersionsResponse() {
  ...
  if (buildCounterListDeviceConfigVersionsResponse < 3) {
    o.deviceConfigs = buildUnnamed2208();
  }
  buildCounterListDeviceConfigVersionsResponse--;
  return o;
}
...
checkListDeviceConfigVersionsResponse(api.ListDeviceConfigVersionsResponse o) {
  buildCounterListDeviceConfigVersionsResponse++;
  if (buildCounterListDeviceConfigVersionsResponse < 3) {
    checkUnnamed2208(o.deviceConfigs);
  }
  buildCounterListDeviceConfigVersionsResponse--;
}
...
checkUnnamed2209(core.List<api.DeviceRegistry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListDeviceRegistriesResponse() {
  ...
  if (buildCounterListDeviceRegistriesResponse < 3) {
    o.deviceRegistries = buildUnnamed2209();
    o.nextPageToken = "foo";
  }
  buildCounterListDeviceRegistriesResponse--;
  return o;
...
checkListDeviceRegistriesResponse(api.ListDeviceRegistriesResponse o) {
  buildCounterListDeviceRegistriesResponse++;
  if (buildCounterListDeviceRegistriesResponse < 3) {
    checkUnnamed2209(o.deviceRegistries);
...
checkUnnamed2210(core.List<api.DeviceState> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListDeviceStatesResponse() {
  ...
  if (buildCounterListDeviceStatesResponse < 3) {
    o.deviceStates = buildUnnamed2210();
  }
  buildCounterListDeviceStatesResponse--;
  return o;
}
...
checkListDeviceStatesResponse(api.ListDeviceStatesResponse o) {
  buildCounterListDeviceStatesResponse++;
  if (buildCounterListDeviceStatesResponse < 3) {
    checkUnnamed2210(o.deviceStates);
  }
  buildCounterListDeviceStatesResponse--;
}
...
checkUnnamed2211(core.List<api.Device> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkDevice(o[0]);
  checkDevice(o[1]);
}
...
checkUnnamed2212(core.List<api.Binding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBinding(o[0]);
  checkBinding(o[1]);
}
...
checkUnnamed2213(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed2214() {
  ...
  o.add(buildUnnamed2213());
  o.add(buildUnnamed2213());
  return o;
}

checkUnnamed2214(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed2213(o[0]);
  checkUnnamed2213(o[1]);
}
...
buildTestIamPermissionsResponse() {
  ...
  if (buildCounterTestIamPermissionsResponse < 3) {
    o.permissions = buildUnnamed2216();
  }
  buildCounterTestIamPermissionsResponse--;
  return o;
}
...
checkTestIamPermissionsResponse(api.TestIamPermissionsResponse o) {
  buildCounterTestIamPermissionsResponse++;
  if (buildCounterTestIamPermissionsResponse < 3) {
    checkUnnamed2216(o.permissions);
  }
  buildCounterTestIamPermissionsResponse--;
}
...
main() {
  ...
  unittest.group("resource-ProjectsLocationsRegistriesDevicesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_fieldMask = "foo";
      var arg_pageSize = 42;
      var arg_deviceIds = buildUnnamed2217();
      var arg_deviceNumIds = buildUnnamed2218();
  ...
  unittest.group("resource-ProjectsLocationsRegistriesGroupsDevicesResourceApi",
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_pageSize = 42;
      var arg_deviceIds = buildUnnamed2219();
      var arg_gatewayListOptions_associationsDeviceId = "foo";
      var arg_deviceNumIds = buildUnnamed2220();
      var arg_gatewayListOptions_gatewayType = "foo";
      var arg_gatewayListOptions_associationsGatewayId = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
