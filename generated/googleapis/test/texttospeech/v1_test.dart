...
buildAudioConfig() {
  ...
  if (buildCounterAudioConfig < 3) {
    o.audioEncoding = "foo";
    o.effectsProfileId = buildUnnamed3713();
    o.pitch = 42.0;
...
checkAudioConfig(api.AudioConfig o) {
  ...
  if (buildCounterAudioConfig < 3) {
    ...
    checkUnnamed3713(o.effectsProfileId);
...
checkUnnamed3714(core.List<api.Voice> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkVoice(o[0]);
  checkVoice(o[1]);
}
...
buildVoice() {
  ...
  if (buildCounterVoice < 3) {
    o.languageCodes = buildUnnamed3715();
    o.name = "foo";
...
checkVoice(api.Voice o) {
  buildCounterVoice++;
  if (buildCounterVoice < 3) {
    checkUnnamed3715(o.languageCodes);
