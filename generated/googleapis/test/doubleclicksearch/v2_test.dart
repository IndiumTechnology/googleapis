...
checkUnnamed1205(core.List<api.CustomDimension> o) {
...
checkUnnamed1206(core.List<api.CustomMetric> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildConversion() {
  ...
  if (buildCounterConversion < 3) {
    ...
    o.criterionId = "foo";
    o.currencyCode = "foo";
    o.customDimension = buildUnnamed1205();
    o.customMetric = buildUnnamed1206();
    o.deviceType = "foo";
...
checkConversion(api.Conversion o) {
  ...
  if (buildCounterConversion < 3) {
    ...
    checkUnnamed1205(o.customDimension);
    checkUnnamed1206(o.customMetric);
...
checkUnnamed1207(core.List<api.Conversion> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkConversion(o[0]);
  checkConversion(o[1]);
}
...
checkUnnamed1208(core.List<api.ReportFiles> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1209(core.List<api.ReportRow> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportRow(o[0]);
  checkReportRow(o[1]);
}
...
checkUnnamed1210(core.List<api.ReportApiColumnSpec> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1211(core.List<core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1212(core.List<api.ReportRequestFilters> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1213(core.List<api.ReportRequestOrderBy> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildReportRequestTimeRange() {
  ...
  if (buildCounterReportRequestTimeRange < 3) {
    o.changedAttributesSinceTimestamp =
        core.DateTime.parse("2002-02-27T14:01:02");
...
checkReportRequestTimeRange(api.ReportRequestTimeRange o) {
  buildCounterReportRequestTimeRange++;
  if (buildCounterReportRequestTimeRange < 3) {
    unittest.expect(o.changedAttributesSinceTimestamp,
        unittest.equals(core.DateTime.parse("2002-02-27T14:01:02")));
    unittest.expect(o.changedMetricsSinceTimestamp,
        unittest.equals(core.DateTime.parse("2002-02-27T14:01:02")));
    unittest.expect(o.endDate, unittest.equals('foo'));
    unittest.expect(o.startDate, unittest.equals('foo'));
  }
...
checkUnnamed1214(core.List<api.SavedColumn> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed1215(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUpdateAvailabilityRequest() {
  ...
  if (buildCounterUpdateAvailabilityRequest < 3) {
    o.availabilities = buildUnnamed1215();
  }
  buildCounterUpdateAvailabilityRequest--;
  return o;
}
...
checkUpdateAvailabilityRequest(api.UpdateAvailabilityRequest o) {
  buildCounterUpdateAvailabilityRequest++;
  if (buildCounterUpdateAvailabilityRequest < 3) {
    checkUnnamed1215(o.availabilities);
  }
  buildCounterUpdateAvailabilityRequest--;
}
...
checkUnnamed1216(core.List<api.Availability> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAvailability(o[0]);
  checkAvailability(o[1]);
}
...
buildUpdateAvailabilityResponse() {
  ...
  if (buildCounterUpdateAvailabilityResponse < 3) {
    o.availabilities = buildUnnamed1216();
  }
  buildCounterUpdateAvailabilityResponse--;
  return o;
}
...
checkUpdateAvailabilityResponse(api.UpdateAvailabilityResponse o) {
  buildCounterUpdateAvailabilityResponse++;
  if (buildCounterUpdateAvailabilityResponse < 3) {
    checkUnnamed1216(o.availabilities);
  }
  buildCounterUpdateAvailabilityResponse--;
}
  ...
  unittest.group("resource-ConversionResourceApi", () {
    unittest.test("method--get", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(path.substring(pathOffset, pathOffset + 21),
            unittest.equals("doubleclicksearch/v2/"));
        pathOffset += 21;
        unittest.expect(path.substring(pathOffset, pathOffset + 7),
            unittest.equals("agency/"));
        pathOffset += 7;
    ...
    unittest.test("method--patch", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(
            queryMap["agencyId"].first, unittest.equals(arg_agencyId));
        unittest.expect(core.int.parse(queryMap["endDate"].first),
            unittest.equals(arg_endDate));
        unittest.expect(queryMap["engineAccountId"].first,
    ...
    unittest.test("method--updateAvailability", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(path.substring(pathOffset, pathOffset + 29),
            unittest.equals("conversion/updateAvailability"));
        pathOffset += 29;
    ...
    unittest.test("method--generate", () {
      ...
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        ...
        unittest.expect(path.substring(pathOffset, pathOffset + 16),
            unittest.equals("reports/generate"));
        pathOffset += 16;
