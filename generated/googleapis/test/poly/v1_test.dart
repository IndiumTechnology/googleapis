...
checkUnnamed3534(core.List<api.Format> o) {
...
checkUnnamed3535(core.List<api.File> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFile(o[0]);
  checkFile(o[1]);
}
...
checkUnnamed3536(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsset(o[0]);
  checkAsset(o[1]);
}
...
checkUnnamed3537(core.List<api.Asset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAsset(o[0]);
  checkAsset(o[1]);
}
...
checkUnnamed3538(core.List<api.UserAsset> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUserAsset(o[0]);
  checkUserAsset(o[1]);
}
...
buildRemixInfo() {
  ...
  if (buildCounterRemixInfo < 3) {
    o.sourceAsset = buildUnnamed3539();
  }
  buildCounterRemixInfo--;
  return o;
}
...
checkRemixInfo(api.RemixInfo o) {
  buildCounterRemixInfo++;
  if (buildCounterRemixInfo < 3) {
    checkUnnamed3539(o.sourceAsset);
  }
  buildCounterRemixInfo--;
}
...
checkUnnamed3540(core.List<api.AssetImportMessage> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildStartAssetImportResponse() {
  ...
  if (buildCounterStartAssetImportResponse < 3) {
    o.assetId = "foo";
    o.assetImportId = "foo";
    o.assetImportMessages = buildUnnamed3540();
    o.publishUrl = "foo";
  }
  buildCounterStartAssetImportResponse--;
  return o;
...
checkStartAssetImportResponse(api.StartAssetImportResponse o) {
  ...
  if (buildCounterStartAssetImportResponse < 3) {
    ...
    checkUnnamed3540(o.assetImportMessages);
