...
checkUnnamed2854(core.List<api.GdataCompositeMedia> o) {
...
buildGdataMedia() {
  ...
  if (buildCounterGdataMedia < 3) {
    ...
    o.blobRef = "foo";
    o.blobstore2Info = buildGdataBlobstore2Info();
    o.compositeMedia = buildUnnamed2854();
    o.contentType = "foo";
...
checkGdataMedia(api.GdataMedia o) {
  ...
  if (buildCounterGdataMedia < 3) {
    ...
    unittest.expect(o.blobRef, unittest.equals('foo'));
    checkGdataBlobstore2Info(o.blobstore2Info);
    checkUnnamed2854(o.compositeMedia);
...
checkUnnamed2855(core.List<api.Job> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJob(o[0]);
  checkJob(o[1]);
}
...
checkUnnamed2856(core.List<api.ReportType> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReportType(o[0]);
  checkReportType(o[1]);
}
...
buildListReportTypesResponse() {
  ...
  if (buildCounterListReportTypesResponse < 3) {
    o.nextPageToken = "foo";
    o.reportTypes = buildUnnamed2856();
  }
  buildCounterListReportTypesResponse--;
  return o;
}
...
checkListReportTypesResponse(api.ListReportTypesResponse o) {
  ...
  if (buildCounterListReportTypesResponse < 3) {
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    checkUnnamed2856(o.reportTypes);
  }
  buildCounterListReportTypesResponse--;
}
...
checkUnnamed2857(core.List<api.Report> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkReport(o[0]);
  checkReport(o[1]);
}
