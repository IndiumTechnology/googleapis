...
checkUnnamed156(core.List<api.Post> o) {
...
checkUnnamed157(core.List<api.BlogUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed158(core.List<api.Blog> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBlog(o[0]);
  checkBlog(o[1]);
}
...
buildBlogList() {
  ...
  if (buildCounterBlogList < 3) {
    o.blogUserInfos = buildUnnamed157();
...
checkBlogList(api.BlogList o) {
  buildCounterBlogList++;
  if (buildCounterBlogList < 3) {
    checkUnnamed157(o.blogUserInfos);
...
checkUnnamed159(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed160(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed161(core.List<api.PageviewsCounts> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed162(core.List<api.PostImages> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPostImages(o[0]);
  checkPostImages(o[1]);
}
...
checkUnnamed164(core.List<api.Comment> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkComment(o[0]);
  checkComment(o[1]);
}
...
checkUnnamed165(core.List<api.Post> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPost(o[0]);
  checkPost(o[1]);
}
...
checkUnnamed166(core.List<api.PostUserInfo> o) {
  unittest.expect(o, unittest.hasLength(2));
...
main() {
  ...
  unittest.group("resource-BlogsResourceApi", () {
    ...
    unittest.test("method--listByUser", () {
      ...
      var arg_role = buildUnnamed167();
      var arg_status = buildUnnamed168();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-CommentsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_status = buildUnnamed169();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
    ...
    unittest.test("method--listByBlog", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed170();
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
        var pathOffset = 0;
  ...
  unittest.group("resource-PagesResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_maxResults = 42;
      var arg_pageToken = "foo";
      var arg_status = buildUnnamed172();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-PostUserInfosResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed173();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
  ...
  unittest.group("resource-PostsResourceApi", () {
    ...
    unittest.test("method--list", () {
      ...
      var arg_pageToken = "foo";
      var arg_startDate = core.DateTime.parse("2002-02-27T14:01:02");
      var arg_status = buildUnnamed174();
      var arg_view = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
        var path = (req.url).path;
