...
checkUnnamed2436(core.List<api.Statement> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkStatement(o[0]);
  checkStatement(o[1]);
}
...
buildListResponse() {
  ...
  if (buildCounterListResponse < 3) {
    o.debugString = "foo";
    o.errorCode = buildUnnamed2435();
    o.maxAge = "foo";
    o.statements = buildUnnamed2436();
  }
  buildCounterListResponse--;
  return o;
}
...
checkListResponse(api.ListResponse o) {
  ...
  if (buildCounterListResponse < 3) {
    unittest.expect(o.debugString, unittest.equals('foo'));
    checkUnnamed2435(o.errorCode);
    unittest.expect(o.maxAge, unittest.equals('foo'));
    checkUnnamed2436(o.statements);
  }
  buildCounterListResponse--;
}
