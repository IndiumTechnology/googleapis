...
buildConstraints() {
  ...
  if (buildCounterConstraints < 3) {
    ...
    o.region = "foo";
    o.supportedCompressions = buildUnnamed3721();
  }
  buildCounterConstraints--;
  return o;
}
...
checkConstraints(api.Constraints o) {
  ...
  if (buildCounterConstraints < 3) {
    ...
    checkUnnamed3721(o.supportedCompressions);
  }
  buildCounterConstraints--;
}
...
checkUnnamed3722(core.List<api.ListUpdateRequest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFetchThreatListUpdatesRequest() {
  ...
  if (buildCounterFetchThreatListUpdatesRequest < 3) {
    ...
    o.listUpdateRequests = buildUnnamed3722();
  }
  buildCounterFetchThreatListUpdatesRequest--;
  return o;
}
...
checkFetchThreatListUpdatesRequest(api.FetchThreatListUpdatesRequest o) {
  ...
  if (buildCounterFetchThreatListUpdatesRequest < 3) {
    ...
    checkUnnamed3722(o.listUpdateRequests);
  }
  buildCounterFetchThreatListUpdatesRequest--;
}
...
checkUnnamed3723(core.List<api.ListUpdateResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildFetchThreatListUpdatesResponse() {
  ...
  if (buildCounterFetchThreatListUpdatesResponse < 3) {
    o.listUpdateResponses = buildUnnamed3723();
...
checkFetchThreatListUpdatesResponse(api.FetchThreatListUpdatesResponse o) {
  buildCounterFetchThreatListUpdatesResponse++;
  if (buildCounterFetchThreatListUpdatesResponse < 3) {
    checkUnnamed3723(o.listUpdateResponses);
...
buildFindFullHashesRequest() {
  ...
  if (buildCounterFindFullHashesRequest < 3) {
    ...
    o.client = buildClientInfo();
    o.clientStates = buildUnnamed3724();
...
checkFindFullHashesRequest(api.FindFullHashesRequest o) {
  ...
  if (buildCounterFindFullHashesRequest < 3) {
    ...
    checkClientInfo(o.client);
    checkUnnamed3724(o.clientStates);
...
checkUnnamed3725(core.List<api.ThreatMatch> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3726(core.List<api.ThreatMatch> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkThreatMatch(o[0]);
  checkThreatMatch(o[1]);
}
...
checkUnnamed3727(core.List<api.ThreatListDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListThreatListsResponse() {
  ...
  if (buildCounterListThreatListsResponse < 3) {
    o.threatLists = buildUnnamed3727();
  }
  buildCounterListThreatListsResponse--;
  return o;
}
...
checkListThreatListsResponse(api.ListThreatListsResponse o) {
  buildCounterListThreatListsResponse++;
  if (buildCounterListThreatListsResponse < 3) {
    checkUnnamed3727(o.threatLists);
  }
  buildCounterListThreatListsResponse--;
}
...
checkUnnamed3728(core.List<api.ThreatEntrySet> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3729(core.List<api.ThreatEntrySet> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkThreatEntrySet(o[0]);
  checkThreatEntrySet(o[1]);
}
...
buildListUpdateResponse() {
  ...
  if (buildCounterListUpdateResponse < 3) {
    o.additions = buildUnnamed3728();
    o.checksum = buildChecksum();
    o.newClientState = "foo";
    o.platformType = "foo";
    o.removals = buildUnnamed3729();
    o.responseType = "foo";
    o.threatEntryType = "foo";
    o.threatType = "foo";
  }
...
checkUnnamed3730(core.List<core.int> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3731(core.List<api.MetadataEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3732(core.List<api.ThreatSource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3734(core.List<api.ThreatEntry> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildThreatInfo() {
  ...
  if (buildCounterThreatInfo < 3) {
    o.platformTypes = buildUnnamed3733();
    o.threatEntries = buildUnnamed3734();
    o.threatEntryTypes = buildUnnamed3735();
    o.threatTypes = buildUnnamed3736();
  }
  buildCounterThreatInfo--;
  return o;
}
...
checkThreatInfo(api.ThreatInfo o) {
  buildCounterThreatInfo++;
  if (buildCounterThreatInfo < 3) {
    checkUnnamed3733(o.platformTypes);
    checkUnnamed3734(o.threatEntries);
    checkUnnamed3735(o.threatEntryTypes);
    checkUnnamed3736(o.threatTypes);
  }
  buildCounterThreatInfo--;
}
