...
checkUnnamed3926(core.List<api.ContactGroupResponse> o) {
...
buildContactGroup() {
  ...
  if (buildCounterContactGroup < 3) {
    ...
    o.groupType = "foo";
    o.memberCount = 42;
    o.memberResourceNames = buildUnnamed3927();
...
checkContactGroup(api.ContactGroup o) {
  ...
  if (buildCounterContactGroup < 3) {
    ...
    checkUnnamed3927(o.memberResourceNames);
...
checkUnnamed3928(core.List<api.PersonResponse> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3929(core.List<api.Person> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPerson(o[0]);
  checkPerson(o[1]);
}
...
buildListConnectionsResponse() {
  ...
  if (buildCounterListConnectionsResponse < 3) {
    o.connections = buildUnnamed3929();
    o.nextPageToken = "foo";
    o.nextSyncToken = "foo";
    o.totalItems = 42;
    o.totalPeople = 42;
...
checkListConnectionsResponse(api.ListConnectionsResponse o) {
  buildCounterListConnectionsResponse++;
  if (buildCounterListConnectionsResponse < 3) {
    checkUnnamed3929(o.connections);
...
checkUnnamed3930(core.List<api.ContactGroup> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListContactGroupsResponse() {
  ...
  if (buildCounterListContactGroupsResponse < 3) {
    o.contactGroups = buildUnnamed3930();
    o.nextPageToken = "foo";
    o.nextSyncToken = "foo";
    o.totalItems = 42;
  }
...
checkListContactGroupsResponse(api.ListContactGroupsResponse o) {
  buildCounterListContactGroupsResponse++;
  if (buildCounterListContactGroupsResponse < 3) {
    checkUnnamed3930(o.contactGroups);
    unittest.expect(o.nextPageToken, unittest.equals('foo'));
    unittest.expect(o.nextSyncToken, unittest.equals('foo'));
    unittest.expect(o.totalItems, unittest.equals(42));
  }
...
buildModifyContactGroupMembersRequest() {
  ...
  if (buildCounterModifyContactGroupMembersRequest < 3) {
    o.resourceNamesToAdd = buildUnnamed3931();
    o.resourceNamesToRemove = buildUnnamed3932();
  }
  buildCounterModifyContactGroupMembersRequest--;
  return o;
}
...
checkModifyContactGroupMembersRequest(api.ModifyContactGroupMembersRequest o) {
  buildCounterModifyContactGroupMembersRequest++;
  if (buildCounterModifyContactGroupMembersRequest < 3) {
    checkUnnamed3931(o.resourceNamesToAdd);
    checkUnnamed3932(o.resourceNamesToRemove);
  }
  buildCounterModifyContactGroupMembersRequest--;
}
...
buildModifyContactGroupMembersResponse() {
  ...
  if (buildCounterModifyContactGroupMembersResponse < 3) {
    o.canNotRemoveLastContactGroupResourceNames = buildUnnamed3933();
    o.notFoundResourceNames = buildUnnamed3934();
  }
  buildCounterModifyContactGroupMembersResponse--;
  return o;
}
...
checkModifyContactGroupMembersResponse(
  ...
  buildCounterModifyContactGroupMembersResponse++;
  if (buildCounterModifyContactGroupMembersResponse < 3) {
    checkUnnamed3933(o.canNotRemoveLastContactGroupResourceNames);
    checkUnnamed3934(o.notFoundResourceNames);
  }
  buildCounterModifyContactGroupMembersResponse--;
}
...
checkUnnamed3935(core.List<api.Address> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkAddress(o[0]);
  checkAddress(o[1]);
}
...
checkUnnamed3936(core.List<api.AgeRangeType> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3937(core.List<api.Biography> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBiography(o[0]);
  checkBiography(o[1]);
}
...
checkUnnamed3938(core.List<api.Birthday> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkBirthday(o[0]);
  checkBirthday(o[1]);
}
...
checkUnnamed3939(core.List<api.BraggingRights> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3940(core.List<api.CoverPhoto> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCoverPhoto(o[0]);
  checkCoverPhoto(o[1]);
}
...
checkUnnamed3941(core.List<api.EmailAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3942(core.List<api.Event> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEvent(o[0]);
  checkEvent(o[1]);
}
...
checkUnnamed3943(core.List<api.Gender> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGender(o[0]);
  checkGender(o[1]);
}
...
checkUnnamed3944(core.List<api.ImClient> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkImClient(o[0]);
  checkImClient(o[1]);
}
...
checkUnnamed3945(core.List<api.Interest> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkInterest(o[0]);
  checkInterest(o[1]);
}
...
checkUnnamed3946(core.List<api.Locale> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLocale(o[0]);
  checkLocale(o[1]);
}
...
checkUnnamed3947(core.List<api.Membership> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMembership(o[0]);
  checkMembership(o[1]);
}
...
checkUnnamed3948(core.List<api.Name> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkName(o[0]);
  checkName(o[1]);
}
...
checkUnnamed3949(core.List<api.Nickname> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkNickname(o[0]);
  checkNickname(o[1]);
}
...
checkUnnamed3950(core.List<api.Occupation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOccupation(o[0]);
  checkOccupation(o[1]);
}
...
checkUnnamed3951(core.List<api.Organization> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3952(core.List<api.PhoneNumber> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3953(core.List<api.Photo> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPhoto(o[0]);
  checkPhoto(o[1]);
}
...
checkUnnamed3954(core.List<api.Relation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRelation(o[0]);
  checkRelation(o[1]);
}
...
checkUnnamed3955(core.List<api.RelationshipInterest> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3956(core.List<api.RelationshipStatus> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed3957(core.List<api.Residence> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkResidence(o[0]);
  checkResidence(o[1]);
}
...
checkUnnamed3958(core.List<api.SipAddress> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSipAddress(o[0]);
  checkSipAddress(o[1]);
}
...
checkUnnamed3959(core.List<api.Skill> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSkill(o[0]);
  checkSkill(o[1]);
}
...
checkUnnamed3960(core.List<api.Tagline> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkTagline(o[0]);
  checkTagline(o[1]);
}
...
checkUnnamed3961(core.List<api.Url> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUrl(o[0]);
  checkUrl(o[1]);
}
...
checkUnnamed3962(core.List<api.UserDefined> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildPerson() {
  ...
  if (buildCounterPerson < 3) {
    o.addresses = buildUnnamed3935();
    o.ageRange = "foo";
    o.ageRanges = buildUnnamed3936();
    o.biographies = buildUnnamed3937();
    o.birthdays = buildUnnamed3938();
    o.braggingRights = buildUnnamed3939();
    o.coverPhotos = buildUnnamed3940();
    o.emailAddresses = buildUnnamed3941();
    o.etag = "foo";
    o.events = buildUnnamed3942();
    o.genders = buildUnnamed3943();
    o.imClients = buildUnnamed3944();
    o.interests = buildUnnamed3945();
    o.locales = buildUnnamed3946();
    o.memberships = buildUnnamed3947();
    o.metadata = buildPersonMetadata();
    o.names = buildUnnamed3948();
    o.nicknames = buildUnnamed3949();
    o.occupations = buildUnnamed3950();
    o.organizations = buildUnnamed3951();
    o.phoneNumbers = buildUnnamed3952();
    o.photos = buildUnnamed3953();
    o.relations = buildUnnamed3954();
    o.relationshipInterests = buildUnnamed3955();
    o.relationshipStatuses = buildUnnamed3956();
    o.residences = buildUnnamed3957();
    o.resourceName = "foo";
    o.sipAddresses = buildUnnamed3958();
    o.skills = buildUnnamed3959();
    o.taglines = buildUnnamed3960();
    o.urls = buildUnnamed3961();
    o.userDefined = buildUnnamed3962();
  }
  buildCounterPerson--;
  return o;
}
...
checkPerson(api.Person o) {
  buildCounterPerson++;
  if (buildCounterPerson < 3) {
    checkUnnamed3935(o.addresses);
    unittest.expect(o.ageRange, unittest.equals('foo'));
    checkUnnamed3936(o.ageRanges);
    checkUnnamed3937(o.biographies);
    checkUnnamed3938(o.birthdays);
    checkUnnamed3939(o.braggingRights);
    checkUnnamed3940(o.coverPhotos);
    checkUnnamed3941(o.emailAddresses);
    unittest.expect(o.etag, unittest.equals('foo'));
    checkUnnamed3942(o.events);
    checkUnnamed3943(o.genders);
    checkUnnamed3944(o.imClients);
    checkUnnamed3945(o.interests);
    checkUnnamed3946(o.locales);
    checkUnnamed3947(o.memberships);
    checkPersonMetadata(o.metadata);
    checkUnnamed3948(o.names);
    checkUnnamed3949(o.nicknames);
    checkUnnamed3950(o.occupations);
    checkUnnamed3951(o.organizations);
    checkUnnamed3952(o.phoneNumbers);
    checkUnnamed3953(o.photos);
    checkUnnamed3954(o.relations);
    checkUnnamed3955(o.relationshipInterests);
    checkUnnamed3956(o.relationshipStatuses);
    checkUnnamed3957(o.residences);
    unittest.expect(o.resourceName, unittest.equals('foo'));
    checkUnnamed3958(o.sipAddresses);
    checkUnnamed3959(o.skills);
    checkUnnamed3960(o.taglines);
    checkUnnamed3961(o.urls);
    checkUnnamed3962(o.userDefined);
  }
  buildCounterPerson--;
}
...
checkUnnamed3965(core.List<api.Source> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkSource(o[0]);
  checkSource(o[1]);
}
...
buildPersonMetadata() {
  ...
  if (buildCounterPersonMetadata < 3) {
    o.deleted = true;
    o.linkedPeopleResourceNames = buildUnnamed3963();
    o.objectType = "foo";
    o.previousResourceNames = buildUnnamed3964();
    o.sources = buildUnnamed3965();
  }
  buildCounterPersonMetadata--;
  return o;
}
...
checkPersonMetadata(api.PersonMetadata o) {
  ...
  if (buildCounterPersonMetadata < 3) {
    unittest.expect(o.deleted, unittest.isTrue);
    checkUnnamed3963(o.linkedPeopleResourceNames);
    unittest.expect(o.objectType, unittest.equals('foo'));
    checkUnnamed3964(o.previousResourceNames);
    checkUnnamed3965(o.sources);
  }
  buildCounterPersonMetadata--;
}
...
checkUnnamed3967(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildUnnamed3968() {
  ...
  o.add(buildUnnamed3967());
  o.add(buildUnnamed3967());
  return o;
}

checkUnnamed3968(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed3967(o[0]);
  checkUnnamed3967(o[1]);
}
...
main() {
  ...
  unittest.group("resource-ContactGroupsResourceApi", () {
    unittest.test("method--batchGet", () {
      ...
      var arg_resourceNames = buildUnnamed3969();
      var arg_$fields = "foo";
  ...
  unittest.group("resource-PeopleResourceApi", () {
    ...
    unittest.test("method--getBatchGet", () {
      var mock = new HttpServerMock();
      api.PeopleResourceApi res = new api.PeopleApi(mock).people;
      var arg_resourceNames = buildUnnamed3970();
      var arg_personFields = "foo";
      var arg_requestMask_includeField = "foo";
      var arg_$fields = "foo";
      mock.register(unittest.expectAsync2((http.BaseRequest req, json) {
