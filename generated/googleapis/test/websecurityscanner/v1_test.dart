...
checkUnnamed143(core.List<api.CrawledUrl> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkCrawledUrl(o[0]);
  checkCrawledUrl(o[1]);
}
...
checkUnnamed144(core.List<api.FindingTypeStats> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildListFindingTypeStatsResponse() {
  ...
  if (buildCounterListFindingTypeStatsResponse < 3) {
    o.findingTypeStats = buildUnnamed144();
  }
  buildCounterListFindingTypeStatsResponse--;
  return o;
}
...
checkListFindingTypeStatsResponse(api.ListFindingTypeStatsResponse o) {
  buildCounterListFindingTypeStatsResponse++;
  if (buildCounterListFindingTypeStatsResponse < 3) {
    checkUnnamed144(o.findingTypeStats);
  }
  buildCounterListFindingTypeStatsResponse--;
}
...
checkUnnamed145(core.List<api.Finding> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkFinding(o[0]);
  checkFinding(o[1]);
}
...
checkUnnamed146(core.List<api.ScanConfig> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScanConfig(o[0]);
  checkScanConfig(o[1]);
}
...
checkUnnamed147(core.List<api.ScanRun> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkScanRun(o[0]);
  checkScanRun(o[1]);
}
...
buildOutdatedLibrary() {
  ...
  if (buildCounterOutdatedLibrary < 3) {
    o.learnMoreUrls = buildUnnamed148();
    o.libraryName = "foo";
    o.version = "foo";
  }
  buildCounterOutdatedLibrary--;
...
checkOutdatedLibrary(api.OutdatedLibrary o) {
  buildCounterOutdatedLibrary++;
  if (buildCounterOutdatedLibrary < 3) {
    checkUnnamed148(o.learnMoreUrls);
...
buildScanConfig() {
  ...
  if (buildCounterScanConfig < 3) {
    ...
    o.blacklistPatterns = buildUnnamed149();
    o.displayName = "foo";
    ...
    o.startingUrls = buildUnnamed150();
    o.userAgent = "foo";
  }
  buildCounterScanConfig--;
  return o;
...
checkScanConfig(api.ScanConfig o) {
  ...
  if (buildCounterScanConfig < 3) {
    ...
    checkUnnamed149(o.blacklistPatterns);
    ...
    checkUnnamed150(o.startingUrls);
...
checkUnnamed151(core.List<api.ScanRunWarningTrace> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildScanRun() {
  ...
  if (buildCounterScanRun < 3) {
    ...
    o.warningTraces = buildUnnamed151();
  }
  buildCounterScanRun--;
  return o;
}
...
checkScanRun(api.ScanRun o) {
  ...
  if (buildCounterScanRun < 3) {
    ...
    checkUnnamed151(o.warningTraces);
  }
  buildCounterScanRun--;
}
...
checkUnnamed152(core.List<api.Header> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeader(o[0]);
  checkHeader(o[1]);
}
...
checkUnnamed153(core.List<api.Header> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHeader(o[0]);
  checkHeader(o[1]);
}
...
buildVulnerableHeaders() {
  ...
  if (buildCounterVulnerableHeaders < 3) {
    ...
    o.missingHeaders = buildUnnamed153();
  }
  buildCounterVulnerableHeaders--;
  return o;
}
...
checkVulnerableHeaders(api.VulnerableHeaders o) {
  ...
  if (buildCounterVulnerableHeaders < 3) {
    ...
    checkUnnamed153(o.missingHeaders);
  }
  buildCounterVulnerableHeaders--;
}
...
buildVulnerableParameters() {
  ...
  if (buildCounterVulnerableParameters < 3) {
    o.parameterNames = buildUnnamed154();
  }
  buildCounterVulnerableParameters--;
  return o;
}
...
checkVulnerableParameters(api.VulnerableParameters o) {
  buildCounterVulnerableParameters++;
  if (buildCounterVulnerableParameters < 3) {
    checkUnnamed154(o.parameterNames);
  }
  buildCounterVulnerableParameters--;
}
