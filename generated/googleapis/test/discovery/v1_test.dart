...
checkUnnamed542(core.List<api.DirectoryListItems> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed546(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
checkUnnamed547(core.List<api.JsonSchemaVariantMap> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildJsonSchema() {
  ...
  if (buildCounterJsonSchema < 3) {
    ...
    o.default_ = "foo";
    o.description = "foo";
    o.enum_ = buildUnnamed544();
    o.enumDescriptions = buildUnnamed545();
    o.format = "foo";
    o.id = "foo";
...
checkJsonSchema(api.JsonSchema o) {
  ...
  if (buildCounterJsonSchema < 3) {
    ...
    unittest.expect(o.description, unittest.equals('foo'));
    checkUnnamed544(o.enum_);
    checkUnnamed545(o.enumDescriptions);
...
checkUnnamed551(core.Map<core.String, api.RestMethod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRestMethod(o["x"]);
  checkRestMethod(o["y"]);
}
...
checkUnnamed552(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
checkUnnamed553(core.Map<core.String, api.RestResource> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed554(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
buildRestDescription() {
  ...
  if (buildCounterRestDescription < 3) {
    ...
    o.features = buildUnnamed549();
    o.icons = buildRestDescriptionIcons();
    o.id = "foo";
    o.kind = "foo";
    o.labels = buildUnnamed550();
    o.methods = buildUnnamed551();
    o.name = "foo";
    o.ownerDomain = "foo";
    o.ownerName = "foo";
    o.packagePath = "foo";
    o.parameters = buildUnnamed552();
    o.protocol = "foo";
    o.resources = buildUnnamed553();
    o.revision = "foo";
    o.rootUrl = "foo";
...
checkRestDescription(api.RestDescription o) {
  ...
  if (buildCounterRestDescription < 3) {
    ...
    checkUnnamed549(o.features);
    checkRestDescriptionIcons(o.icons);
    unittest.expect(o.id, unittest.equals('foo'));
    unittest.expect(o.kind, unittest.equals('foo'));
    checkUnnamed550(o.labels);
    checkUnnamed551(o.methods);
    unittest.expect(o.name, unittest.equals('foo'));
    ...
    checkUnnamed552(o.parameters);
    unittest.expect(o.protocol, unittest.equals('foo'));
    checkUnnamed553(o.resources);
...
checkUnnamed557(core.Map<core.String, api.JsonSchema> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkJsonSchema(o["x"]);
  checkJsonSchema(o["y"]);
}
...
buildRestMethod() {
  ...
  if (buildCounterRestMethod < 3) {
    ...
    o.parameterOrder = buildUnnamed556();
    o.parameters = buildUnnamed557();
    o.path = "foo";
...
checkRestMethod(api.RestMethod o) {
  ...
  if (buildCounterRestMethod < 3) {
    ...
    checkUnnamed556(o.parameterOrder);
    checkUnnamed557(o.parameters);
    unittest.expect(o.path, unittest.equals('foo'));
...
checkUnnamed559(core.Map<core.String, api.RestMethod> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRestMethod(o["x"]);
  checkRestMethod(o["y"]);
}
...
checkUnnamed560(core.Map<core.String, api.RestResource> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkRestResource(o["x"]);
  checkRestResource(o["y"]);
}
