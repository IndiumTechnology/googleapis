...
checkUnnamed175(core.List<api.Method> o) {
...
checkUnnamed176(core.List<api.Mixin> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMixin(o[0]);
  checkMixin(o[1]);
}
...
checkUnnamed177(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
buildApi() {
  ...
  if (buildCounterApi < 3) {
    o.methods = buildUnnamed175();
    o.mixins = buildUnnamed176();
    o.name = "foo";
    o.options = buildUnnamed177();
...
checkApi(api.Api o) {
  buildCounterApi++;
  if (buildCounterApi < 3) {
    checkUnnamed175(o.methods);
    checkUnnamed176(o.mixins);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed177(o.options);
...
checkUnnamed178(core.List<api.AuthProvider> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed179(core.List<api.AuthenticationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAuthentication() {
  ...
  if (buildCounterAuthentication < 3) {
    o.providers = buildUnnamed178();
    o.rules = buildUnnamed179();
  }
  buildCounterAuthentication--;
  return o;
}
...
checkAuthentication(api.Authentication o) {
  buildCounterAuthentication++;
  if (buildCounterAuthentication < 3) {
    checkUnnamed178(o.providers);
    checkUnnamed179(o.rules);
  }
  buildCounterAuthentication--;
}
...
checkUnnamed180(core.List<api.AuthRequirement> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildAuthenticationRule() {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    o.requirements = buildUnnamed180();
    o.selector = "foo";
  }
  buildCounterAuthenticationRule--;
  return o;
...
checkAuthenticationRule(api.AuthenticationRule o) {
  ...
  if (buildCounterAuthenticationRule < 3) {
    ...
    checkUnnamed180(o.requirements);
...
checkUnnamed181(core.List<api.BackendRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed182(core.List<api.QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed183(core.List<api.QuotaOverride> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaOverride(o[0]);
  checkQuotaOverride(o[1]);
}
...
checkUnnamed185(core.List<api.EnableFailure> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed186(core.List<api.GoogleApiServiceusageV1Service> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBatchEnableServicesResponse() {
  ...
  if (buildCounterBatchEnableServicesResponse < 3) {
    o.failures = buildUnnamed185();
    o.services = buildUnnamed186();
  }
  buildCounterBatchEnableServicesResponse--;
  return o;
}
...
checkBatchEnableServicesResponse(api.BatchEnableServicesResponse o) {
  buildCounterBatchEnableServicesResponse++;
  if (buildCounterBatchEnableServicesResponse < 3) {
    checkUnnamed185(o.failures);
    checkUnnamed186(o.services);
  }
  buildCounterBatchEnableServicesResponse--;
}
...
checkUnnamed187(core.List<api.BillingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildBilling() {
  ...
  if (buildCounterBilling < 3) {
    o.consumerDestinations = buildUnnamed187();
  }
  buildCounterBilling--;
  return o;
}
...
checkBilling(api.Billing o) {
  buildCounterBilling++;
  if (buildCounterBilling < 3) {
    checkUnnamed187(o.consumerDestinations);
  }
  buildCounterBilling--;
}
...
checkUnnamed189(core.List<api.ContextRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildContextRule() {
  ...
  if (buildCounterContextRule < 3) {
    o.allowedRequestExtensions = buildUnnamed190();
    o.allowedResponseExtensions = buildUnnamed191();
    o.provided = buildUnnamed192();
    o.requested = buildUnnamed193();
    o.selector = "foo";
  }
  buildCounterContextRule--;
  return o;
...
checkContextRule(api.ContextRule o) {
  buildCounterContextRule++;
  if (buildCounterContextRule < 3) {
    checkUnnamed190(o.allowedRequestExtensions);
    checkUnnamed191(o.allowedResponseExtensions);
    checkUnnamed192(o.provided);
    checkUnnamed193(o.requested);
    unittest.expect(o.selector, unittest.equals('foo'));
  }
  buildCounterContextRule--;
}
...
checkUnnamed194(core.List<api.CustomErrorRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildCustomError() {
  ...
  if (buildCounterCustomError < 3) {
    o.rules = buildUnnamed194();
    o.types = buildUnnamed195();
  }
  buildCounterCustomError--;
  return o;
}
...
checkCustomError(api.CustomError o) {
  buildCounterCustomError++;
  if (buildCounterCustomError < 3) {
    checkUnnamed194(o.rules);
    checkUnnamed195(o.types);
  }
  buildCounterCustomError--;
}
...
checkUnnamed196(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed197(core.List<api.DocumentationRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildDocumentation() {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    o.overview = "foo";
    o.pages = buildUnnamed196();
    o.rules = buildUnnamed197();
...
checkDocumentation(api.Documentation o) {
  ...
  if (buildCounterDocumentation < 3) {
    ...
    checkUnnamed196(o.pages);
    checkUnnamed197(o.rules);
...
buildEndpoint() {
  ...
  if (buildCounterEndpoint < 3) {
    o.aliases = buildUnnamed198();
    o.allowCors = true;
    o.features = buildUnnamed199();
    o.name = "foo";
    o.target = "foo";
  }
  buildCounterEndpoint--;
...
checkEndpoint(api.Endpoint o) {
  buildCounterEndpoint++;
  if (buildCounterEndpoint < 3) {
    checkUnnamed198(o.aliases);
    unittest.expect(o.allowCors, unittest.isTrue);
    checkUnnamed199(o.features);
    unittest.expect(o.name, unittest.equals('foo'));
...
checkUnnamed200(core.List<api.EnumValue> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnumValue(o[0]);
  checkEnumValue(o[1]);
}
...
checkUnnamed201(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
buildEnum() {
  ...
  if (buildCounterEnum < 3) {
    o.enumvalue = buildUnnamed200();
    o.name = "foo";
    o.options = buildUnnamed201();
    o.sourceContext = buildSourceContext();
    o.syntax = "foo";
  }
  buildCounterEnum--;
...
checkEnum(api.Enum o) {
  buildCounterEnum++;
  if (buildCounterEnum < 3) {
    checkUnnamed200(o.enumvalue);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed201(o.options);
    checkSourceContext(o.sourceContext);
    unittest.expect(o.syntax, unittest.equals('foo'));
  }
  buildCounterEnum--;
...
checkUnnamed202(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
checkUnnamed203(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
checkUnnamed204(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0]);
  checkApi(o[1]);
}
...
checkUnnamed205(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
checkUnnamed206(core.List<api.Enum> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEnum(o[0]);
  checkEnum(o[1]);
}
...
checkUnnamed207(core.List<api.LogDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed208(core.List<api.MetricDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed209(core.List<api.MonitoredResourceDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed210(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}
...
checkUnnamed211(core.List<api.Type> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkType(o[0]);
  checkType(o[1]);
}
...
buildGoogleApiService() {
  ...
  if (buildCounterGoogleApiService < 3) {
    ...
    o.endpoints = buildUnnamed205();
    o.enums = buildUnnamed206();
    o.http = buildHttp();
    o.id = "foo";
    o.logging = buildLogging();
    o.logs = buildUnnamed207();
    o.metrics = buildUnnamed208();
    o.monitoredResources = buildUnnamed209();
    ...
    o.systemTypes = buildUnnamed210();
    o.title = "foo";
    o.types = buildUnnamed211();
    o.usage = buildUsage();
  }
  buildCounterGoogleApiService--;
  return o;
...
checkGoogleApiService(api.GoogleApiService o) {
  ...
  if (buildCounterGoogleApiService < 3) {
    ...
    checkUnnamed205(o.endpoints);
    checkUnnamed206(o.enums);
    checkHttp(o.http);
    unittest.expect(o.id, unittest.equals('foo'));
    checkLogging(o.logging);
    checkUnnamed207(o.logs);
    checkUnnamed208(o.metrics);
    checkUnnamed209(o.monitoredResources);
    ...
    checkUnnamed210(o.systemTypes);
    unittest.expect(o.title, unittest.equals('foo'));
    checkUnnamed211(o.types);
    checkUsage(o.usage);
  }
  buildCounterGoogleApiService--;
}
...
buildGoogleApiServiceusageV1OperationMetadata() {
  ...
  if (buildCounterGoogleApiServiceusageV1OperationMetadata < 3) {
    o.resourceNames = buildUnnamed212();
  }
  buildCounterGoogleApiServiceusageV1OperationMetadata--;
  return o;
}
...
checkGoogleApiServiceusageV1OperationMetadata(
  ...
  buildCounterGoogleApiServiceusageV1OperationMetadata++;
  if (buildCounterGoogleApiServiceusageV1OperationMetadata < 3) {
    checkUnnamed212(o.resourceNames);
  }
  buildCounterGoogleApiServiceusageV1OperationMetadata--;
}
...
checkUnnamed213(core.List<api.Api> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkApi(o[0]);
  checkApi(o[1]);
}
...
checkUnnamed214(core.List<api.Endpoint> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkEndpoint(o[0]);
  checkEndpoint(o[1]);
}
...
buildGoogleApiServiceusageV1ServiceConfig() {
  ...
  if (buildCounterGoogleApiServiceusageV1ServiceConfig < 3) {
    o.apis = buildUnnamed213();
    o.authentication = buildAuthentication();
    o.documentation = buildDocumentation();
    o.endpoints = buildUnnamed214();
    o.name = "foo";
    o.quota = buildQuota();
    o.title = "foo";
    o.usage = buildUsage();
...
checkGoogleApiServiceusageV1ServiceConfig(
  ...
  buildCounterGoogleApiServiceusageV1ServiceConfig++;
  if (buildCounterGoogleApiServiceusageV1ServiceConfig < 3) {
    checkUnnamed213(o.apis);
    checkAuthentication(o.authentication);
    checkDocumentation(o.documentation);
    checkUnnamed214(o.endpoints);
    unittest.expect(o.name, unittest.equals('foo'));
    checkQuota(o.quota);
    unittest.expect(o.title, unittest.equals('foo'));
    checkUsage(o.usage);
...
checkUnnamed215(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
checkUnnamed216(core.List<api.HttpRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkHttpRule(o[0]);
  checkHttpRule(o[1]);
}
...
buildHttpRule() {
  ...
  if (buildCounterHttpRule < 3) {
    o.additionalBindings = buildUnnamed216();
    o.body = "foo";
...
checkHttpRule(api.HttpRule o) {
  buildCounterHttpRule++;
  if (buildCounterHttpRule < 3) {
    checkUnnamed216(o.additionalBindings);
...
checkUnnamed217(core.List<api.Operation> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOperation(o[0]);
  checkOperation(o[1]);
}
...
checkUnnamed218(core.List<api.GoogleApiServiceusageV1Service> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkGoogleApiServiceusageV1Service(o[0]);
  checkGoogleApiServiceusageV1Service(o[1]);
}
...
checkUnnamed219(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed220(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed221(core.List<api.LoggingDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLoggingDestination(o[0]);
  checkLoggingDestination(o[1]);
}
...
buildLogging() {
  ...
  if (buildCounterLogging < 3) {
    o.consumerDestinations = buildUnnamed220();
    o.producerDestinations = buildUnnamed221();
  }
  buildCounterLogging--;
  return o;
}
...
checkLogging(api.Logging o) {
  buildCounterLogging++;
  if (buildCounterLogging < 3) {
    checkUnnamed220(o.consumerDestinations);
    checkUnnamed221(o.producerDestinations);
  }
  buildCounterLogging--;
}
...
checkUnnamed223(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
checkUnnamed224(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
checkUnnamed225(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed226(core.List<api.LabelDescriptor> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkLabelDescriptor(o[0]);
  checkLabelDescriptor(o[1]);
}
...
checkUnnamed227(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed228(core.List<api.MonitoringDestination> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMonitoringDestination(o[0]);
  checkMonitoringDestination(o[1]);
}
...
buildMonitoring() {
  ...
  if (buildCounterMonitoring < 3) {
    o.consumerDestinations = buildUnnamed227();
    o.producerDestinations = buildUnnamed228();
  }
  buildCounterMonitoring--;
  return o;
}
...
checkMonitoring(api.Monitoring o) {
  buildCounterMonitoring++;
  if (buildCounterMonitoring < 3) {
    checkUnnamed227(o.consumerDestinations);
    checkUnnamed228(o.producerDestinations);
  }
  buildCounterMonitoring--;
}
...
checkUnnamed230(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed231(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
buildOperation() {
  ...
  if (buildCounterOperation < 3) {
    o.done = true;
    o.error = buildStatus();
    o.metadata = buildUnnamed230();
    o.name = "foo";
    o.response = buildUnnamed231();
  }
  buildCounterOperation--;
  return o;
}
...
checkOperation(api.Operation o) {
  ...
  if (buildCounterOperation < 3) {
    ...
    checkStatus(o.error);
    checkUnnamed230(o.metadata);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed231(o.response);
  }
  buildCounterOperation--;
}
...
buildOperationMetadata() {
  ...
  if (buildCounterOperationMetadata < 3) {
    o.resourceNames = buildUnnamed232();
  }
  buildCounterOperationMetadata--;
  return o;
}
...
checkOperationMetadata(api.OperationMetadata o) {
  buildCounterOperationMetadata++;
  if (buildCounterOperationMetadata < 3) {
    checkUnnamed232(o.resourceNames);
  }
  buildCounterOperationMetadata--;
}
...
checkUnnamed233(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed234(core.List<api.Page> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkPage(o[0]);
  checkPage(o[1]);
}
...
checkUnnamed235(core.List<api.QuotaLimit> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkQuotaLimit(o[0]);
  checkQuotaLimit(o[1]);
}
...
checkUnnamed236(core.List<api.MetricRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkMetricRule(o[0]);
  checkMetricRule(o[1]);
}
...
buildQuota() {
  ...
  if (buildCounterQuota < 3) {
    o.limits = buildUnnamed235();
    o.metricRules = buildUnnamed236();
  }
  buildCounterQuota--;
  return o;
}
...
checkQuota(api.Quota o) {
  buildCounterQuota++;
  if (buildCounterQuota < 3) {
    checkUnnamed235(o.limits);
    checkUnnamed236(o.metricRules);
  }
  buildCounterQuota--;
}
...
checkUnnamed237(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed238(core.Map<core.String, core.String> o) {
  unittest.expect(o, unittest.hasLength(2));
  unittest.expect(o["x"], unittest.equals('foo'));
  unittest.expect(o["y"], unittest.equals('foo'));
}
...
checkUnnamed239(core.Map<core.String, core.Object> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed240(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed239(o[0]);
  checkUnnamed239(o[1]);
}
...
buildUnnamed242() {
  var o = new core.List<core.Map<core.String, core.Object>>();
  o.add(buildUnnamed241());
  o.add(buildUnnamed241());
  return o;
}

checkUnnamed242(core.List<core.Map<core.String, core.Object>> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUnnamed241(o[0]);
  checkUnnamed241(o[1]);
}
...
checkUnnamed243(core.List<api.SystemParameter> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed244(core.List<api.SystemParameterRule> o) {
  unittest.expect(o, unittest.hasLength(2));
...
checkUnnamed245(core.List<api.Field> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkField(o[0]);
  checkField(o[1]);
}
...
checkUnnamed247(core.List<api.Option> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkOption(o[0]);
  checkOption(o[1]);
}
...
buildType() {
  ...
  if (buildCounterType < 3) {
    o.fields = buildUnnamed245();
    o.name = "foo";
    o.oneofs = buildUnnamed246();
    o.options = buildUnnamed247();
    o.sourceContext = buildSourceContext();
    o.syntax = "foo";
  }
  buildCounterType--;
...
checkType(api.Type o) {
  buildCounterType++;
  if (buildCounterType < 3) {
    checkUnnamed245(o.fields);
    unittest.expect(o.name, unittest.equals('foo'));
    checkUnnamed246(o.oneofs);
    checkUnnamed247(o.options);
    checkSourceContext(o.sourceContext);
    unittest.expect(o.syntax, unittest.equals('foo'));
  }
  buildCounterType--;
...
checkUnnamed249(core.List<api.UsageRule> o) {
  unittest.expect(o, unittest.hasLength(2));
  checkUsageRule(o[0]);
  checkUsageRule(o[1]);
}
...
buildUsage() {
  ...
  if (buildCounterUsage < 3) {
    ...
    o.requirements = buildUnnamed248();
...
checkUsage(api.Usage o) {
  ...
  if (buildCounterUsage < 3) {
    ...
    checkUnnamed248(o.requirements);
